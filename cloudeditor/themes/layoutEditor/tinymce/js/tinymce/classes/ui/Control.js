...
define("tinymce/ui/Control", [
	...
	var proto = {
		...
		initLayoutRect: function() {
			...
			borderBox = self.borderBox =
				self.borderBox || BoxUtils.measureBox(elm, "border");
		...
		layoutRect: function(newRect) {
			...
			if (newRect) {
				...
				if (size !== undef) {
					size =
						size < curRect.minW - deltaWidth ? curRect.minW - deltaWidth : size;
					size =
						size > curRect.maxW - deltaWidth ? curRect.maxW - deltaWidth : size;
					curRect.innerW = size;
	 ...
	 */
	Tools.each("text title visible disabled active value".split(" "), function(
		name
	) {
