...
define("tinymce/dom/ControlSelection", [
	...
	return function(selection, editor) {
		...
		editor.contentStyles.push(
			...
			"}" +
			rootClass +
			" img[data-mce-selected], hr[data-mce-selected] {" +
		...
		function resizeGhostElement(e) {
			...
			if (
				selectedElm.nodeName == "IMG" &&
				editor.settings.resize_img_proportional !== false
			) {
		...
		function updateResizeRect(e) {
			...
			controlElm = dom
				.$(controlElm)
				.closest(isIE ? "table" : "table,img,hr")[0];
			...
			if (isChildOrEqual(controlElm, rootElement)) {
				...
				if (
					...
					if (
						!isIE ||
						(controlElm != startElm && startElm.nodeName !== "IMG")
					) {
