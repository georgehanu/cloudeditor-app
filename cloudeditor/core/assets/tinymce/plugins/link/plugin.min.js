!(function() {
  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
      ...
      var i = function(t, n) {
        return (
          ...
          A.each(t, function(t) {
            ...
            t.menu ? (e.menu = i(t.menu)) : ((e.value = t.value), o && o(e)),
              n.push(e);
          }),
          n
        );
    ...
    V = function(a, t) {
      ...
      (u = E(v.getContent())),
        (e = S(a)),
        (m.text = l = I(a.selection, e)),
        (m.href = e ? g.getAttrib(e, "href") : ""),
        e
          ? (m.target = g.getAttrib(e, "target"))
          : k(a.settings) && (m.target = y(a.settings)),
        ...
        C(a.settings) &&
          (r = {
            ...
            values: F(T(a.settings), function(t) {
              !1 === N(a.settings) &&
                (t.value = K(t.value, "_blank" === m.target));
            })
          }),
        O(a.settings) &&
          (s = {
              ...
              onchange: function(t) {
                ...
                i && i.value(a.convertURL(this.value(), "href")),
                  A.each(t.meta, function(t, e) {
                    var n = o.find("#" + e);
                    "text" === e
                      ? 0 === l.length && (n.value(t), (m.text = t))
                      : n.value(t);
                  }),
                  e.attach && (B = { href: this.value(), attach: e.attach }),
                  e.text || x.call(this);
              },
              onkeyup: x,
              onpaste: x,
    ...
    X = function(r) {
      return function(t) {
        ...
        return !!(
          ...
          h(t) &&
          3 ===
            (o = (n = (e = r.selection).getRng()).startContainer).nodeType &&
          e.isCollapsed() &&
          0 < n.startOffset &&
    ...
    Y = function(n) {
      return function() {
        ...
        x(n.dom.getParents(n.selection.getStart())) || e.hide(),
          n.on("nodechange", t),
