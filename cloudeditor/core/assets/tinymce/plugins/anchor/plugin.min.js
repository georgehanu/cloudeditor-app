  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    i = function(t, e) {
      ...
      "A" === n.tagName && "" === t.dom.getAttrib(n, "href")
        ? (n.removeAttribute("name"), (n.id = e), t.undoManager.add())
        : (t.focus(),
    ...
    n = function(r) {
      ...
      r.windowManager.open({
        title: "Anchor",
        body: { type: "textbox", name: "id", size: 40, label: "Id", value: t },
        onsubmit: function(t) {
          var e,
            n,
            o = t.data.id;
      ...
      return function(t) {
        for (var e = 0; e < t.length; e++)
          (n = t[e]).attr("href") ||
            ...
            n.firstChild ||
            t[e].attr("contenteditable", o);
        var n;
      };
    },
    c = function(t) {
      t.on("PreInit", function() {
        t.parser.addNodeFilter("a", r("false")),
          t.serializer.addNodeFilter("a", r(null));
      });
    },
    d = function(t) {
      t.addButton("anchor", {
