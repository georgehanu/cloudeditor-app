  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    function(l) {
      for (var e = [], t = 1; t < arguments.length; t++)
        e[t - 1] = arguments[t];
      for (
        var c = new Array(arguments.length - 1), n = 1;
        n < arguments.length;
        n++
      )
        c[n - 1] = arguments[n];
    ...
    v = function(e, t, n) {
      ...
      return (
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
          ...
          "%m",
          y(n.getMonth() + 1, 2)
        )).replace("%d", y(n.getDate(), 2))).replace(
          "%H",
          "" + y(n.getHours(), 2)
        )).replace("%M", "" + y(n.getMinutes(), 2))).replace(
          "%S",
          "" + y(n.getSeconds(), 2)
    ...
    P = function(t, e, n) {
      ...
      (n = M(0, n, m(t))),
        (a = l.create("div", null, n)),
        (r = l.select(".mceTmpl", a)) &&
          0 < r.length &&
          (a = l.create("div", null)).appendChild(r[0].cloneNode(!0)),
        o.each(l.select("*", a), function(e) {
          b(e, i(t).replace(/\s+/g, "|")) && (e.innerHTML = v(t, d(t))),
            b(e, s(t).replace(/\s+/g, "|")) && (e.innerHTML = v(t, f(t))),
            b(e, u(t).replace(/\s+/g, "|")) && (e.innerHTML = c);
        }),
        _(t, a),
        t.execCommand("mceInsertContent", !1, a.innerHTML),
        t.addVisual();
    },
    S = function(e) {
    ...
    H = function(n, e) {
      ...
      if (e && 0 !== e.length)
                    ...
                    items: {
                      ...
                      onselect: function(e) {
                        ...
                        t.url
                          ...
                          a
                            .find("#description")[0]
                            .text(e.control.value().description);
                      }
                    }
                  }
                ]
        ...
        n.notificationManager.open({ text: l, type: "info" });
      }
    },
    C = function(t) {
      return function(e) {
