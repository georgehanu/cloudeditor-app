!(function() {
  ...
  var c = function(e) {
    ...
    m = tinymce.util.Tools.resolve("tinymce.util.URI"),
  ...
  var x,
      ...
      return (
        ...
        (g = r.schema.getShortEndedElements()),
        {
          text: (o = (function e(t) {
            ...
            if (h[t.nodeName] && !f[t.nodeName]) return "";
            if (v(t)) return "\n";
            if (
              ((n = ""),
              (f[t.nodeName] || g[t.nodeName]) && (n += "\n"),
              (t = t.firstChild))
            )
          ...
          reset: function() {
            return i.splice(0, i.length), u(), this;
          },
          ...
          find: function(e, t) {
            if (o && e.global) for (; (n = e.exec(o)); ) i.push(a(n, t));
            return this;
          },
          add: function(e, t, n) {
            return (
              i.push({ start: e, end: e + t, text: o.substr(e, t), data: n }),
              this
            );
          },
          wrap: function(e) {
            return (
              i.length &&
                (function(e, t, n) {
                  ...
                  e: for (;;) {
                    if (
                      ((f[u.nodeName] || g[u.nodeName] || v(u)) && s++,
                      3 === u.nodeType &&
                        (!o && u.length + s >= a.end
                          ? ((o = u), (c = a.end - s))
                          : r && l.push(u),
                  ...
                  (function(o) {
                    function v(e, t) {
                      ...
                      return (
                        ...
                        e && r.appendChild(x.doc.createTextNode(e)),
                        r
                      );
                    }
                    return function(e) {
                      ...
                      (t = a.createTextNode(
                        ...
                        (n = a.createTextNode(
                          i.data.substring(e.endNodeIndex)
                        ));
                      for (
                        var u = v(o.data.substring(e.startNodeIndex), c),
                          d = [],
                          f = 0,
                          h = e.innerNodes.length;
                        f < h;
                        ++f
                      ) {
                        var g = e.innerNodes[f],
                          m = v(g.data, c);
                        g.parentNode.replaceChild(m, g), d.push(m);
                      }
                      var p = v(i.data.substring(0, e.endNodeIndex), c);
                      return (
    ...
    k = function(e, t, n, r, o, i, c) {
            ...
            p.send({
              ...
              success: function(e) {
                if ((e = JSON.parse(e))) e.error ? r(e.error) : n(e);
                  ...
                  var t = a.translate("Server response wasn't proper JSON.");
                  r(t);
                }
              },
              error: function() {
                var e =
                  a.translate("The spelling service was not found: (") +
                  d(a) +
                  a.translate(")");
                r(e);
              }
      ...
      ).call(e.plugins.spellchecker, r, o, i, c);
    },
    y = function(e, t, n) {
      e.dom.select("span.mce-spellchecker-word").length || S(e, t, n);
    },
    S = function(e, t, n) {
      if ((N(e, n).reset(), n.set(null), t.get())) return t.set(!1), r(e), !0;
    },
    w = function(e) {
    ...
    b = function(t, e, n, r, o) {
      var i, c;
      if (
        ("string" != typeof o && o.words
          ? ((c = !!o.dictionary), (i = o.words))
          : (i = o),
        ...
        var a = t.translate("No misspellings found.");
        return (
          t.notificationManager.open({ text: a, type: "info" }), void e.set(!1)
        );
      }
    ...
    T = {
      spellcheck: function(t, e, n, r, o, i) {
        S(t, n, r) ||
      ...
      checkIfFinished: y,
      addToDictionary: function(t, e, n, r, o, i, c) {
        t.setProgressState(!0),
          k(
            t,
            e,
            ...
            i,
            function() {
              t.setProgressState(!1), t.dom.remove(c, !0), y(t, n, r);
            },
            function(e) {
              t.notificationManager.open({ text: e, type: "error" }),
                t.setProgressState(!1);
      ...
      ignoreWord: function(t, e, n, r, o, i) {
      ...
      findSpansByIndex: function(e, t) {
        var n,
          r = [];
        if ((n = g.toArray(e.getBody().getElementsByTagName("span"))).length)
    ...
    E = function(e, t, n, r, o, i) {
      e.addCommand("mceSpellCheck", function() {
        T.spellcheck(e, t, n, r, o, i);
      });
    },
    P = function(n, e, r, t, o, i) {
      var c,
        a,
        l,
        s,
        u = ((l = n),
        (c = g.map(h(l).split(","), function(e) {
          return { name: (e = e.split("="))[0], value: e[1] };
        })),
        (a = []),
        g.each(c, function(e) {
          a.push({ selectable: !0, text: e.name, data: e.value });
        }),
        a),
        d = function() {
          T.spellcheck(n, e, r, t, i, o);
        },
        f = {
          tooltip: "Spellcheck",
          onclick: d,
          onPostRender: function(e) {
            var t = e.control;
            n.on("SpellcheckStart SpellcheckEnd", function() {
              t.active(r.get());
            });
          }
        };
      1 < u.length &&
        ...
        (f.onselect = function(e) {
          o.set(e.control.settings.data);
        })),
        n.addButton("spellchecker", f),
        n.addMenuItem("spellchecker", {
          text: "Spellcheck",
          context: "tools",
          onclick: d,
          selectable: !0,
    ...
    B = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    C = tinymce.util.Tools.resolve("tinymce.ui.Factory"),
    D = function(o, i, c, a, l, s) {
      o.on("click", function(e) {
        var t = e.target;
        if ("mce-spellchecker-word" === t.className) {
          e.preventDefault();
          var n = T.findSpansByIndex(o, T.getElmIndex(t));
          if (0 < n.length) {
            var r = o.dom.createRng();
            r.setStartBefore(n[0]),
              r.setEndAfter(n[n.length - 1]),
              o.selection.setRng(r),
              (function(t, e, n, r, o, i, c, a) {
                var l = [],
                  s = n.get().suggestions[c];
                g.each(s, function(e) {
                  l.push({
                    text: e,
                    onclick: function() {
                      t.insertContent(t.dom.encode(e)),
                        t.dom.remove(a),
                        T.checkIfFinished(t, r, o);
                    }
                  });
                }),
                  l.push({ text: "-" }),
                  n.get().hasDictionarySupport &&
                    l.push({
                      ...
                      onclick: function() {
                        T.addToDictionary(t, e, r, o, i, c, a);
                      }
                    }),
                  l.push.apply(l, [
                    {
                      text: "Ignore",
                      onclick: function() {
                        T.ignoreWord(t, r, o, c, a);
                      }
                    },
                    {
                      text: "Ignore all",
                      onclick: function() {
                        T.ignoreWord(t, r, o, c, a, !0);
                      }
                    }
                  ]),
                  (x = C.create("menu", {
                ...
                var u = B.DOM.getPos(t.getContentAreaContainer()),
                  d = t.dom.getPos(a[0]),
                  f = t.dom.getRoot();
                "BODY" === f.nodeName
                  ? ((d.x -=
                  ...
                  (u.x += d.x),
                  (u.y += d.y),
                  x.moveTo(u.x, u.y + a[0].offsetHeight);
              })(o, i, c, a, l, s, t.getAttribute("data-mce-word"), n);
          }
        }
      });
    };
  t.add("spellchecker", function(e, t) {
    if (!1 === a(e)) {
      var n = c(!1),
        r = c(l(e)),
        o = c(null),
