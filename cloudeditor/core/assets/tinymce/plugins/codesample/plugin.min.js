!(function() {
    ...
    c = (function() {
      var c = /\blang(?:uage)?-(?!\*)(\w+)\b/i,
        S = (u.Prism = {
            ...
            clone: function(e) {
              switch (S.util.type(e)) {
                case "Object":
                  var t = {};
                  for (var a in e)
                    e.hasOwnProperty(a) && (t[a] = S.util.clone(e[a]));
                  return t;
                case "Array":
                  return (
                    e.map &&
          ...
          languages: {
            ...
            DFS: function(e, t, a) {
              for (var n in e)
                e.hasOwnProperty(n) &&
                  (t.call(e, n, e[n], a || n),
                  "Object" === S.util.type(e[n])
                    ? S.languages.DFS(e[n], t)
                    : "Array" === S.util.type(e[n]) &&
                      S.languages.DFS(e[n], t, n));
            }
          },
          plugins: {},
          ...
          highlightElement: function(e, t, a) {
            ...
            if (s && i)
              if ((S.hooks.run("before-highlight", o), t && u.Worker)) {
                  ...
                  for (var f = 0; f < i.length; f++) {
                    ...
                    if (!(h instanceof n)) {
                      ...
                      if (m) {
                        ...
                        w.push(x),
                          k && w.push(k),
                          Array.prototype.splice.apply(i, w);
                      }
                    }
                  }
                }
          ...
          hooks: {
            ...
            run: function(e, t) {
              var a = S.hooks.all[e];
              if (a && a.length)
                for (var n = 0, i = void 0; (i = a[n++]); ) i(t);
            }
          }
        }),
      ...
      if (
        ((o.stringify = function(t, a, e) {
          ...
          var n = {
            type: t.type,
            content: o.stringify(t.content, a, e),
            tag: "span",
            ...
            u.addEventListener(
              ...
              function(e) {
                var t = JSON.parse(e.data),
                  ...
                  n = t.code,
                  i = t.immediateClose;
                u.postMessage(S.highlight(n, S.languages[a], a)),
                  i && u.close();
              },
              !1
            ),
    ...
    c.languages.markup &&
      (c.hooks.add("before-highlight", function(t) {
        "php" === t.language &&
          ((t.tokenStack = []),
          (t.backupCode = t.code),
          (t.code = t.code.replace(/(?:<\?php|<\?)[\w\W]*?(?:\?>)/gi, function(
            e
          ) {
  ...
  var g = {
    ...
    d = function(e) {
      ...
      return g.isCodeSample(t) ? t : null;
    },
    p = d,
    f = function(t, a, n) {
        ...
        (n = i.DOM.encode(n)),
          e
            ? (t.dom.setAttrib(e, "class", "language-" + a),
              (e.innerHTML = n),
              c.highlightElement(e),
              t.selection.select(e))
            : (t.insertContent(
                '<pre id="__new" class="language-' + a + '">' + n + "</pre>"
              ),
    ...
    y = function(t) {
      ...
      t.windowManager.open({
        ...
        onSubmit: function(e) {
          f(t, e.data.language, e.data.code);
        }
      });
    },
    v = function(t) {
      t.addCommand("codesample", function() {
        ...
        t.selection.isCollapsed() || g.isCodeSample(e)
          ? y(t)
          : t.formatter.toggle("code");
      });
    },
    k = function(a) {
      var i = a.$;
      a.on("PreProcess", function(e) {
        i("pre[contenteditable=false]", e.node)
          .filter(g.trimArg(g.isCodeSample))
          .each(function(e, t) {
            var a = i(t),
              n = t.textContent;
    ...
    w = function(e, t, a, n) {
      ...
      (e.inline && a.get()) ||
        (!e.inline && n.get()) ||
        (e.inline ? a.set(!0) : n.set(!0),
        !1 !== r &&
          ((i = e.dom.create("link", {
            rel: "stylesheet",
            href: r || t + "/css/prism.css"
          })),
          e
            .getDoc()
