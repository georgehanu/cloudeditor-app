  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    y = function(t) {
      var r = function(e) {
        ...
        E = function() {
          t.theme.panel.find("#wordcount").text(r(t));
        };
      t.on("init", function() {
        var e = t.theme.panel && t.theme.panel.find("#statusbar")[0],
          n = D.debounce(E, 300);
        e &&
          D.setEditorTimeout(
            t,
              ...
              e.insert(
                {
                  ...
                  text: r(t),
                  classes: "wordcount",
                  disabled: t.settings.readonly
                },
                0
              ),
                t.on("setcontent beforeaddundo undo redo keyup", n);
            },
            0
          );
      });
