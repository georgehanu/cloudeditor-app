    ...
    d = function(i, o, c) {
      return function(t) {
        ...
        if (">" === r) {
          ...
          if (
            -1 !== a &&
            -1 !== o.substring(a, e).indexOf('contenteditable="false"')
          )
            return t;
        }
        return (
        ...
        0 < o.length &&
          n.on("BeforeSetContent", function(t) {
            !(function(t, n, e) {
              var r = n.length,
                a = e.content;
              if ("raw" !== e.format) {
                for (; r--; ) a = a.replace(n[r], d(t, a, l(t)));
                e.content = a;
              }
            })(n, o, t);
          }),
          n.parser.addAttributeFilter("class", function(t) {
            for (var n, e = t.length; e--; )
              (n = t[e]), a(n) ? n.attr(r, "true") : i(n) && n.attr(r, "false");
          }),
          n.serializer.addAttributeFilter(r, function(t) {
            for (var n, e = t.length; e--; )
              (n = t[e]),
                (a(n) || i(n)) &&
                  (0 < o.length && n.attr("data-mce-content")
                    ? ((n.name = "#text"),
                      (n.type = 3),
                      (n.raw = !0),
