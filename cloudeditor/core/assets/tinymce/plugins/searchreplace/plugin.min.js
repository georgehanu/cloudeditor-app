  ...
  var u = {
                  ...
                  if ("function" != typeof e) {
                    ...
                    m = function(e, t) {
                      ...
                      return (
                        ...
                        e && n.appendChild(v.createTextNode(e)),
                        n
                      );
                    };
                  } else m = e;
                  return function(e) {
                    ...
                    if (a === i) {
                      ...
                      (r = d.parentNode),
                        0 < e.startNodeIndex &&
                          ((t = v.createTextNode(
                            d.data.substring(0, e.startNodeIndex)
                          )),
                          r.insertBefore(t, d));
                      var c = m(e.match[0], o);
                      return (
                        ...
                        e.endNodeIndex < d.length &&
                          ((n = v.createTextNode(
                            d.data.substring(e.endNodeIndex)
                          )),
                          r.insertBefore(n, d)),
                    ...
                    (t = v.createTextNode(
                      ...
                      (n = v.createTextNode(i.data.substring(e.endNodeIndex)));
                    for (
                      var l = m(a.data.substring(e.startNodeIndex), o),
                        s = [],
                        u = 0,
                    ...
                    return (
                      ...
                      r.insertBefore(l, a),
                      r.removeChild(a),
                      (r = i.parentNode).insertBefore(h, i),
                      r.insertBefore(n, i),
                      r.removeChild(i),
                      h
                    );
    ...
    f = function(e, t, n) {
      var r = t.get(),
        a = e.dom;
      (n = !1 !== n) ? r++ : r--,
        a.removeClass(o(e, t.get()), "mce-match-marker-selected");
      var i = o(e, r);
      return i.length
        ? (a.addClass(o(e, r), "mce-match-marker-selected"),
    ...
    y = function(e, t, n) {
      var r, a, i, o;
      for (
        a = p.toArray(e.getBody().getElementsByTagName("span")), r = 0;
        r < a.length;
        r++
      ) {
        var d = g(a[r]);
        null !== d &&
          d.length &&
          (d === t.get().toString() &&
            (i || (i = a[r].firstChild), (o = a[r].firstChild)),
          m(a[r]));
      }
      if (i && o) {
        ...
        return (
          c.setStart(i, 0),
          c.setEnd(o, o.data.length),
          !1 !== n && e.selection.setRng(c),
          c
        );
      }
    },
    ...
    T = {
      ...
      find: function(e, t, n, r, a) {
        ...
        var i,
          ...
          ((l = i.dom.create("span", { "data-mce-bogus": 1 })).className =
            "mce-match-marker"),
          (c = i.getBody()),
          y(i, o, !1),
      ...
      replace: function(e, t, n, r, a) {
        ...
        for (
          ...
          if (((c = l = parseInt(f, 10)), a || c === t.get())) {
            for (
              n.length
                ? ((o[i].firstChild.nodeValue = n), m(o[i]))
                : v(e.dom, o[i]);
              o[++i];
    ...
    a = function(i, o) {
      ...
      i.undoManager.add(),
        (e = p.trim(i.selection.getContent({ format: "text" })));
