!(function() {
  ...
  var u = function(e) {
    ...
    r = function(e, t, n) {
      ...
      "text" === t.pasteFormat.get()
        ? (t.pasteFormat.set("html"), l(e, !1))
        : (t.pasteFormat.set("text"),
          l(e, !0),
          (i = e),
          !1 === n.get() &&
            m.shouldPlainTextInform(i) &&
            ((a =
    ...
    c = function(e, n, t) {
      e.addCommand("mceTogglePlainTextPaste", function() {
        ...
        e.addCommand("mceInsertClipboardContent", function(e, t) {
          t.content && n.pasteHtml(t.content, t.internal),
            t.text && n.pasteText(t.text);
        });
    },
  ...
  function M(e) {
    ...
    function t(t, n, r) {
      ...
      a !== s && (a < s ? i && (i = i.parent.parent) : ((o = i), (i = null))),
        i && i.name === n
          ? i.append(t)
          : ((o = o || i),
            (i = new k(n, 1)),
            ...
            t.wrap(i)),
        (t.name = "li"),
        s < a && o && o.lastChild.append(i),
        (s = a),
        (function e(t) {
          if (t._listIgnore) t.remove();
          else if ((t = t.firstChild)) for (; e(t), (t = t.next); );
        })(t),
        l(t, /^\u00a0+/),
        l(t, /^\s*([\u2022\u00b7\u00a7\u25CF]|\w+\.)/),
        l(t, /^\u00a0+/);
    ...
    return (
      b.each(e, function(e, t) {
        switch (t) {
          case "mso-list":
            (o = /\w+ \w+([0-9]+)/i.exec(i)) &&
              (a._listLevel = parseInt(o[1], 10)),
              /Ignore/i.test(e) &&
                a.firstChild &&
                ((a._listIgnore = !0), (a.firstChild._listIgnore = !0));
            break;
          case "horiz-align":
            t = "text-align";
            break;
        ...
        0 !== t.indexOf("mso-comment")
          ? 0 !== t.indexOf("mso-") &&
            ("all" === m.getRetainStyleProps(n) || (r && r[t])) &&
            (s[t] = e)
          : a.remove();
      }),
      /(bold)/i.test(s["font-weight"]) &&
        (delete s["font-weight"], a.wrap(new k("b", 1))),
      /(italic)/i.test(s["font-style"]) &&
        (delete s["font-style"], a.wrap(new k("i", 1))),
      (s = n.dom.serializeStyle(s, a.name)) || null
    );
  }
  var A = {
      preProcess: function(e, t) {
        return m.shouldUseDefaultFilters(e)
          ? (function(r, e) {
              var t, a;
              (t = m.getRetainStyleProps(r)) &&
                (a = b.makeMap(t.split(/[, ]/))),
                (e = S.filter(e, [
              ...
              o.addAttributeFilter("style", function(e) {
                for (var t, n = e.length; n--; )
                  (t = e[n]).attr("style", O(r, a, t, t.attr("style"))),
                    "span" === t.name &&
                      t.parent &&
                      !t.attributes.length &&
                      t.unwrap();
              ...
              var s = o.parse(e);
              return (
                m.shouldConvertWordFakeLists(r) && M(s),
                (e = F({ validate: r.settings.validate }, i).serialize(s))
              );
            })(e, t)
          : t;
      },
    ...
    B = function(e, t, n, r) {
      var a,
        ...
        u,
        c = f(e, t, n, r);
      return e.hasEventListeners("PastePostProcess") && !c.isDefaultPrevented()
        ? ((a = e),
          (i = c.content),
          (o = n),
          (s = r),
          (l = a.dom.create("div", { style: "display:none" }, i)),
          (u = d(a, l, o, s)),
          H(u.node.innerHTML, u.isDefaultPrevented()))
        : H(c.content, c.isDefaultPrevented());
    },
    L = function(e, t, n) {
    ...
    $ = function(e, t) {
      return (
        e.insertContent(t, { merge: m.shouldMergeFormats(e), paste: !0 }), !0
      );
    },
    j = function(e) {
    ...
    z = function(e, t) {
      var n, r;
      !1 === m.isSmartPasteEnabled(e)
        ? $(e, t)
        : ((n = e),
          (r = t),
          b.each([N, V, $], function(e) {
            return !0 !== e(n, r, $);
          }));
    },
    K = function(e, t, n) {
    ...
    Z = function(e, t, n, r) {
      ...
      var a,
        ...
        p =
          e.settings.images_reuse_filename && r.name
            ? ((o = e),
              (s = r.name),
              (l = s.match(/([\s\S]+?)\.(?:jpeg|jpg|png|gif)$/i))
                ? o.dom.encode(l[1])
                : null)
            : m,
        g = new Image();
      if (
        ...
        (u = e.settings),
        (c = g),
        !u.images_dataimg_filter || u.images_dataimg_filter(c))
      ) {
        var v,
          h = e.editorUpload.blobCache,
          b = void 0;
        (v = h.findFirst(function(e) {
          return e.base64() === d;
        }))
          ? (b = v)
          : ((b = h.create(m, r, d, p)), h.add(b)),
          K(e, '<img src="' + b.blobUri() + '">', !1);
        ...
        if (e)
          for (t = 0; t < e.length; t++)
            if (((n = e[t]), /^image\/(jpeg|png|gif|bmp)$/.test(n.type))) {
              ...
              ((r = new window.FileReader()).onload = Z.bind(null, o, l, r, i)),
                r.readAsDataURL(i),
                s.preventDefault(),
                (a = !0);
            }
    ...
    Q = function(e) {
      return (
        (a.metaKeyPressed(e) && 86 === e.keyCode) ||
    ...
    ee = function(c, f, d) {
      ...
      function g(e, t, n, r) {
        ...
        X(e, "text/html")
          ...
          : ((a = f.getHtml()),
            (r = r || y(a)),
            f.isDefaultContent(a) && (n = !0)),
          (a = S.trimHtml(a)),
          f.remove(),
          (i = !1 === r && D(a)),
          (a.length && !i) || (n = !0),
          n && (a = X(e, "text/plain") && i ? e["text/plain"] : S.innerText(a)),
          f.isDefaultContent(a)
            ? t ||
              c.windowManager.alert(
      ...
      c.on("keydown", function(e) {
        ...
        if (Q(e) && !e.isDefaultPrevented()) {
          ...
          if (
            ...
            return e.preventDefault(), void n(c, !0);
          f.remove(),
            f.create(),
            c.once("keyup", t),
        ...
        c.on("paste", function(e) {
          var t,
            ...
            a = new Date().getTime(),
            i = ((t = c),
            (n = G(e.clipboardData || t.getDoc().dataTransfer)),
            S.isMsEdge() ? b.extend(n, { "text/html": "" }) : n),
          ...
          (m = !1),
            ...
            -1 !== navigator.userAgent.indexOf("Android") &&
              ...
              0 === r.items.length)
              ? f.remove()
              : q(i) || !J(c, e, f.getLastRng() || c.selection.getRng())
              ? (s || e.preventDefault(),
                !v.ie ||
                  (s && !e.ieFake) ||
                  X(i, "text/html") ||
                  (f.create(),
                  c.dom.bind(f.getEl(), "paste", function(e) {
                    e.stopPropagation();
                  }),
                  c.getDoc().execCommand("Paste", !1, null),
                  (i["text/html"] = f.getHtml())),
                X(i, "text/html")
                  ? (e.preventDefault(),
                    u || (u = y(i["text/html"])),
                    g(i, s, l, u))
      ...
      return {
          ...
          return (
            ...
            (v.ie || v.gecko) &&
              a.setStyle(
                r,
                "left",
                "rtl" === a.getStyle(i, "direction", !0) ? 65535 : -65535
              ),
            a.bind(r, "beforedeactivate focusin focusout", function(e) {
              e.stopPropagation();
            }),
            ne(e, r),
            r.focus(),
        ...
        getHtml: function() {
          return (function(n) {
            ...
            for (
              e = b.grep(te(n).childNodes, function(e) {
                ...
                r = (a = n.dom.select("div[id=mcepastebin]", t)).length - 1;
              0 <= r;
              r--
            )
              (i = n.dom.create("div")), t.insertBefore(i, a[r]), o(i, a[r]);
        ...
        isDefault: function() {
          return (
            (e = l),
            (n = re(o)),
            (t = n) && "mcepastebin" === t.id && ae(e, n.innerHTML)
          );
          var e, t, n;
        },
    ...
    oe = function(n, e) {
      ...
      return (
        n.on("preInit", function() {
          return (
            ee((o = n), t, e),
            void o.parser.addNodeFilter("img", function(e, t, n) {
              var r,
                a = function(e) {
              ...
              if (
                !o.settings.paste_data_images &&
                (r = n).data &&
                !0 === r.data.paste
              )
                for (var i = e.length; i--; )
                  (s = e[i].attributes.map.src) &&
                    (0 === s.indexOf("webkit-fake-url")
                      ? a(e[i])
                      : o.settings.allow_html_data_urls ||
                        0 !== s.indexOf("data:") ||
                        a(e[i]));
            })
          );
    ...
    ue = function(e, t, n, r) {
      le(e.clipboardData, t.html, t.text)
        ? (e.preventDefault(), r())
        : n(t.html, r);
    },
    ce = function(s) {
    ...
    de = function(e) {
      ...
      e.on(
        ...
        e.on(
          ...
          ((n = e),
          function(e) {
            !1 === n.selection.isCollapsed() && ue(e, fe(n), ce(n), se);
          })
        );
    },
    me = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),
    pe = function(e, t) {
      return me.getCaretRangeFromPoint(t.clientX, t.clientY, e.getDoc());
    },
    ge = function(e, t) {
    ...
    ve = function(o, s, l) {
      m.shouldBlockDrop(o) &&
        o.on("dragend dragover draggesture dragdrop drop drag", function(e) {
          e.preventDefault(), e.stopPropagation();
        }),
        m.shouldPasteDataImages(o) ||
        ...
        o.on("drop", function(e) {
          var t, n;
          if (((n = pe(o, e)), !e.isDefaultPrevented() && !l.get())) {
            t = s.getDataTransferItems(e.dataTransfer);
            var r,
              a = s.hasContentType(t, x());
            if (
              ((s.hasHtmlOrText(t) &&
                (!(r = t["text/plain"]) || 0 !== r.indexOf("file://"))) ||
                !s.pasteImageData(e, n)) &&
              n &&
              m.shouldFilterDrop(o)
            ) {
              var i = t["mce-internal"] || t["text/html"] || t["text/plain"];
              i &&
                (e.preventDefault(),
                h.setEditorTimeout(o, function() {
                  o.undoManager.transact(function() {
                    t["mce-internal"] && o.execCommand("Delete"),
                      ge(o, n),
                      (i = S.trimHtml(i)),
                      t["text/html"] ? s.pasteHtml(i, a) : s.pasteText(i);
                  });
                }));
            }
          }
    ...
    if ((a && (u = a.split(/[, ]/)), u)) {
      ...
      t = t.replace(/(<[^>]+) style="([^"]*)"([^>]*>)/gi, function(e, t, n, r) {
        ...
        for (var o = 0; o < u.length; o++) {
          ...
          /color/.test(u[o]) && ((s = c.toHex(s)), (l = c.toHex(l))),
            l !== s && (i[u[o]] = s);
        }
        return (i = c.serializeStyle(i, "span"))
          ? t + ' style="' + i + '"' + r
          : t + r;
      });
  ...
  var we = function(e) {
    ...
    function(i) {
      for (var e = [], t = 1; t < arguments.length; t++)
        e[t - 1] = arguments[t];
      for (
        var o = new Array(arguments.length - 1), n = 1;
        n < arguments.length;
        n++
      )
        o[n - 1] = arguments[n];
  ...
  t.add("paste", function(e) {
    if (!1 === o(e)) {
      var t = u(!1),
        ...
        a = oe(e, r),
        i = we(e);
      return Ce(e, a), c(e, a, t), he(e), de(e), ve(e, a, n), s(a, i);
    }
  });
})();
