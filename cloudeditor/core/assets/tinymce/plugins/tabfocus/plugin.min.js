    ...
    i = function(r) {
      function e(n) {
        ...
        if (
          ...
          var t = c.get(o.id || o.name);
          o.id && t
            ? t.focus()
            : a.setTimeout(function() {
                s.webkit || window.focus(), o.focus();
              }, 10),
            n.preventDefault();
        }
        function u(e) {
          ...
          if (
            ((o = m.select(":input:enabled,*[tabindex]:not(iframe)")),
      ...
      r.on("init", function() {
        r.inline && m.setAttrib(r.getBody(), "tabIndex", null),
          r.on("keyup", n),
          s.gecko ? r.on("keypress keydown", e) : r.on("keydown", e);
      });
    };
