!(function() {
  ...
  var n,
    ...
    v = {
      ...
      curry: function(u) {
        for (var n = [], e = 1; e < arguments.length; e++)
          n[e - 1] = arguments[e];
        for (
          var i = new Array(arguments.length - 1), t = 1;
          t < arguments.length;
          t++
        )
          i[t - 1] = arguments[t];
    ...
    w = {
      ...
      none: y,
      from: function(n) {
        return null === n || n === undefined ? b : T(n);
      }
    },
    x = function(e) {
      return function(n) {
    ...
    E.isFunction(Array.from) && Array.from,
    N),
    O = k,
    C = function(n) {
      if (null === n || n === undefined)
        throw new Error("Node cannot be null or undefined");
      return { dom: v.constant(n) };
    },
    M = {
      ...
      fromPoint: function(n, e, t) {
        return w.from(n.dom().elementFromPoint(e, t)).map(C);
      }
    },
    S = 8,
    D = 9,
    ...
    F = function(n, e) {
      var t = [],
        r = n.dom(),
        o = A(r.childNodes, M.fromDom);
      return (
        O(o, function(n) {
          e(n) && (t = t.concat([n])), (t = t.concat(F(n, e)));
        }),
        t
      );
    },
    z = {
      isMatch: function(n) {
        return (
          R.isText(n) && R.value(n) !== undefined && s.regExp.test(R.value(n))
        );
      },
      filterDescendants: F,
      ...
      replaceWithSpans: function(n) {
        return n.replace(s.regExpGlobal, _);
      }
    },
    G = function(t, n) {
      var r,
        o,
        e = z.filterDescendants(M.fromDom(n), z.isMatch);
      O(e, function(n) {
        var e = z.replaceWithSpans(R.value(n));
        for (o = t.dom.create("div", null, e); (r = o.lastChild); )
          t.dom.insertAfter(r, n.dom());
        t.dom.remove(n.dom());
      });
    },
    W = function(e, n) {
    ...
    J = function(n) {
      var e = n.getBody(),
        ...
        r = z.findParentElm(n.selection.getNode(), e);
      (r = r !== undefined ? r : e),
        W(n, r),
        G(n, r),
    ...
    Y = function(e, t) {
      var r = X.debounce(function() {
        J(e);
      }, 300);
      !1 !== e.settings.forced_root_block &&
        e.on("keydown", function(n) {
          !0 === t.get() && (13 === n.keyCode ? J(e) : r());
        });
    },
    Z = function(t) {
      return function(n) {
