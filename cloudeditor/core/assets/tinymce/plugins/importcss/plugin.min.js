!(function() {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
      ...
      function p(e, t) {
        ...
        if (
          ...
          (c = r) &&
            ...
            ((o = c),
            (u = (s = f).settings),
            !(l = !1 !== u.skin && (u.skin || "lightgray")) ||
              o !==
                (u.skin_url
                  ? s.documentBaseURI.toAbsolute(u.skin_url)
                  : v.baseURL + "/skins/" + l) +
                  "/content" +
                  (s.inline ? ".inline" : "") +
                  ".min.css"))
          ...
          y.each(n, function(e) {
            e.styleSheet
              ? p(e.styleSheet, !0)
              : e.selectorText &&
                y.each(e.selectorText.split(","), function(e) {
                  g.push(y.trim(e));
                });
          });
        }
      }
      y.each(f.contentCSS, function(e) {
        n[e] = !0;
      }),
        m ||
          (m = function(e, t) {
    ...
    x = function(e, t) {
      ...
      if (r) {
        ...
        return (
          r[1]
            ? ((n = { title: t }),
              e.schema.getTextBlockElements()[i]
                ? (n.block = i)
                : e.schema.getBlockElements()[i] || s[i.toLowerCase()]
                ? (n.selector = i)
                : (n.inline = i))
            : r[2] && (n = { inline: "span", title: t.substr(1), classes: c }),
          !1 !== o(e) ? (n.classes = c) : (n.attributes = { class: c }),
          n
        );
      }
    },
    ...
    t = function(h) {
      h.on("renderFormatsMenu", function(e) {
        var t,
          ...
          o = function(e, t) {
            if (
              ((f = e), (g = p), !(T(h, (m = t)) ? f in g : f in m.selectors))
            ) {
              (u = e),
                (a = p),
                T(h, (l = t)) ? (a[u] = !0) : (l.selectors[u] = !0);
              var n = ((c = (i = h).plugins.importcss),
              (s = e),
              ((o = t) && o.selector_converter
                ? o.selector_converter
                : _(i)
                ? _(i)
                : function() {
                    return x(i, s);
              ...
              if (n) {
                ...
                return (
                  h.formatter.register(r, n),
                  y.extend({}, v.settings.itemDefaults, {
                    text: n.title,
                    format: r
                  })
                );
        ...
        u(h) || v.items().remove(),
          y.each(f(h, e.doc || h.getDoc(), a(l(h))), function(n) {
    ...
    s = function(t) {
      return {
        convertSelectorToFormat: function(e) {
          return c(t, e);
        }
      };
    };
