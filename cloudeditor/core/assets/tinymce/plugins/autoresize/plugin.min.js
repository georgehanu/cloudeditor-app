  ...
  var i = function(t) {
    ...
    _ = function(t, e) {
      var n,
        ...
        d = t.dom;
      if ((i = t.getDoc()))
        if ((m = t).plugins.fullscreen && m.plugins.fullscreen.isFullscreen())
          S(t, !0);
        else {
          var m;
          (o = i.body),
            (r = h(t)),
            (u = d.getStyle(o, "margin-top", !0)),
            (s = d.getStyle(o, "margin-bottom", !0)),
            (l = d.getStyle(o, "padding-top", !0)),
            (g = d.getStyle(o, "padding-bottom", !0)),
            (c = d.getStyle(o, "border-top-width", !0)),
            (f = d.getStyle(o, "border-bottom-width", !0)),
            (a =
              o.offsetHeight +
              parseInt(u, 10) +
              parseInt(s, 10) +
            ...
            (isNaN(a) || a <= 0) &&
              (a = y.ie
                ? o.scrollHeight
                : y.webkit && 0 === o.clientHeight
                ? 0
                : o.offsetHeight),
            a > h(t) && (r = a);
          var p = v(t);
          p && p < a ? ((r = p), S(t, !0)) : S(t, !1),
            r !== e.get() &&
              ((n = r - e.get()),
              d.setStyle(t.iframeElement, "height", r + "px"),
              e.set(r),
              y.webkit && n < 0 && _(t, e));
        }
    },
      ...
      setup: function(i, e) {
        i.on("init", function() {
          ...
          (t = o(i)),
            (e = a(i)),
            !1 !== t &&
              n.setStyles(i.getBody(), { paddingLeft: t, paddingRight: t }),
            !1 !== e && n.setStyles(i.getBody(), { paddingBottom: e });
        }),
          i.on("nodechange setcontent keyup FullscreenStateChanged", function(
            t
          ) {
            _(i, e);
          }),
