!(function() {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    v = function(e, t) {
      for (
        var n = t !== undefined && null !== t ? t : h, r = 0;
  ...
  var x = tinymce.util.Tools.resolve("tinymce.util.Promise"),
      ...
      return (function n(e, r) {
        return (
          ...
          w.each(e, function(e) {
            ...
            e.menu ? (t.menu = n(e.menu)) : ((t.value = e.value), i(t)),
              r.push(t);
          }),
          r
        );
    ...
    j = M(function(e, t) {
      return E.isObject(e) && E.isObject(t) ? j(e, t) : t;
    }),
    k = M(function(e, t) {
      return t;
    }),
    D = { deepMerge: j, merge: k },
    z = L.DOM,
    B = function(e) {
    ...
    F = function(e) {
      return e.style.borderWidth ? _(e.style.borderWidth) : "";
    },
    W = function(e, t) {
    ...
    $ = function(e) {
      var t, n, r, i;
      V(e)
        ? ((i = (r = e).parentNode), z.insertAfter(r, i), z.remove(i))
        : ((t = e),
          (n = z.create("figure", { class: "image" })),
          z.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(
            z.create("figcaption", { contentEditable: !0 }, "Caption")
          ),
    ...
    q = function(e, r) {
      return function(e, t, n) {
        e.style[t] ? ((e.style[t] = T(n)), X(e, r)) : G(e, t, n);
      };
    },
    K = function(e, t) {
      return e.style[t] ? _(e.style[t]) : W(e, t);
    },
    Q = function(e, t) {
      var n = T(t);
    ...
    ne = function(e, t) {
      ...
      return (
        ...
        (H(n) || "" !== t.vspace) && Y(n, t.vspace),
        (F(n) || "" !== t.border) && Z(n, t.border),
        (J(n, "borderStyle") || "" !== t.borderStyle) && ee(n, t.borderStyle),
    ...
    ae = function(e, t, n) {
      var r = re(e, n);
      ie(n, r, t, "caption", function(e, t, n) {
        return $(e);
      }),
        ie(n, r, t, "src", G),
        ie(n, r, t, "alt", G),
        ie(n, r, t, "title", G),
        ie(n, r, t, "width", q(0, e)),
        ie(n, r, t, "height", q(0, e)),
        ie(n, r, t, "class", G),
        ie(
          n,
          r,
        ...
        ie(n, r, t, "hspace", oe(Q, e)),
        ie(n, r, t, "vspace", oe(Y, e)),
        ie(n, r, t, "border", oe(Z, e)),
        ie(n, r, t, "borderStyle", oe(ee, e));
    },
    le = function(e, t) {
    ...
    de = function(t, e) {
      var n = (function(e, t) {
        var n = document.createElement("img");
        if (
          (ae(e, D.merge(t, { caption: !1 }), n), G(n, "alt", t.alt), t.caption)
        ) {
          var r = z.create("figure", { class: "image" });
          return (
            r.appendChild(n),
            r.appendChild(
              z.create("figcaption", { contentEditable: !0 }, "Caption")
      ...
      if ((t.dom.setAttrib(r, "data-mce-id", null), te(r))) {
        var i = ce(t, r);
        ...
        ? t.src
          ? (function(t, e) {
              ...
              if (
                ...
                var i = r.parentNode;
                ce(t, i), t.selection.select(r.parentNode);
              } else t.selection.select(r), P(t, e, r);
            })(e, t)
          : (function(e, t) {
              if (t) {
        ...
        items: [
          {
            ...
            function(e) {
              ...
              if (a(o)) {
                var r = n.toJSON(),
                  i = t.parseStyle(r.style);
                n.find("#vspace").value(""),
                  n.find("#hspace").value(""),
                  (((i = O(i))["margin-top"] && i["margin-bottom"]) ||
                    (i["margin-right"] && i["margin-left"])) &&
                    (i["margin-top"] === i["margin-bottom"]
                      ? n.find("#vspace").value(_(i["margin-top"]))
                      : n.find("#vspace").value(""),
                    i["margin-right"] === i["margin-left"]
                      ? n.find("#hspace").value(_(i["margin-right"]))
                      : n.find("#hspace").value("")),
                  i["border-width"]
                    ? n.find("#border").value(_(i["border-width"]))
                    : n.find("#border").value(""),
                  i["border-style"]
                    ? n.find("#borderStyle").value(i["border-style"])
    ...
    ve = function(e, t, n) {
      ...
      n &&
        ...
        a &&
        (o !== r
          ? ((a = Math.round((o / r) * a)), isNaN(a) || t.value(a))
          ...
          onchange: function(e) {
            ...
            (n = s),
              ...
              a.width ||
                ...
                i &&
                  !o.test(r) &&
                  r.substring(0, i.length) !== i &&
                  (r = i + r),
                l.value(r),
                C(n.documentBaseURI.toAbsolute(l.value()), function(e) {
                  e.width &&
                    e.height &&
                    d(n) &&
    ...
    Ce = function(e, t) {
      return { title: "General", type: "form", items: Ne(e, t) };
    },
    Ae = Ne,
    _e = function() {
    ...
    Te = function(e) {
      return _e().createObjectURL(e);
    },
    Oe = function(e) {
      _e().revokeObjectURL(e);
    },
    Re = tinymce.util.Tools.resolve("tinymce.ui.Factory");
  function Pe() {
    return new (t.getOrDie("XMLHttpRequest"))();
  }
  var Ie = function() {};
  function Le(a) {
    var t = function(e, r, i, t) {
      var o, n;
      (o = new Pe()).open("POST", a.url),
    ...
    return (
      (a = w.extend({ credentials: !1, handler: t }, a)),
      {
        upload: function(e) {
          return a.url || a.handler !== t
            ? ((r = e),
              (i = a.handler),
              new x(function(e, t) {
                try {
        ...
        return (
          ...
          I(i)
            .then(function(e) {
              ...
              return a.upload(t).then(function(e) {
                var t = n.find("#src");
                return (
                  t.value(e),
  ...
  var Be = function(e) {
      e.addCommand("mceImage", ze(e).open);
    },
    He = function(o) {
      return function(e) {
        for (
          ...
          (t = e[r]),
            (n = t.attr("class")) &&
              ...
              w.each(t.getAll("figcaption"), i));
      };
    },
    Fe = function(e) {
      e.on("preInit", function() {
        e.parser.addNodeFilter("figure", He(!0)),
          e.serializer.addNodeFilter("figure", He(!1));
      });
    },
    We = function(e) {
      e.addButton("image", {
