!(function() {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    m = function(e, t, n) {
      var o = e.isEmpty(t);
      return (
        !(n && 0 < e.select("span[data-mce-type=bookmark]", t).length) && o
      );
    },
    g = function(e, t) {
    ...
    b = function(r) {
      var i = {},
        e = function(e) {
          var t, n, o;
          (n = r[e ? "startContainer" : "endContainer"]),
            (o = r[e ? "startOffset" : "endOffset"]),
            1 === n.nodeType &&
              ((t = S.create("span", { "data-mce-type": "bookmark" })),
              n.hasChildNodes()
                ? ((o = Math.min(o, n.childNodes.length - 1)),
                  e
                    ? n.insertBefore(t, n.childNodes[o])
                    : S.insertAfter(t, n.childNodes[o]))
                : n.appendChild(t),
              (n = t),
              (o = 0)),
            (i[e ? "startContainer" : "endContainer"] = n),
            (i[e ? "startOffset" : "endOffset"] = o);
        };
    ...
    D = function(r) {
      function e(e) {
        var t, n, o;
        (t = o = r[e ? "startContainer" : "endContainer"]),
          (n = r[e ? "startOffset" : "endOffset"]),
          t &&
            (1 === t.nodeType &&
              ((n = (function(e) {
              ...
              !t.hasChildNodes() &&
                S.isBlock(t) &&
                t.appendChild(S.create("br"))),
            (r[e ? "startContainer" : "endContainer"] = t),
            (r[e ? "startOffset" : "endOffset"] = n));
      }
      e(!0), e();
      var t = S.createRng();
      return (
        t.setStart(r.startContainer, r.startOffset),
        r.endContainer && t.setEnd(r.endContainer, r.endOffset),
        L(t)
      );
    },
    k = t.DOM,
    T = function(e, t) {
      ...
      "LI" === o.nodeName &&
        ...
        ((n = o.previousSibling) && "LI" === n.nodeName
          ? (n.appendChild(t), m(e, o) && k.remove(o))
      ...
      getSelectedSubLists: function(e) {
        ...
        return (
          ...
          (n = r) && 1 === o.length && o[0] === n
            ? ((t = r),
              v.grep(t.querySelectorAll("ol,ul,dl"), function(e) {
                return h(e);
              }))
            : v.grep(i, function(e) {
                return h(e) && r !== e;
    ...
    x = function(e, t, n) {
      ...
      if (
        ...
        n &&
          ...
          f(t.firstChild, s) || a.appendChild(r)),
        t)
      )
        for (; (o = t.firstChild); ) {
          var d = o.nodeName;
    ...
    M = function(e, t, n, o) {
      var r, i, a, s, d;
      for (
        a = _.select('span[data-mce-type="bookmark"]', t),
          o = o || x(e, n),
          (r = _.createRng()).setStartAfter(n),
          r.setEndAfter(t),
          s = (i = r.extractContents()).firstChild;
        s;
        s = s.firstChild
      )
      ...
      e.dom.isEmpty(i) || _.insertAfter(i, t),
        _.insertAfter(o, t),
        m(e.dom, n.parentNode) &&
          ((d = n.parentNode),
          v.each(a, function(e) {
          ...
          ? ((n = r.parentNode),
            r === e.getBody() ||
              ("DD" === t.nodeName
                ...
                : s(t) && c(t)
                ? "LI" === n.nodeName
                  ? (U.insertAfter(t, n), H(e.dom, n), U.remove(r))
                  : h(n)
                  ? U.remove(r, !0)
                  : (n.insertBefore(x(e, t), r), U.remove(r))
                : s(t)
                ? "LI" === n.nodeName
                  ? (U.insertAfter(t, n), t.appendChild(r), H(e.dom, n))
                  : h(n)
                  ? n.insertBefore(t, r)
                  : (n.insertBefore(x(e, t), r), U.remove(t))
                : c(t)
                ? "LI" === n.nodeName
                  ? U.insertAfter(t, n)
                  : h(n)
                  ? U.insertAfter(t, r)
                  : (U.insertAfter(x(e, t), r), U.remove(t))
                : ("LI" === n.nodeName
                    ? ((r = n), (o = x(e, t, "LI")))
                    : (o = h(n) ? x(e, t, "LI") : x(e, t)),
                  M(e, r, t, o),
                  I(e.dom, r.parentNode))))
          : H(e.dom, t),
        !0
      );
    },
    ...
    W = function(e, t, n) {
      ...
      (o = e),
        (r = t),
        (a = (i = n)["list-style-type"] ? i["list-style-type"] : null),
        o.setStyle(r, "list-style-type", a),
        (s = e),
        Q((d = t), (l = n)["list-attributes"]),
        v.each(s.select("li", d), function(e) {
    ...
    j = function(e, t, n, o) {
      ...
      for (
        r = t[n ? "startContainer" : "endContainer"],
          ...
          !n && C(r.nextSibling) && (r = r.nextSibling);
        r.parentNode !== o;
    ...
    q = function(c, f, u) {
      void 0 === u && (u = {});
      var e,
        t = c.selection.getRng(!0),
        m = "LI",
        n = E.getClosestListRootElm(c, c.selection.getStart(!0)),
        g = c.dom;
      "false" !== g.getContentEditable(c.selection.getNode()) &&
        ("DL" === (f = f.toUpperCase()) && (m = "DT"),
        (e = b(t)),
        v.each(
          (function(n, e, o) {
            for (
            ...
            return (
              v.each(d, function(e) {
                ...
                if (a.isBlock(e) || C(e))
                  return C(e) && a.remove(e), void (r = null);
                var t = e.nextSibling;
                p.isBookmarkNode(e) && (y(n, t) || (!t && e.parentNode === o))
                  ? (r = null)
                  : (r ||
                      ((r = a.create("p")),
          ...
          function(e) {
            ...
            ((o = n),
            (r = u),
            (i = g.getStyle(o, "list-style-type")),
            (a = r ? r["list-style-type"] : ""),
            i === (a = null === a ? "" : a))
              ? ((t = n), (e = g.rename(e, m)), n.appendChild(e))
              : ((t = g.create(f)),
    ...
    Y = function(e, t, n, o) {
      ...
      for (
        r = e.schema.getNonEmptyElements(),
          1 === a.nodeType && (a = d.getNode(a, s)),
          i = new l(a, o),
          n && u(e.dom, a) && i.next();
        (a = i[n ? "next" : "prev2"]());
    ...
    te = function(e, t, n) {
      ...
      g(e, t) &&
        g(e, n) &&
        (h(n.lastChild) && (r = n.lastChild),
        i === n.lastChild &&
          C(i.previousSibling) &&
          e.remove(i.previousSibling),
        (o = n.lastChild) && C(o) && t.hasChildNodes() && e.remove(o),
        m(e, n, !0) && e.$(n).empty(),
        ee(e, t, n),
        r && n.appendChild(r),
        e.remove(t),
        m(e, i) && i !== e.getRoot() && e.remove(i));
    },
    ne = function(e, t, n, o) {
      var r,
        i,
            ...
            if (l)
              return (
                r.undoManager.transact(function() {
                  ...
                  (t = d),
                    (n = s),
                    (o = (e = a).getParent(t.parentNode, e.isBlock, n)),
                    e.remove(t),
                    o && e.isEmpty(o) && e.remove(o),
                    X.mergeWithAdjacentLists(a, l.parentNode),
                    r.selection.select(l, !0),
                    r.selection.collapse(i);
                }),
                !0
              );
          }
      ...
      return e.selection.isCollapsed()
        ...
        : ((o = (n = e).selection.getStart()),
          ...
          !!(
            ...
            0 < E.getSelectedListItems(n).length
          ) &&
    ...
    ae = function(t) {
      t.on("keydown", function(e) {
        e.keyCode === n.BACKSPACE
          ? ie(t, !1) && e.preventDefault()
          : e.keyCode === n.DELETE && ie(t, !0) && e.preventDefault();
      });
    },
    se = ie,
    de = function(t) {
    ...
    fe = function(e) {
      ...
      if (i.length) {
        for (
          ...
          ("DT" === t.nodeName
            ? (le.rename(t, "DD"), 1)
            : (n = t.previousSibling) && h(n)
            ? (n.appendChild(t), 1)
            : n && "LI" === n.nodeName && h(n.lastChild)
    ...
    me = function(o) {
      o.on("BeforeExecCommand", function(e) {
        ...
        if (
          ...
          return (
            o.fire("ExecCommand", { command: e.command }),
            e.preventDefault(),
            !0
          );
      }),
        ...
        o.addQueryStateHandler("InsertUnorderedList", ue(o, "UL")),
        o.addQueryStateHandler("InsertOrderedList", ue(o, "OL")),
        o.addQueryStateHandler("InsertDefinitionList", ue(o, "DL"));
    },
    ge = function(e) {
