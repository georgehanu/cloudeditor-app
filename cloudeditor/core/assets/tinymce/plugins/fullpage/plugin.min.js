  ...
  var l = function(e) {
    ...
    v = function(e, t) {
      ...
      return (
        (r.fontface = a(e)),
        (r.fontsize = c(e)),
        7 === (n = i.firstChild).type &&
          ((r.xml_pi = !0),
          (l = /encoding="([^"]+)"/.exec(n.value)) && (r.docencoding = l[1])),
        (n = i.getAll("#doctype")[0]) &&
          (r.doctype = "<!DOCTYPE" + n.value + ">"),
        (n = i.getAll("title")[0]) &&
          n.firstChild &&
          (r.title = n.firstChild.value),
        g.each(i.getAll("meta"), function(e) {
          var t,
            n = e.attr("name"),
            l = e.attr("http-equiv");
          n
        ...
        (n = i.getAll("html")[0]) &&
          (r.langcode = o(n, "lang") || o(n, "xml:lang")),
        (r.stylesheets = []),
        g.each(i.getAll("link"), function(e) {
          "stylesheet" === e.attr("rel") && r.stylesheets.push(e.attr("href"));
        }),
        (n = i.getAll("body")[0]) &&
          ((r.langdir = o(n, "dir")),
          (r.style = o(n, "style")),
          (r.visited_color = o(n, "vlink")),
          (r.link_color = o(n, "link")),
          (r.active_color = o(n, "alink"))),
        r
      );
    },
    _ = function(e, r, t) {
      ...
      (o = p(t)),
        ...
        r.xml_pi
          ? ((i = 'version="1.0"'),
            r.docencoding && (i += ' encoding="' + r.docencoding + '"'),
            7 !== a.type &&
              ((a = new f("xml", 7)), o.insert(a, o.firstChild, !0)),
            (a.value = i))
          : a && 7 === a.type && a.remove(),
        (a = o.getAll("#doctype")[0]),
        r.doctype
          ? (a ||
              ((a = new f("#doctype", 10)),
              r.xml_pi ? o.insert(a, o.firstChild) : u(a)),
            (a.value = r.doctype.substring(9, r.doctype.length - 1)))
          : a && a.remove(),
        (a = null),
        g.each(o.getAll("meta"), function(e) {
          "Content-Type" === e.attr("http-equiv") && (a = e);
        }),
        r.docencoding
          ? (a ||
              ((a = new f("meta", 1)).attr("http-equiv", "Content-Type"),
              (a.shortEnded = !0),
              u(a)),
            a.attr("content", "text/html; charset=" + r.docencoding))
          : a && a.remove(),
        (a = o.getAll("title")[0]),
        r.title
          ? (a ? a.empty() : u((a = new f("title", 1))),
            (a.append(new f("#text", 3)).value = r.title))
          : a && a.remove(),
        g.each(
      ...
      var d = {};
      return (
        g.each(o.getAll("link"), function(e) {
        ...
        (a = o.getAll("body")[0]) &&
          (s(a, "dir", r.langdir),
          s(a, "style", r.style),
          s(a, "vlink", r.visited_color),
          s(a, "link", r.link_color),
          s(a, "alink", r.active_color),
        ...
        (a = o.getAll("html")[0]) &&
          (s(a, "lang", r.langcode), s(a, "xml:lang", r.langcode)),
      ...
      r.on("BeforeSetContent", function(e) {
        !(function(e, t, n, l) {
          ...
          if (
            !(
              l.selection ||
              ((o = b(e.settings.protect, l.content)),
            ...
            0 !== o.length ||
              ...
              (i = (o = o.replace(/<(\/?)BODY/gi, "<$1body")).indexOf("<body"))
                ? ((i = o.indexOf(">", i)),
                  t.set(C(o.substring(0, i + 1))),
                  -1 === (r = o.indexOf("</body", i)) && (r = o.length),
                  (l.content = g.trim(o.substring(i + 1, r))),
                  n.set(C(o.substring(r))))
                : (t.set(A(e)), n.set("\n</body>\n</html>")),
              (a = y(t.get())),
              k(a.getAll("style"), function(e) {
            ...
            s &&
              (u.add(d, "style", { id: "fullpage_styles" }, s),
              (c = u.get("fullpage_styles")).styleSheet &&
