!(function() {
  ...
  var n,
    ...
    Dn = {
      unknown: function() {
        return Tn({ current: undefined, version: Cn.unknown() });
      },
      nu: Tn,
    ...
    Bn = {
      unknown: function() {
        return Pn({ current: undefined, version: Cn.unknown() });
      },
      nu: Pn,
    ...
    Jn = { browsers: y.constant(Kn), oses: y.constant($n) },
    Qn = function(n) {
      var e,
        t,
        r,
  ...
  var Pe,
    ...
    It = function(n) {
      return { row: Pt(n), cell: Ot, replace: Et, gap: Ot };
    },
    Wt = function(n, e) {
      var t = (e || document).createElement("div");
  ...
  function Lt() {
    return {
      ...
      down: y.constant({ selector: Ne.descendants, predicate: Oe.descendants }),
      styles: y.constant({
        get: ut.get,
        getRaw: ut.getRaw,
        set: ut.set,
      ...
      remove: y.constant({ unwrap: dt.unwrap, remove: dt.remove }),
      create: y.constant({
        nu: nn.fromTag,
        clone: function(n) {
  ...
  var qt = V.immutable("left", "right"),
          ...
          return u(n)
            ...
            : i
                ...
                .bind(function(r) {
                  return a(i, r, n)
                    .map(function(n) {
                      var e = [{ first: n.left, second: n.right }],
                        t = u(r) ? r : n.left();
    ...
    yr = function(a, c, r) {
      ...
      return te.eq(a, c)
        ? x.some(wr({ boxes: x.some([a]), start: a, finish: c }))
        : br(a).bind(function(u) {
            return br(c).bind(function(i) {
              if (te.eq(u, i))
                return x.some(wr({ boxes: hr(u, a, c), start: a, finish: c }));
              if (te.contains(u, i)) {
                var n =
                  0 < (e = Ne.ancestors(c, "td,th", l(u))).length
                    ...
                    : c;
                return x.some(
                  wr({ boxes: pr(u, a, u, c, i), start: a, finish: n })
                );
              }
              if (te.contains(i, u)) {
                var e,
                  t =
                    0 < (e = Ne.ancestors(a, "td,th", l(i))).length
                      ...
                      : a;
                return x.some(
                  wr({ boxes: pr(i, a, u, c, i), start: a, finish: t })
                );
              }
              return rr
                .ancestors(a, c)
                ...
                .bind(function(n) {
                  return He.closest(n, "table", r).bind(function(n) {
                    ...
                    return x.some(
                      wr({ boxes: pr(n, a, u, c, i), start: o, finish: t })
                    );
                  });
                });
            });
        ...
        function(e, n) {
          return 0 === e.length
            ...
            : Dr(t, Nr.firstSelectedSelector(), Nr.lastSelectedSelector()).bind(
                function(n) {
                  return 1 < e.length
                    ? x.some({ bounds: y.constant(n), cells: y.constant(e) })
                    : x.none();
                }
              );
        },
  ...
  var Fr = Hr("height", function(n) {
    ...
    ao = {
      ...
      getGenericWidth: function(n) {
        return io(n).bind(function(n) {
          if (Qr.test(n)) {
            var e = Qr.exec(n);
            return x.some({ width: y.constant(e[1]), unit: y.constant(e[3]) });
          }
          return x.none();
        });
      },
    ...
    To = { delta: y.identity, edge: wo, positions: y.curry(Ro, yo, xo) },
    Do = {
      height: So,
      rtl: {
        delta: function(n, e) {
  ...
  var Oo = function(n) {
    ...
    Eo = function(n, e) {
      return Po(n, e, { validate: p.isFunction, label: "function" });
    },
    Po = function(r, o, i) {
      if (0 === o.length)
    ...
    ai = function(n, e, t, r) {
      var o,
        ...
        f = ui(s, r);
      return { colspan: y.constant(l), rowspan: y.constant(f) };
    },
    ci = function(o, i) {
    ...
    si = function(n, e, t, r) {
      ...
      return (
        ...
        e(r, "tbody"),
        e(a, "tfoot"),
        { newRows: y.constant(i), newCells: y.constant(u) }
      );
    },
    di = function(n) {
      return P.map(n, function(n) {
    ...
    wi = function(n, e, t, r, o) {
      ...
      return (
        ...
        Se.setAll(i, { "data-column": n, role: "presentation" }),
        i
      );
    },
    yi = function(n, e, t, r, o) {
      ...
      return (
        ...
        Se.setAll(i, { "data-row": n, role: "presentation" }),
        i
      );
    },
    xi = function(n) {
    ...
    Ci = { resolve: xi("ephox-snooker").resolve },
    Ri = function(n, e) {
      var t = Se.get(n, e);
        ...
        return c(u, n)
          .map(function(n) {
            var e = li(u, o, !1),
              t = a(e, n, te.eq, f(o)),
              r = Gi(t.grid(), o);
            return { grid: y.constant(r), cursor: t.cursor };
          })
          .fold(
            function() {
              return x.none();
    ...
    Zi = function(e, n) {
      ...
      return 0 < r.length
        ? x.some(
            ni.merge(
              { cells: r },
              { generators: n.generators, clipboard: n.clipboard }
            )
          )
        : x.none();
    },
    ...
    lu = function(n, e) {
      var t = ii.cellLength(n[0]),
        r = ii.cellLength(e[0]);
      return { rowDelta: y.constant(0), colDelta: y.constant(t - r) };
    },
    su = function(n, e, t) {
    ...
    Uu = function(n, t) {
      ...
      return P.map(e, function(n) {
        ...
        return { element: n.element, width: y.constant(e), colspan: n.colspan };
      });
    },
    Vu = function(n, t) {
      var e = Ze.justCells(n);
    ...
    Gu = function(n, t) {
      return P.map(n.all(), function(n, e) {
        return { element: n.element, height: y.constant(t[e]) };
      });
    },
    Xu = function(n) {
      var e = parseInt(n, 10),
    ...
    wa = { isRtl: y.constant(!1) },
    ya = { isRtl: y.constant(!0) },
    xa = {
    ...
    Ra = { "border-collapse": "collapse", width: "100%" },
    Sa = { border: "1" },
    Ta = function(n) {
    ...
    Wa = function(n, e, t, r) {
      n.fire("ObjectResizeStart", { target: e, width: t, height: r });
    },
    Ma = function(n, e, t, r) {
      n.fire("ObjectResized", { target: e, width: t, height: r });
    },
    La = function(s, n) {
      var e,
        t = function(n) {
        ...
        f = ((e = s.getParam("table_clone_elements")),
        p.isString(e)
          ? x.some(e.split(/[ ,]/))
          : Array.isArray(e)
          ? x.some(e)
    ...
    Ga = function(t) {
      ...
      return {
        title: "Advanced",
        type: "form",
        defaults: { onchange: y.curry(Va, t) },
        items: [
      ...
      if (
          ...
          items: [
            {
              ...
              items: [
                { label: "Width", name: "width", onchange: y.curry(Ya, e) },
                { label: "Height", name: "height", onchange: y.curry(Ya, e) },
                {
                  label: "Cell type",
                  name: "type",
                  type: "listbox",
        ...
        Ta(e)
          ? e.windowManager.open({
              ...
              bodyType: "tabpanel",
              data: t,
              body: [{ title: "General", type: "form", items: l }, Ga(e)],
        ...
        (r = d[0]) &&
          ...
          Da(e)
            ? e.windowManager.open({
                ...
                data: i,
                bodyType: "tabpanel",
                body: [{ title: "General", type: "form", items: u }, Ga(e)],
    ...
    uc = function(i, n, e) {
      var t,
        ...
        u = {
          styles: o,
          attributes: ((r = i),
          r.getParam("table_default_attributes", Sa, "object")),
          percentages: ((t = o.width),
          p.isString(t) && -1 !== t.indexOf("%") && !Pa(i))
        },
        a = tc(e, n, 0, 0, u);
  ...
  var cc = function(n, e, t) {
    ...
    fc = function(a, e, c, l, t) {
      var r = ga(a),
        ...
        d = function(n) {
          return { width: da(n.dom()), height: da(n.dom()) };
        },
        o = function(e) {
          var t = s();
          f(t).each(function(i) {
  ...
  var hc = {
    ...
    vc = { resolve: xi("ephox-dragster").resolve },
    bc = function(m, g) {
      return function(n) {
        if (m(n)) {
          var e,
    ...
    wc = function(n, e, t, r, o) {
      var i = bc(t, r);
      return (
        n.dom().addEventListener(e, i, o), { unbind: y.curry(yc, n, e, i, o) }
      );
    },
    yc = function(n, e, t, r) {
    ...
    Tc = pc.mode({
      ...
      sink: function(n, e) {
        var t,
          ...
          o,
          i = ((t = e),
          (r = ni.merge({ layerClass: vc.resolve("blocker") }, t)),
          (o = nn.fromTag("div")),
  ...
  function kc() {
    var n = { onEvent: function(n, e) {}, reset: y.noop },
      e = Dc(),
      t = n;
    return {
      on: function() {
  ...
  function Ec() {
    var t,
      r = hc.create({ drag: gc(["xDelta", "yDelta", "target"]) }),
      o = x.none(),
      n = {
        mutate: function(n, e) {
          t.trigger.drag(n, e);
        },
        events: (t = hc.create({ drag: gc(["xDelta", "yDelta"]) })).registry
      };
    return (
  ...
  var Wc = function(n, e) {
    ...
    Fc = function(t, n) {
      return Ye.table(t, n).bind(function(n) {
        ...
        return P.findIndex(e, function(n) {
          ...
          return { index: y.constant(n), all: y.constant(e) };
        });
      });
    },
    Uc = function(e, n) {
    ...
    il = function(n, e) {
      var o,
        ...
        e.match({
          domRange: function(n) {
            return { ltr: y.constant(n), rtl: x.none };
          },
          relative: function(n, e) {
            return {
              ltr: bn(function() {
    ...
    Il = function(n) {
      var o = $c.getWin(n).dom(),
        ...
        t = Rl(n);
      return ul.diagnose(o, t).match({ ltr: e, rtl: e });
    },
    Wl = function(n, e) {
    ...
    Gl = { response: V.immutable("selection", "kill") },
    Xl = function(e) {
      return function(n) {
        return n === e;
      };
    ...
    Kl = Xl(40),
    $l = {
      ltr: { isBackward: Xl(37), isForward: Xl(39) },
      rtl: { isBackward: Xl(39), isForward: Xl(37) },
      isUp: Yl,
      isDown: Kl,
  ...
  var rs = function(t, n, r, e, o) {
    ...
    us = {
      ...
      moveBottomTo: function(n, e) {
        ...
        return is({ left: n.left(), top: e - t, right: n.right(), bottom: e });
      },
      moveTopTo: function(n, e) {
        var t = n.bottom() - n.top();
        return is({ left: n.left(), top: e, right: n.right(), bottom: e + t });
      },
      getTop: function(n) {
        return n.top();
      },
    ...
    hs = [
      { current: ds, next: ms, fallback: x.none() },
      { current: ms, next: gs, fallback: x.some(ds) },
      { current: gs, next: gs, fallback: x.some(ms) }
    ],
    ...
    vs = { backtrack: ds, sidestep: ms, advance: gs, go: ps },
    bs = {
      left: function() {
        return {
          sibling: function(n, e) {
    ...
    Ts = {
      ...
      seekRight: Ss,
      walkers: function() {
        return { left: bs.left, right: bs.right };
      },
    ...
    js = (V.immutable("ancestor", "descendants", "element", "index"),
    ...
    Vs = function(n, e, t, r) {
      ...
      return (Hs(e)
        ...
        return { start: y.constant(n), finish: y.constant(n) };
      });
    },
    Gs = function(n) {
      return Ls.cata(
      ...
      h.on("init", function(n) {
        var r = h.getWin(),
          ...
          u = function(n) {
            ...
            a.keydown(e, o, t.startOffset, i, t.endOffset, u).each(function(n) {
              c(e, n);
            }),
              p().each(function(n) {
                n.showBars();
        ...
        h.on("mousedown", d),
          ...
          (b = x.some(
            v({ mousedown: d, mouseover: m, mouseup: g, keyup: i, keydown: u })
          ));
      }),
      {
        clear: w.clear,
      ...
      var g = {
        ...
        p = {
          ...
          menu: [
            ...
            { text: "-" },
            { text: "Cut row", onclick: m("mceTableCutRow"), onPostRender: e },
            {
              text: "Copy row",
