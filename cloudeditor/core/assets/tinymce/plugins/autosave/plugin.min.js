!(function() {
  ...
  var n = function(t) {
    ...
    m = function(t, e) {
      ...
      return (
        "" === (e = o.trim(void 0 === e ? t.getBody().innerHTML : e)) ||
        new RegExp(
          "^<" +
            r +
            "[^>]*>((\xa0|&nbsp;|[ \t]|<br[^>]*>)+?|)</" +
    ...
    g = function(t) {
      var e = f(t);
      v(t) && (t.setContent(a.getItem(e + "draft"), { format: "raw" }), r(t));
    },
    y = {
      isEmpty: m,
      hasDraft: v,
    ...
    I = function(r, n) {
      return function(t) {
        ...
        e.disabled(!y.hasDraft(r)),
          r.on("StoreDraft RestoreDraft RemoveDraft", function() {
            e.disabled(!y.hasDraft(r));
          }),
