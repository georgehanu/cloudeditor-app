!(function() {
  ...
  var e,
    ...
    c = function(t) {
      var e = parseInt(t.getParam("toc_depth", "3"), 10);
      return 1 <= e && e <= 9 ? e : 3;
    },
    a = ((e = "mcetoc_"),
    (n = 0),
    ...
    d = function(t) {
      ...
      for (
        ...
        if (
          (((o = d[e]).element.id = o.id),
          (r = d[e + 1] && d[e + 1].level),
          u === o.level)
        )
          a += "<li>";
        else for (n = u; n < o.level; n++) a += "<ul><li>";
        if (
    ...
    o = {
      hasHeaders: function(t) {
        return 0 < v(t).length;
      },
      insertToc: function(t) {
        var e,
          n,
          o,
          r,
    ...
    r = function(t) {
      t.addCommand("mceInsertToc", function() {
        o.insertToc(t);
      }),
        t.addCommand("mceUpdateToc", function() {
          o.updateToc(t);
        });
    },
    h = function(t) {
    ...
    g = function(n) {
      return function(t) {
        var e = t.control;
        n.on("LoadContent SetContent change", function() {
          e.disabled(n.readonly || !o.hasHeaders(n));
        });
      };
    },
    T = function(t) {
