!(function() {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    j = function(e, t) {
      return (
        (c = t),
        (s = u.createFragment(c)),
        "" !== l(s.firstChild)
          ? ((o = t),
            (n = u.createFragment(o).firstChild),
            {
          ...
          : ((i = e),
            ...
            p({
              ...
              start: function(e, t) {
                if (
                  (a.source1 || "param" !== e || (a.source1 = t.map.movie),
                  ("iframe" !== e &&
                    "object" !== e &&
                    "embed" !== e &&
                    "video" !== e &&
                    "audio" !== e) ||
                    (a.type || (a.type = e), (a = v.extend(t.map, a))),
                  "script" === e)
                ) {
                  var r = x(i, t.map.src);
                  if (!r) return;
                ...
                "source" === e &&
                  (a.source1
                    ? a.source2 || (a.source2 = t.map.src)
                    : (a.source1 = t.map.src)),
                  "img" !== e || a.poster || (a.poster = t.map.src);
              }
            }).parse(r),
            (a.source1 = a.source1 || a.src || a.data),
            (a.source2 = a.source2 || ""),
            (a.poster = a.poster || ""),
            a)
      );
    ...
    k = function(e, t) {
      var r,
        i,
        a = S.createFragment(e).firstChild;
      return (
        f.setMaxWidth(a, t.width),
        f.setMaxHeight(a, t.height),
        (r = a.outerHTML),
        (i = _()),
        p(i).parse(r),
        i.getContent()
    ...
    A = function(e, t, r) {
      return (
        (u = e),
        (l = S.createFragment(u)),
        "" !== S.getAttrib(l.firstChild, "data-ephox-embed-iri")
          ? k(e, t)
          : ((i = e),
            (a = t),
            (o = r),
                ...
                start: function(e, t, r) {
                  switch (e) {
                    ...
                    case "iframe":
                      a.height !== undefined &&
                        a.width !== undefined &&
                        F(t, { width: a.width, height: a.height });
                  }
                  if (o)
                    switch (e) {
                      case "video":
                        F(t, { poster: a.poster, src: "" }),
                          a.source2 && F(t, { src: "" });
                        break;
                      case "iframe":
                        F(t, { src: a.source1 });
                  ...
                  if (a.poster && "object" === e && o && !n) {
                    var i = [];
                    (i.map = {}),
                      F(i, { src: a.poster, width: a.width, height: a.height }),
                      c.start("img", i, !0);
                  }
                  c.end(e);
                }
    ...
    c = function(r, e) {
      ...
      i.source2 || (i.source2 = ""),
        i.poster || (i.poster = ""),
        (i.source1 = r.convertURL(i.source1, "source")),
        (i.source2 = r.convertURL(i.source2, "source")),
        (i.source1mime = M(i.source1)),
        (i.source2mime = M(i.source2)),
        (i.poster = r.convertURL(i.poster, "poster"));
      var t,
        a,
        o = ((t = i.source1),
        0 <
      ...
      if (
        (o &&
          ((i.source1 = o.url),
          (i.type = o.type),
          (i.allowFullscreen = o.allowFullscreen),
          (i.width = i.width || o.w),
          (i.height = i.height || o.h)),
        i.embed)
      )
        return A(i.embed, i, !0);
      ...
      return (
        (i.width = i.width || 300),
        (i.height = i.height || 150),
        v.each(i, function(e, t) {
          i[t] = r.dom.encode(e);
        }),
        "iframe" === i.type
          ? ((p = (h = i).allowFullscreen ? ' allowFullscreen="1"' : ""),
            '<iframe src="' +
              h.source1 +
              '" width="' +
              h.width +
              ...
              p +
              "></iframe>")
          : "application/x-shockwave-flash" === i.source1mime
          ? ((d =
              '<object data="' +
              (m = i).source1 +
              '" width="' +
      ...
      return c
        ? ((a = t),
          ...
          new g(function(t, e) {
            var r = function(e) {
              return (
                e.html && (O[a.source1] = e),
                t({ url: a.source1, html: e.html ? e.html : o(a) })
              );
            };
            O[a.source1] ? r(O[a.source1]) : n({ url: a.source1 }, r, e);
          }))
        : ((r = t),
          (i = P(e)),
          new g(function(e) {
    ...
    U = function(a, o) {
      return function(e) {
        var t = e.html,
          r = a.find("#embed")[0],
          i = v.extend(j(w(o), t), { source1: e.url });
    ...
    B = function(i) {
      ...
      (r = (e = i).selection.getNode()),
        ...
        (t = o
          ...
          ? j(w(e), e.serializer.serialize(r, { selection: !0 }))
          : {});
      var u = {
        id: "mcemediasource",
        type: "textbox",
            ...
            start: function(e, t, r) {
              if (((o = !0), "script" !== e && "noscript" !== e)) {
                for (var i = 0; i < t.length; i++) {
                  ...
                  "style" === t[i].name &&
                    (t[i].value = a.dom.serializeStyle(
                      a.dom.parseStyle(t[i].value),
                      e
                    ));
                }
                n.start(e, t, r), (o = !1);
        ...
        for (var t, r, i = e.length; i--; )
          (t = e[i]).parent &&
            (t.parent.attr("data-mce-object") ||
              (("script" !== t.name || (r = x(w(a), t.attr("src")))) &&
                (r &&
                  (r.width && t.attr("width", r.width.toString()),
                  r.height && t.attr("height", r.height.toString())),
                "iframe" === t.name && n(a) && o.ceFalse
                  ? ee(t) || t.replace(Y(a, t))
                  : ee(t) || t.replace(X(a, t)))));
      };
    },
    re = function(d) {
      d.on("preInit", function() {
              ...
              if ((r = e[l]).parent) {
                for (
                  ...
                  0 === m.indexOf("data-mce-p-") &&
                    i.attr(m.substr(11), o[a].value);
                }
                "script" === s && i.attr("type", "text/javascript"),
                  (n = r.attr("data-mce-html")) &&
                    (((c = new K("#text", 3)).raw = !0),
                    (c.value = Q(d, unescape(n))),
                    i.append(c)),
                  r.replace(i);
              }
          });
        ...
        d.on("setContent", function() {
          d.$("span.mce-preview-object").each(function(e, t) {
            var r = d.$(t);
            0 === r.find("span.mce-shim", t).length &&
