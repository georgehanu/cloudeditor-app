...
!(function() {
  ...
  var e,
    ...
    j = function(e, t) {
      for (
        var n = t !== undefined && null !== t ? t : q, r = 0;
  ...
  (d = /Android/.test(G)),
    (a =
      (a =
        !(i = /WebKit/.test(G)) &&
        /MSIE/gi.test(G) &&
        /Explorer/gi.test(Y.appName)) && /MSIE (\w+)\./.exec(G)[1]),
    (u =
      -1 !== G.indexOf("Trident/") &&
      (-1 !== G.indexOf("rv:") || -1 !== Y.appName.indexOf("Netscape")) &&
      11),
    (s = -1 !== G.indexOf("Edge/") && !a && !u && 12),
    (a = a || u || s),
    (c = !i && !u && /Gecko/.test(G)),
    (l = -1 !== G.indexOf("Mac")),
    (f = /(iPad|iPhone)/.test(G)),
    (m =
      "FormData" in window &&
      "FileReader" in window &&
      "URL" in window &&
      !!X.createObjectURL),
    (p = J("only screen and (max-device-width: 480px)") && (d || f)),
    (g = J("only screen and (min-width: 800px)") && (d || f)),
    (h = -1 !== G.indexOf("Windows Phone")),
    s && (i = !1);
  var Q,
    Z,
    ee,
    ...
    ve = {
      ...
      android: d,
      contentEditable:
        !f || m || 534 <= parseInt(G.match(/AppleWebKit\/(\d*)/)[1], 10),
      transparentSrc:
    ...
    Re = function(e, t) {
      ...
      if (
        ...
        ve.experimentalShadowDom &&
          (s.target = ((r = e),
          (o = s.target),
          (a = o),
          (i = r.path) && 0 < i.length && (a = i[0]),
          r.composedPath &&
            (i = r.composedPath()) &&
            0 < i.length &&
            (a = i[0]),
      ...
      return (
        (s.preventDefault = function() {
          (s.isDefaultPrevented = ke),
            e && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1));
        }),
        (s.stopPropagation = function() {
          (s.isPropagationStopped = ke),
            e &&
        ...
        !(s.stopImmediatePropagation = function() {
          ...
          ((u = s).isDefaultPrevented === ke || u.isDefaultPrevented === Se) &&
          ((s.isDefaultPrevented = Se),
          (s.isPropagationStopped = Se),
          (s.isImmediatePropagationStopped = Se)),
    ...
    _e = function(e, t, n) {
      ...
      if (n.domLoaded) t(o);
        ...
        !r.addEventListener || (ve.ie && ve.ie < 11)
          ? (Te(r, "readystatechange", u),
            r.documentElement.doScroll && e.self === e.top && s())
          : i()
          ? a()
          : Te(e, "DOMContentLoaded", a),
          Te(e, "load", a);
      }
    },
    Be = function() {
      var m,
        ...
        y = this,
        b = {};
      (p = "mce-data-" + (+new Date()).toString(32)),
        (h = "onmouseenter" in document.documentElement),
        (g = "onfocusin" in document.documentElement),
            ...
            if (((s = b[r]), t)) {
              for (i = (t = t.split(" ")).length; i--; )
                if ((o = s[(u = t[i])])) {
                  ...
                  (n && 0 !== o.length) ||
                    (delete s[u],
                    Ae(e, o.fakeName || u, o.nativeHandler, o.capture));
                }
            } else {
              for (u in s)
                (o = s[u]), Ae(e, o.fakeName || u, o.nativeHandler, o.capture);
              s = {};
            }
            for (u in s) return y;
            delete b[r];
  ...
  try {
    $e.apply((Ve = We.call(Oe.childNodes)), Oe.childNodes),
      Ve[Oe.childNodes.length].nodeType;
  } catch (Dw) {
    $e = {
      apply: Ve.length
        ? function(e, t) {
  ...
  var mt = function(e, t, n, r) {
    ...
    if (
      ((t ? t.ownerDocument || t : Oe) !== fe && le(t),
      (n = n || []),
      !e || "string" != typeof e)
    )
      return n;
    ...
    if (me && !r) {
      if ((o = st.exec(e)))
        if ((a = o[1])) {
          ...
          if ((a = o[3]) && ee.getElementsByClassName)
  ...
  function pt() {
    ...
    return function e(t, n) {
      return (
        r.push(t + " ") > te.cacheLength && delete e[r.shift()],
        (e[t + " "] = n)
      );
    };
  }
  ...
  for (Z in ((ee = mt.support = {}),
  (re = mt.isXML = function(e) {
    var t = e && (e.ownerDocument || e).documentElement;
    return !!t && "HTML" !== t.nodeName;
  }),
  (le = mt.setDocument = function(e) {
    var t,
      s = e ? e.ownerDocument || e : Oe,
      n = s.defaultView;
    return s !== fe && 9 === s.nodeType && s.documentElement
      ? ((de = (fe = s).documentElement),
        (me = !re(s)),
        n &&
          n !==
            (function(e) {
        ...
        (ee.attributes = !0),
        (ee.getElementsByTagName = !0),
        (ee.getElementsByClassName = ut.test(s.getElementsByClassName)),
        (ee.getById = !0),
        ...
        (te.find.TAG = ee.getElementsByTagName
          ? function(e, t) {
              if (typeof t.getElementsByTagName !== Ue)
        ...
        (ge = []),
        (pe = []),
        (ee.disconnectedMatch = !0),
        (pe = pe.length && new RegExp(pe.join("|"))),
        (ge = ge.length && new RegExp(ge.join("|"))),
        (t = ut.test(de.compareDocumentPosition)),
        (he =
          t || ut.test(de.contains)
            ? function(e, t) {
                ...
                (1 &
                  (n =
                    (e.ownerDocument || e) === (t.ownerDocument || t)
                      ...
                      : 1) ||
                (!ee.sortDetached && t.compareDocumentPosition(e) === n)
                  ? e === s || (e.ownerDocument === Oe && he(Oe, e))
                    ? -1
                    : t === s || (t.ownerDocument === Oe && he(Oe, t))
                    ? 1
                    : se
                    ? Ke.call(se, e) - Ke.call(se, t)
                    : 0
                  : 4 & n
                  ? -1
                  : 1)
  ...
  (mt.matchesSelector = function(e, t) {
    if (
      ...
      (t = t.replace(tt, "='$1']")),
      ee.matchesSelector && me && (!ge || !ge.test(t)) && (!pe || !pe.test(t)))
    )
      try {
  ...
  (mt.attr = function(e, t) {
    ...
    var n = te.attrHandle[t.toLowerCase()],
      r =
        n && qe.call(te.attrHandle, t.toLowerCase()) ? n(e, t, !me) : undefined;
    return r !== undefined
      ? r
      : ee.attributes || !me
      ? e.getAttribute(t)
  ...
  (mt.uniqueSort = function(e) {
    var t,
      ...
      o = 0;
    if (
      ((ce = !ee.detectDuplicates),
      (se = !ee.sortStable && e.slice(0)),
      e.sort(ze),
      ce)
    ) {
  ...
  ((te = mt.selectors = {
    ...
    preFilter: {
      ATTR: function(e) {
        return (
          (e[1] = e[1].replace(ft, dt)),
          (e[3] = (e[3] || e[4] || e[5] || "").replace(ft, dt)),
          "~=" === e[2] && (e[3] = " " + e[3] + " "),
          e.slice(0, 4)
        );
      },
    ...
    filter: {
      ...
      CLASS: function(e) {
        ...
        return (
          t ||
          ((t = new RegExp("(^|" + Xe + ")" + e + "(" + Xe + "|$)")) &&
            Ie(e, function(e) {
              return t.test(
                ("string" == typeof e.className && e.className) ||
                  (typeof e.getAttribute !== Ue && e.getAttribute("class")) ||
                  ""
              );
            }))
        );
        ...
        return 1 === p && 0 === g
          ...
          : function(e, t, n) {
              ...
              if (l) {
                ...
                } else if (d && (r = (e[De] || (e[De] = {}))[m]) && r[0] === Pe)
                  a = r[1];
                else
                  for (
                    ;
    ...
    pseudos: {
      ...
      lang: gt(function(n) {
        return (
          rt.test(n || "") || mt.error("unsupported lang: " + n),
          (n = n.replace(ft, dt).toLowerCase()),
          function(e) {
            var t;
            do {
              if (
  ...
  { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }))
    te.pseudos[Z] = vt(Z);
  for (Z in { submit: !0, reset: !0 }) te.pseudos[Z] = yt(Z);
  function xt() {}
  function wt(e) {
    ...
    return (
      ...
      gt(function(e, t, n, r) {
        var o,
          ...
          d = g ? (v || (e ? m : c || h) ? [] : t) : f;
        if ((g && g(f, d, n, r), h))
          for (o = St(d, s), h(o, [], n, r), i = o.length; i--; )
            (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (v || m) {
            if (v) {
  ...
  (xt.prototype = te.filters = te.pseudos),
    (te.setFilters = new xt()),
    (oe = mt.tokenize = function(e, t) {
      var n,
        r,
        o,
        i,
      ...
      for (a = e, u = [], s = te.preFilter; a; ) {
        for (i in ((n && !(r = Ze.exec(a))) ||
          (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
        (n = !1),
        (r = et.exec(a)) &&
          ((n = r.shift()),
          o.push({ value: n, type: r[0].replace(Qe, " ") }),
          (a = a.slice(n.length))),
        te.filter))
          !(r = ot[i].exec(a)) ||
            (s[i] && !(r = s[i](r))) ||
        ...
        (a = Fe(
          ...
          (r = function(e, t, n, r, o) {
            ...
            if (((s += c), y && c !== s)) {
              ...
              if (e) {
                if (0 < s) for (; c--; ) l[c] || f[c] || (f[c] = He.call(r));
                f = St(f);
              }
              $e.apply(r, f),
                o && !e && 0 < f.length && 1 < s + v.length && mt.uniqueSort(r);
            }
    ...
    (ae = mt.select = function(e, t, n, r) {
      ...
      if (((n = n || []), 1 === l.length)) {
        if (
          ...
          if (!(t = (te.find.ID(a.matches[0].replace(ft, dt), t) || [])[0]))
            return n;
          c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
        }
        for (
          o = ot.needsContext.test(e) ? 0 : i.length;
          ...
          if (
            (s = te.find[u]) &&
            (r = s(
              a.matches[0].replace(ft, dt),
              (ct.test(i[0].type) && Ct(t.parentNode)) || t
            ))
          ) {
            if ((i.splice(o, 1), !(e = r.length && wt(i))))
              return $e.apply(n, r), n;
            break;
          }
      }
      return (
        (c || ie(e, l))(r, t, !me, n, (ct.test(e) && Ct(t.parentNode)) || t), n
      );
    }),
    (ee.sortStable =
      De.split("")
  ...
  var At = Array.isArray,
    ...
    Bt = {
      ...
      toArray: function(e) {
        var t,
          n,
          r = e;
        if (!At(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
        return r;
      },
      each: Rt,
      map: function(n, r) {
    ...
    Pt = function(e, t) {
      return t
        ? !("array" !== t || !Bt.isArray(e)) || typeof e === t
        : e !== undefined;
    },
    Lt = function(e, n, r, o) {
      (o = o || this),
    ...
    Wt = function(e, t, n, r) {
      ...
      if (jt(t)) t = $t(t, un(e[0]));
        ...
        else for (o = 0; o < t.length; o++) Wt(e, t[o], n, r);
        return e;
      }
    ...
    Jt = { for: "htmlFor", class: "className", readonly: "readOnly" },
    Qt = { float: "cssFloat" },
    Zt = {},
    en = {},
    tn = function(e, t) {
  ...
  (tn.fn = tn.prototype = {
    ...
    init: function(e, t) {
      ...
      if (jt(e)) {
        if (
          ...
          return tn(t).find(e);
        if (n[1])
          for (r = $t(e, un(t)).firstChild; r; )
            Ft.call(o, r), (r = r.nextSibling);
        else {
    ...
    add: function(e, t) {
      ...
      if (!1 !== t)
        for (
          n = tn.unique(o.toArray().concat(tn.makeArray(e))),
            o.length = n.length,
            r = 0;
          r < n.length;
          r++
    ...
    css: function(n, r) {
      ...
      if ("object" == typeof n)
        ...
        (n = t(n)),
          "number" != typeof r || Yt[n] || (r = r.toString() + "px"),
          i.each(function() {
            var e = this.style;
    ...
    remove: function() {
      for (var e, t = this.length; t--; )
        (e = this[t]), qt.clean(e), e.parentNode && e.parentNode.removeChild(e);
      return this;
    },
    empty: function() {
      for (var e, t = this.length; t--; )
  ...
  var sn = function(e, t, n) {
      var r = [],
        o = e[t];
      for (
        "string" != typeof n && n instanceof tn && (n = n[0]);
        o && 9 !== o.nodeType;
  ...
  on(
    ...
    (tn.fn.init.prototype = tn.fn),
    (tn.overrideDefaults = function(n) {
      var r,
        o = function(e, t) {
          return (
            (r = r || n()),
  ...
  var dn,
    ...
    Fn = { browsers: V.constant(In), oses: V.constant(Mn) },
    zn = function(e) {
      var t,
        n,
        r,
    ...
    ar = function(e, t, n) {
      if (!(k.isString(n) || k.isBoolean(n) || k.isNumber(n)))
        throw (console.error(
    ...
    Or = function(e) {
      return (
        (e.nodeType !== Br && e.nodeType !== Dr) || 0 === e.childElementCount
      );
    },
    Pr = {
      all: function(e, t) {
    ...
    $r = {
      ...
      parents: function(e, t) {
        for (
          var n = k.isFunction(t) ? t : V.constant(!1), r = e.dom(), o = [];
      ...
      getPos: function(e, t, n) {
        ...
        if (((n = n || e), t)) {
          if (
            n === e &&
            t.getBoundingClientRect &&
            "static" === br(Vn.fromDom(e), "position")
          )
            return {
              x: (a =
                (o = t.getBoundingClientRect()).left +
  ...
  var uo,
    ...
    lo = function(t) {
      var n;
      return function(e) {
        return (n = n || H.mapToObject(t, V.constant(!0))).hasOwnProperty(
          Zn.name(e)
        );
      };
    },
        ...
        return e.replace(qo, function(e, t) {
          return t
            ...
            : co[e] ||
                uo[e] ||
                ((n = e),
                ((r = Vn.fromTag("div").dom()).innerHTML = n),
    ...
    ni = function(e) {
      ...
      return Xo[e]
        ...
        : ((u = "id accesskey class dir lang style tabindex title role"),
          ...
          Jo(ti("a form meter progress dfn"), function(e) {
  ...
  function oi(i) {
    var e,
      ...
      v = function(e, t, n) {
        ...
        return (
          r
            ? (r = Go(r, /[, ]/, Go(r.toUpperCase(), /[, ]/)))
            : (r = Xo[e]) ||
              ((r = Go(t, " ", Go(t.toUpperCase(), " "))),
              (r = Qo(r, n)),
              (Xo[e] = r)),
          r
        );
    ...
    (n = ni((i = i || {}).schema)),
      ...
      (e = ri(i.valid_styles)),
      (t = ri(i.invalid_styles, "map")),
      (s = ri(i.valid_classes, "map")),
      (r = v(
        "whitespace_elements",
    ...
    var S = function(e) {
      ...
      C = function(e) {
        var a = /^(~)?(.+)$/;
        e &&
          ((Xo.text_block_elements = Xo.block_elements = null),
          Jo(ti(e, ","), function(e) {
            var t = a.exec(e),
              n = "~" === t[1],
              r = n ? "span" : "div",
            ...
            if (
              ...
              var i = N[r];
              delete (i = Qo({}, i)).removeEmptyAttrs,
    ...
    return (
      i.valid_elements
        ...
        : (Jo(n, function(e, t) {
          ...
          "html5" !== i.schema &&
            Jo(ti("strong/b em/i"), function(e) {
          ...
          Jo(
            ti("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
            function(e) {
              N[e].paddEmpty = !0;
            }
          ),
      ...
      i.invalid_elements &&
        Jo(Zo(i.invalid_elements), function(e) {
          N[e] && delete N[e];
        }),
            ...
            if (
              ...
              "font-weight" === n && "700" === r
                ...
                : ("color" !== n && "background-color" !== n) ||
                  (r = r.toLowerCase()),
                (r = (r = r.replace(x, ii)).replace(w, y)),
                (c[n] = o ? g(r, !0) : r);
            }
          d("border", "", !0),
            d("border", "-width"),
  ...
  function hi(a, u) {
    ...
    var r = {},
          ...
          t = function(t) {
            return Zr.nu(function(e) {
              n(
                ...
                V.compose(
                  e,
                  V.constant(io.value(t))
                ),
                V.compose(
                  e,
                  V.constant(io.error(t))
                )
              );
            });
          },
        ...
        return n
          ...
          : ("float" ===
              (t = t.replace(/-(\D)/g, function(e, t) {
                return t.toUpperCase();
              })) && (t = ve.ie && ve.ie < 12 ? "styleFloat" : "cssFloat"),
      ...
      T = function(e, n, r) {
        ...
        if (!t) return !1;
        if (It.isArray(t) && (t.length || 0 === t.length))
          return (
            (o = []),
            si(t, function(e, t) {
              e &&
                ("string" == typeof e && (e = g(e)), o.push(n.call(r, e, t)));
            }),
            o
          );
        var i = r || c;
      ...
      I = function(t, e, n) {
        return T(e, function(e) {
          return (
            It.is(e, "array") && (t = t.cloneNode(!0)),
            n &&
              si(ci(e.childNodes), function(e) {
                t.appendChild(e);
              }),
        ...
        loadCSS: function(e) {
          ...
          q === hi.DOM || a !== document
            ? (e || (e = ""),
              ...
              si(e.split(","), function(e) {
                var t;
                (e = It._addCacheSuffix(e)),
                  o[e] ||
                    ((o[e] = !0),
                    (t = B("link", { rel: "stylesheet", href: e })),
                    n.appendChild(t));
              }))
            : hi.DOM.loadCSS(e);
        },
            ...
            (s = function() {
              ...
              if (
                ...
                (a.length = 0),
                  bi(t, function(e) {
                    0 === c.length
                      ? xi(e.success) && e.success.call(e.scope)
                      : xi(e.failure) && e.failure.call(e.scope, c);
                  });
              }
            })();
        });
  ...
  var ki,
    ...
    Oi = function(e) {
      return (
        Di(e) && (e = e.parentNode), Bi(e) && e.hasAttribute("data-mce-caret")
      );
    },
    Pi = function(e) {
    ...
    Vi = function(e) {
      return e && e.hasAttribute("data-mce-caret")
        ? ((t = e.getElementsByTagName("br")),
          (n = t[t.length - 1]),
          Oo.isBogus(n) && n.parentNode.removeChild(n),
    ...
    Ji = function(e) {
      return (
        !Gi(e) && (Wi(e) ? !Ki(e.parentNode) : Xi(e) || $i(e) || Yi(e) || Qi(e))
      );
    },
    Qi = function(e) {
      return (
        !1 ===
          ((t = e),
          Oo.isElement(t) && "true" === t.getAttribute("unselectable")) && ji(e)
      );
      var t;
    },
    Zi = function(e, t) {
    ...
    oa = function(e, t) {
      return (
        ...
        (!(e.top > t.bottom) && ra(t.top - e.bottom, e, t))
      );
    },
    ia = function(e, t) {
      return (
        e.top > t.bottom || (!(e.bottom < t.top) && ra(t.bottom - e.top, e, t))
      );
    },
    aa = function(e) {
      ...
      var t,
        ...
        i = function(e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (
              ca(e.data[t - 1]) &&
              (n.setStart(e, t), n.setEnd(e, t + 1), !Ta(n))
            )
              return o(_a(Ra(n), !1)), r;
          }
          0 < t &&
            (n.setStart(e, t - 1), n.setEnd(e, t), Ta(n) || o(_a(Ra(n), !1))),
            t < e.data.length &&
              (n.setStart(e, t), n.setEnd(e, t + 1), Ta(n) || o(_a(Ra(n), !0)));
        };
      if (Ca(e.container())) return i(e.container(), e.offset()), r;
      if (pa(e.container()))
        if (e.isAtEnd())
          (n = Na(e.container(), e.offset())),
            Ca(n) && i(n, n.data.length),
            ya(n) && !xa(n) && o(_a(Ra(n), !1));
        else {
          if (
            ((n = Na(e.container(), e.offset())),
            Ca(n) && i(n, 0),
            ...
            return o(_a(Ra(n), !1)), r;
          (t = Na(e.container(), e.offset() - 1)),
            ya(t) && !xa(t) && (ha(t) || ha(n) || !ya(n)) && o(_a(Ra(t), !1)),
            ya(n) && o(_a(Ra(n), !0));
        }
      return r;
    };
  ...
  ((ki = Da || (Da = {})).fromRangeStart = function(e) {
    ...
    (ki.isAbove = function(e, t) {
      return ma(
        [H.head(t.getClientRects()), H.last(e.getClientRects())],
        oa
      ).getOr(!1);
    }),
    (ki.isBelow = function(e, t) {
      return ma(
        [H.last(t.getClientRects()), H.head(e.getClientRects())],
        ia
      ).getOr(!1);
    }),
  ...
  var Oa,
    ...
    Va = function(e, t) {
      return Ma(e) && t.container() === e
        ? ((r = t),
          (o = Ua((n = e).data.substr(0, r.offset()))),
          (i = Ua(n.data.substr(r.offset()))),
          0 < (a = o.text + i.text).length
            ? (za(n, a), La(n, r.offset() - o.count))
            : r)
        : qa(e, t);
      var n, r, o, i, a;
    },
    Ha = function(e, t) {
      return t.container() === e.parentNode
        ? ((n = e),
          (o = (r = t).container()),
          (i = H.indexOf(H.from(o.childNodes), n)
            .map(function(e) {
    ...
    ja = function(e) {
      if (
        (Ia(e) &&
          Li(e) &&
          (Ii(e) ? e.removeAttribute("data-mce-caret") : Fa(e)),
        Ma(e))
      ) {
        var t = _i(
          (function(e) {
    ...
    Ya = function(e, t, n) {
      return e
        ? !Xa(t, n) &&
            ((r = t), !(!La.isTextPosition(r) && Oo.isBr(r.getNode()))) &&
            Ka(t) &&
            Wa(n)
        : !Xa(n, t) && Wa(t) && Ka(n);
      var r;
    ...
    Ja = function(e, t) {
      ...
      return Oo.isText(u)
        ? A.some(La(u, e ? 0 : u.data.length))
        : u
        ? Ji(u)
          ? A.some(
              e
                ? La.before(u)
                : ((a = u), Oo.isBr(a) ? La.before(a) : La.after(a))
            )
          : ((r = t),
            (o = u),
            (i = (n = e) ? La.before(o) : La.after(o)),
            Ga(n, r, i))
        : A.none();
    },
    Qa = {
  ...
  var iu,
    ...
    su = function(e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = Ys(n), f = r, d = [];
        f &&
        ((s = l), (c = f), (o = t === iu.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (Oo.isBr(o.getNode(!1)))
          return t === iu.Forwards
            ? {
                positions: uu(t, d).concat([o]),
                breakType: Oa.Br,
                breakAt: A.some(o)
              }
            : { positions: uu(t, d), breakType: Oa.Br, breakAt: A.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var m = ((i = t),
            (a = f),
            (u = o),
            Oo.isBr(u.getNode(i === iu.Forwards))
              ? Oa.Br
              : !1 === bs(a, u)
              ? Oa.Block
              : Oa.Wrap);
            return { positions: uu(t, d), breakType: m, breakAt: A.some(o) };
          }
          d.push(o), (f = o);
        } else f = o;
      }
      return { positions: uu(t, d), breakType: Oa.Eol, breakAt: A.none() };
    },
    cu = function(n, r, o, e) {
      return r(o, e)
      ...
      return H.foldl(
        ...
        function(e, o) {
          return e.fold(
            ...
            function(r) {
              return ma(
                [H.head(r.getClientRects()), H.head(o.getClientRects())],
                function(e, t) {
    ...
    vu = function(e, t, n, r, o) {
      var i,
        ...
        s,
        c,
        l = hu(Vn.fromDom(n), "td,th").map(function(e) {
          return e.dom();
        }),
        f = H.filter(
          ((i = e),
    ...
    Cu = function(t, n) {
      return H.head(n.getClientRects())
        .bind(function(e) {
    ...
    xu = function(t, n) {
      return H.last(n.getClientRects())
        .bind(function(e) {
    ...
    Nu = function(e, t, n) {
      ...
      if (
        ...
        !u.isDefaultPrevented() && Oo.isElement(t))
      ) {
    ...
    Ku = function(t, n, e) {
      var r = t(n, e);
      return r.breakType === Oa.Wrap && 0 === r.positions.length
        ? r.breakAt
            .map(function(e) {
    ...
    Qu = function(u, s, c) {
      ...
      e.fold(
        ...
        function(a) {
          return Qa.positionIn(t, u.getBody())
            .filter(function(e) {
              return e.isEqual(c);
            })
            .fold(
                ...
                return (
                  ...
                  void ((i = Ou((r = u)))
                    ? r.undoManager.transact(function() {
                        var e = Vn.fromTag(i);
                        lr.setAll(e, Pu(r)),
                          Hu.append(e, Vn.fromTag("br")),
                          n
                            ? Hu.after(Vn.fromDom(o), e)
                            : Hu.before(Vn.fromDom(o), e);
    ...
    os = function(e, t, n) {
      var r,
        ...
        a,
        u,
        s = na(t.getBoundingClientRect(), n);
      return (
        "BODY" === e.tagName
    ...
    is = function(a, u, e) {
      var t,
        ...
        l = function() {
          !(function(e) {
            var t, n, r, o, i;
            for (
              t = tn("*[contentEditable=false]", e), o = 0;
              o < t.length;
              o++
            )
        ...
        f = function() {
          t = we.setInterval(function() {
            e()
              ? tn("div.mce-visual-caret", a).toggleClass(
                  "mce-visual-caret-hidden"
                )
              : tn("div.mce-visual-caret", a).addClass(
                  "mce-visual-caret-hidden"
                );
          }, 500);
        };
      return {
        show: function(t, e) {
          var n, r, o;
          if ((l(), (o = e), Oo.isElement(o) && /^(TD|TH)$/i.test(o.tagName)))
            return null;
          if (!u(e))
            return (
              (s = (function(e, t) {
                var n, r, o;
                if (
                  ((r = e.ownerDocument.createTextNode(Ri)),
                  (o = e.parentNode),
                  t)
                ) {
    ...
    vs = function(e, t, n, r, o) {
      ...
      if (gs(t)) {
        ...
        for (; (e = hs(i.prev, o)); ) if (n(e)) return e;
      }
      if (ps(t)) {
        if ((us(e) || ls(e)) && n((e = hs(i.next, !0)))) return e;
        for (; (e = hs(i.next, o)); ) if (n(e)) return e;
      }
      return null;
    },
    ys = function(e, t) {
    ...
    Ss = function(e, t, n) {
      ...
      if (Oo.isText(o)) {
        ...
        if (qi(o) && i >= o.data.length - 1)
          return 1 === e && (r = s(o)) ? Ns(r) : n;
    ...
    Ds = fs(Ts, 0),
    Os = fs(Ts, -1);
  ((au = iu || (iu = {}))[(au.Backwards = -1)] = "Backwards"),
    (au[(au.Forwards = 1)] = "Forwards");
  var Ps,
    Ls,
    Is,
    Ms,
    ...
    Ks = function(e, t) {
      if (ps(e)) {
        if (Hs(t.previousSibling) && !Us(t.previousSibling))
          return La.before(t);
    ...
    Xs = function(e, t, n) {
      ...
      if (t.isEqual(La.after(n)) && n.lastChild) {
        if (
          ((u = La.after(n.lastChild)),
          gs(e) && Hs(n.lastChild) && qs(n.lastChild))
        )
          return Vs(n.lastChild) ? La.before(n.lastChild) : u;
      } else u = t;
      var s,
        c,
        l,
      ...
      if (Us(f)) {
        ...
        if (gs(e) && 0 < d && ((o = Ws(f, d - 1)), Hs(o)))
          return !js(o) && (i = vs(o, e, $s, o))
            ? Us(i)
              ? La(i, i.data.length)
              : La.after(i)
            : Us(o)
            ? La(o, o.data.length)
            : La.before(o);
        if (ps(e) && d < f.childNodes.length && ((o = Ws(f, d)), Hs(o)))
          return Vs(o) && n.lastChild === o
            ? null
            : ((s = o),
              (c = n),
              Oo.isBr(s) &&
              (l = Xs(1, La.after(s), c)) &&
              !bs(La.before(s), La.before(l), c)
                ? Xs(e, La.after(o), n)
                : !js(o) && (i = vs(o, e, $s, o))
                ? Us(i)
                  ? La(i, 0)
      ...
      return ((ps(e) && u.isAtEnd()) || (gs(e) && u.isAtStart())) &&
        ((r = vs(r, e, da.constant(!0), n, !0)), $s(r, n))
        ? Ks(e, r)
        : ((o = vs(r, e, $s, n)),
          !(a = Bt.last(
            Bt.filter(
    ...
    Js = function(e) {
      return (
        ...
        ("\xa0" === (t = e.firstChild).data || Oo.isBr(t))
      );
      var t;
    },
    Qs = function(e) {
      return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Js(t))
        ? e.slice(0, -1)
        : e;
      var t;
    },
    ...
    tc = function(t, e, n) {
      var r,
        ...
        u = t.parentNode;
      return (
        It.each(e, function(e) {
          u.insertBefore(e, t);
        }),
        (r = t),
        (o = n),
        (i = La.before(r)),
        (a = Ys(o).next(i)) ? a.toRange() : null
      );
    },
    nc = function(e, t) {
      var n,
    ...
    fc = function(e) {
      ...
      return (
        ...
        (r = Bt.filter(r, Oo.matchNodeNames(t.nodeName))),
        (n = Bt.findIndex(r, lc(t), t)) - o) +
        "]"
      );
    },
    dc = function(e, t) {
      ...
      return (
        ...
        (a = Bt.filter(a, da.negate(Oo.isBogus))),
        (u = u.concat(
          Bt.map(a, function(e) {
            return fc(e);
          })
          ...
          (r = Bt.reduce(
            ...
            function(e, t) {
              return (t = /([\w\-\(\)]+)\[([0-9]+)\]/.exec(t))
                ? ("text()" === t[1] && (t[1] = "#text"),
                  ...
                  (o = parseInt(t[2], 10)),
                  (i = cc(n)),
                  (i = Bt.filter(i, function(e, t) {
                    return !ic(e) || !ic(i[t - 1]);
                  })),
                  (i = Bt.filter(i, Oo.matchNodeNames(r)))[o])
                : null;
              var n, r, o, i;
            },
            e
            ...
            ? ic(r)
              ? (function(e, t) {
                  ...
                  return (
                    ic(e) && t > e.data.length && (t = e.data.length), La(e, t)
                  );
                })(r, parseInt(o, 10))
              : ((o = "after" === o ? uc(r) + 1 : uc(r)), La(r.parentNode, o))
            : null)
        : null;
    },
    ...
    Cc = function(e, t) {
      ...
      if (Li(e)) {
        if (
          (Oo.isText(e) && Oi(e) && (e = e.parentNode),
          (n = e.previousSibling),
          pc(n))
        )
          return n;
    ...
    xc = function(e, t, n) {
      var r = n.getNode(),
        o = r ? r.nodeName : null,
        i = n.getRng();
      if (pc(r) || "IMG" === o) return { name: o, index: vc(n.dom, o, r) };
      var a,
        u,
        s,
        c,
        ...
        d,
        m =
          Cc((a = i).startContainer, a.startOffset) ||
          Cc(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: vc(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
          ((d = {}).start = gc(f, u, c, l, !0)),
          s.isCollapsed() || (d.end = gc(f, u, c, l, !1)),
          d);
    },
    wc = function(e, t, n) {
      var r = {
    ...
    Nc = function(e, t) {
      var n = e.dom,
        ...
        a = e.getNode(),
        u = a.nodeName;
      if ("IMG" === u) return { name: u, index: vc(n, u, a) };
    ...
    Rc = function(e, t) {
      return Qa.lastPositionIn(e).fold(
        function() {
          return !1;
        },
        function(e) {
    ...
    _c = function(e, t, n) {
      return !(
        ...
        !Tc(e, t) ||
        ((o = n),
        (i = (r = t).ownerDocument.createTextNode(Ri)),
        r.appendChild(i),
        o.setStart(i, 0),
        o.setEnd(i, 0),
        0)
      ...
      if (c) {
        if (
          ...
          for (
            a = c.previousSibling,
              i = c.nextSibling,
              It.each(It.grep(c.childNodes), function(e) {
                Oo.isText(e) &&
    ...
    Pc = function(e, t) {
      var n,
        ...
        y = e.dom;
      if (t) {
        if (((v = t), It.isArray(v.start)))
          return (
            (g = t),
            (h = (p = y).createRng()),
            Bc(p, !0, g, h) && Bc(p, !1, g, h) ? A.some(h) : A.none()
          );
        if ("string" == typeof t.start)
          return A.some(
            ((f = t),
            (d = (l = y).createRng()),
            (m = mc(l.getRoot(), f.start)),
            d.setStart(m.container(), m.offset()),
            (m = mc(l.getRoot(), f.end)),
        ...
        if (t.hasOwnProperty("id"))
          return (
            (s = Oc((o = y), "start", (i = t))),
            (c = Oc(o, "end", i)),
            ma([s, ((a = c), (u = s), a.isSome() ? a : u)], function(e, t) {
              var n = o.createRng();
              return (
                n.setStart(Ac(o, e.container()), e.offset()),
                n.setEnd(Ac(o, t.container()), t.offset()),
                n
              );
            })
          );
    ...
    Hc = {
      empty: function(e) {
        (e.dom().textContent = ""),
          H.each($r.children(e), function(e) {
            Vc(e);
          });
      },
      remove: Vc,
    ...
    (Ms = Un.detect().browser),
    {
      get: function(e) {
        if (!Ps(e))
          throw new Error("Can only get " + Ls + " value of a " + Ls + " node");
        return Fs(e).getOr("");
      },
      getOption: (Fs =
        Ms.isIE() && 10 === Ms.version.major
          ? function(e) {
              try {
                return Is(e);
              } catch (Dw) {
      ...
      set: function(e, t) {
        if (!Ps(e))
          throw new Error(
            "Can only set raw " + Ls + " value of a " + Ls + " node"
          );
        e.dom().nodeValue = t;
      }
    }),
    ...
    Wc = function(e) {
      var t = hu(e, "br"),
        n = H.filter(
          (function(e) {
            for (var t = [], n = e.dom(); n; )
              t.push(Vn.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          go
        );
  ...
  function Gc(e) {
    ...
    return (
      (u = (e = e || {}).indent),
      (s = Yc(e.indent_before || "")),
      (c = Yc(e.indent_after || "")),
      (l = Ko.getEncodeFunc(e.entity_encoding || "raw", e.entities)),
  ...
  var Qc = function(a) {
    ...
    tl = function(o, e, t) {
      var n,
        ...
        m,
        p,
        g = o.schema.getTextInlineElements(),
        h = o.selection,
        v = o.dom;
      if (
        (/^ | $/.test(e) &&
        ...
        (n = o.parser),
        (p = t.merge),
        (r = Jc({ validate: o.settings.validate }, o.schema)),
        (m =
        ...
        if (
          ((u = n.parse(e, T)), !0 === t.paste && nc(o.schema, u) && oc(v, i))
        )
          return (
            (l = rc(r, v, o.selection.getRng(), u)),
        ...
        !(function() {
          ...
          (E = o.getBody()),
          It.each(E.getElementsByTagName("*"), function(e) {
            e.removeAttribute("data-mce-fragment");
          }),
          (S = o.dom),
          (k = o.selection.getStart()),
          A.from(S.getParent(k, "td,th"))
            .map(Vn.fromDom)
            .each(Xc),
          o.fire("SetContent", s),
          o.addVisual();
    ...
    nl = function(e, t) {
      var n,
        ...
        o =
          "string" != typeof (n = t)
            ? ((r = It.extend({ paste: n.paste, data: { paste: n.paste } }, n)),
  ...
  var ol = function(e, t, n) {
      for (
        var r = e.dom(), o = k.isFunction(n) ? n : V.constant(!1);
        r.parentNode;
    ...
    al = function(e, r) {
      var o = function(e) {
        for (var t = 0; t < e.childNodes.length; t++) {
          if (r(Vn.fromDom(e.childNodes[t])))
            return A.some(Vn.fromDom(e.childNodes[t]));
    ...
    ul = {
      ...
      sibling: function(t, n) {
        var e = t.dom();
        return e.parentNode
          ? il(Vn.fromDom(e.parentNode), function(e) {
    ...
    pl = function(e, t, n, r) {
      var o,
        i,
        a = dl(n.forced_plugins),
        u = dl(r.plugins),
        s =
          e && ml(t, "mobile")
            ? ((o = u), H.filter(o, V.curry(H.contains, ll)))
            : u,
        c = ((i = s), [].concat(dl(a)).concat(dl(i)));
      return It.extend(r, { plugins: c.join(" ") });
    },
    gl = function(e, t, n, r) {
      var o,
        i,
        ...
        y = It.extend(
            ...
            : {}),
          {
            ...
            external_plugins: ((u = n),
            (s = v.settings()),
            (c = s.external_plugins ? s.external_plugins : {}),
            u && u.external_plugins ? It.extend({}, u.external_plugins, c) : c)
          }
        );
      return pl(e, v, n, y);
    },
          ...
          "string" == typeof (i = u)
            ? H.each(
                ...
                function(e) {
                  var t = e.split("=");
                  1 < t.length
                    ? (a[It.trim(t[0])] = It.trim(t[1]))
                    : (a[It.trim(t[0])] = It.trim(t));
                }
              )
            : (a = i),
          a)
        : "string" === r
        ? hl(k.isString, e, t).getOr(n)
        : "number" === r
        ? hl(k.isNumber, e, t).getOr(n)
        : "boolean" === r
        ? hl(k.isBoolean, e, t).getOr(n)
        : "object" === r
        ? hl(k.isObject, e, t).getOr(n)
        : "array" === r
        ? hl(k.isArray, e, t).getOr(n)
        : "string[]" === r
        ? hl(
            ((o = k.isString),
            function(e) {
    ...
    Cl = function(e, t) {
      ...
      return e
        ? Pi(n)
          ...
          : t
        : Pi(n)
        ? Oo.isText(n.previousSibling)
          ? La(n.previousSibling, n.previousSibling.data.length)
          : La.before(n)
        : Fi(t)
        ? La(n, r - 1)
        : t;
    ...
    xl = {
      ...
      findRootInline: function(e, t, n) {
        var r,
          ...
          (o = t),
          (i = n),
          H.filter(vi.DOM.getParents(i.container(), "*", o), r));
        return A.from(a[a.length - 1]);
      },
      isRtl: function(e) {
        return (
          "rtl" === vi.DOM.getStyle(e, "direction", !0) ||
          ((t = e.textContent), bl.test(t))
        );
        var t;
      },
      isAtZwsp: function(e) {
    ...
    Bl = function(e, t) {
      return (
        (Ji(t) && !1 === _l(e, t)) ||
        ((n = t),
        Oo.isElement(n) && "A" === n.nodeName && n.hasAttribute("name")) ||
        Dl(t)
      );
      var n;
    },
    ...
    zl = function(o, i, e) {
          ...
          return Qa.fromPosition(i, o, e.position()).bind(function(e) {
            return Fl(o, e).map(function(e) {
              return (
                ...
                (n = i),
                (r = e),
                Oo.isBr(r.position().getNode()) && !1 === Ll(r.block())
                  ? Qa.positionIn(!1, r.block().dom())
                      .bind(function(e) {
                        return e.isEqual(r.position())
                          ? Qa.fromPosition(n, t, e).bind(function(e) {
                              return Fl(t, e);
                            })
                          : A.some(r);
                      })
      ...
      return ma([t, n], Ml).filter(function(e) {
        return (
          (r = e),
          !1 === Mr.eq(r.from().block(), r.to().block()) &&
            ((n = e),
            $r
              .parent(n.from().block())
              .bind(function(t) {
              ...
              .isSome()) &&
            ((t = e),
            !1 === Oo.isContentEditableFalse(t.from().block()) &&
              !1 === Oo.isContentEditableFalse(t.to().block()))
        );
        var t, n, r;
      });
    },
    ...
    Yl = function(n, r, o) {
      if (Ll(o))
        return Hc.remove(o), Ll(r) && Kc(r), Qa.firstPositionIn(r.dom());
      Wl(!0, r), Wl(!1, o);
      var i = $l(r);
      return Xl(r, o).fold(
        function() {
    ...
    Jl = function(t, n) {
      var e,
        r = Vn.fromDom(t.getBody());
      return (
        (e = Ul(r.dom(), n, t.selection.getRng()).bind(function(e) {
    ...
    Zl = function(e, t) {
      var n,
        r,
        o = Qa.prevPosition(e.dom(), La.fromRangeStart(t)).isNone(),
        i = Qa.nextPosition(e.dom(), La.fromRangeEnd(t)).isNone();
      return (
        !(Ql((n = e), (r = t).startContainer) || Ql(n, r.endContainer)) &&
        o &&
        i
      );
    },
    ef = function(e) {
      ...
      return Zl(i, a)
        ...
        : ((n = i),
          ...
          ma(
            [
              wl(n, Vn.fromDom(o.startContainer)),
              wl(n, Vn.fromDom(o.endContainer))
            ],
            function(e, t) {
              return (
                !1 === Mr.eq(e, t) &&
    ...
    of = function(e, t, n, r) {
      var o = r.getNode(!1 === t);
      return wl(Vn.fromDom(e), Vn.fromDom(n.getNode()))
        .map(function(e) {
    ...
    af = function(u, s, c) {
      return Qa.fromPosition(s, u, c).bind(function(e) {
        return (
          (a = e.getNode()),
          xo(Vn.fromDom(a)) || yo(Vn.fromDom(a))
            ? A.none()
            : ((t = u),
              (o = e),
              (i = function(e) {
              ...
              As(!(n = s), (r = c)).fold(function() {
                ...
                ? A.none()
                : s && Oo.isContentEditableFalse(e.getNode())
                ? of(u, s, c, e)
                : !1 === s && Oo.isContentEditableFalse(e.getNode(!0))
                ? of(u, s, c, e)
                : s && Bs(c)
                ? A.some(rf.moveToPosition(e))
                : !1 === s && _s(c)
                ? A.some(rf.moveToPosition(e))
                : A.none())
        );
    ...
    uf = function(r, e, o) {
      return (
        ...
        (a = o.getNode(!1 === i)),
        (u = i ? "after" : "before"),
        Oo.isElement(a) && a.getAttribute("data-mce-caret") === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            t && Oo.isContentEditableFalse(n.nextSibling)
              ? A.some(rf.moveToElement(n.nextSibling))
              : !1 === t && Oo.isContentEditableFalse(n.previousSibling)
              ? A.some(rf.moveToElement(n.previousSibling))
              : A.none()).fold(function() {
              return af(r, e, o);
            }, A.some)
          : af(r, e, o).bind(function(e) {
              return (
                (t = r),
                (n = o),
                e.fold(
    ...
    sf = function(e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === La.isTextPosition(n) &&
        o === r.parentNode &&
        i > La.before(r).offset()
          ? La(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    cf = function(e) {
      return Ji(e.previousSibling)
        ? A.some(
            ((t = e.previousSibling),
            Oo.isText(t) ? La(t, t.data.length) : La.after(t))
          )
        : e.previousSibling
        ? Qa.lastPositionIn(e.previousSibling)
        : A.none();
      var t;
    },
    lf = function(e) {
      return Ji(e.nextSibling)
        ? A.some(((t = e.nextSibling), Oo.isText(t) ? La(t, 0) : La.before(t)))
        : e.nextSibling
        ? Qa.firstPositionIn(e.nextSibling)
        : A.none();
      var t;
    },
    ff = function(r, o) {
      return cf(o)
        ...
        .orThunk(function() {
          return (
            ...
            Qa.prevPosition(e, n).fold(function() {
      ...
      return lf(r)
        ...
        .orThunk(function() {
          return (
            (e = n),
            (t = r),
            Qa.nextPosition(e, La.after(t)).fold(function() {
    ...
    mf = function(e, t, n) {
      return ((r = e), (o = t), (i = n), r ? df(o, i) : ff(o, i)).map(
        V.curry(sf, n)
      );
      var r, o, i;
    },
    ...
    vf = function(t, n, e) {
      var r,
        ...
        s = ((a = e),
        (o = i),
        ma([$r.prevSibling(a), $r.nextSibling(a), o], function(e, t, n) {
          var r,
            o = e.dom(),
            i = t.dom();
          return Oo.isText(o) && Oo.isText(i)
            ? ((r = o.data.length),
              o.appendData(i.data),
              Hc.remove(t),
              Hc.remove(a),
              n.container() === i ? La(o, r) : n)
            : (Hc.remove(a), n);
        }).orThunk(function() {
    ...
    yf = function(a, u) {
      ...
      (o = La.fromRangeStart(r)),
      !1 === t && Bs(o)
        ? A.some(rf.remove(o.getNode(!0)))
        : t && _s(o)
        ? A.some(rf.remove(o.getNode()))
        : uf(e, t, o))
        .map(function(e) {
          return e.fold(
            ((o = a),
    ...
    bf = function(e, t) {
      ...
      return (
        !!Oo.isContentEditableFalse(r) &&
        ((n = Vn.fromDom(e.getBody())),
        H.each(hu(n, ".mce-offscreen-selection"), Hc.remove),
        vf(e, t, Vn.fromDom(e.selection.getNode())),
        Nl(e),
        !0)
      );
    },
    ...
    xf = function(e) {
      var t,
        n = (function(e, t) {
          for (; t && t !== e; ) {
            if (Oo.isContentEditableTrue(t) || Oo.isContentEditableFalse(t))
              return t;
            t = t.parentNode;
          }
          return null;
      ...
      return (
        Oo.isContentEditableTrue(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
          ((t = e.dom.create("br", { "data-mce-bogus": "1" })),
          e.dom.setHTML(n, ""),
          n.appendChild(t),
          e.selection.setRng(La.before(t).toRange())),
        !0
      );
    },
    wf = Oo.isText,
    ...
    kf = function(e, t) {
      return e
        ? (function(e) {
            if (wf(e.previousSibling))
              return (
                Ef(e.previousSibling) || e.previousSibling.appendData(Ri),
                e.previousSibling
              );
        ...
        : (function(e) {
            if (wf(e.nextSibling))
              return (
                Nf(e.nextSibling) || e.nextSibling.insertData(0, Ri),
                e.nextSibling
              );
    ...
    Lf = function(e, t, n) {
      ...
      return xl.findRootInline(e, o, r).fold(function() {
        return Qa.nextPosition(o, r)
          .bind(V.curry(xl.findRootInline, e, o))
          .map(function(e) {
            return Of.before(e);
          });
      }, A.none);
    ...
    Wf = function(n, e, r, t, o, i) {
      return ma(
        [xl.findRootInline(e, r, t), xl.findRootInline(e, r, o)],
        function(e, t) {
          return e !== t && xl.hasSameParentBlock(r, e, t)
            ? Of.after(n ? e : t)
            : i;
        }
      ).getOr(i);
      ...
      return Vf(u, s, e)
        ...
        .orThunk(function() {
          return (
            ...
            (o = l),
            (e = c),
            (i = xl.normalizePosition(t, e)),
            Qa.fromPosition(t, r, i)
              .map(V.curry(xl.normalizePosition, t))
              .fold(
                function() {
                  return o.map($f);
                },
    ...
    td = function(e, t, n) {
      var r = e ? 1 : -1;
      return (
        t.setRng(La(n.container(), n.offset() + r).toRange()),
      ...
      move: function(a, u, s) {
        return function() {
          return (
            ...
            (e = s),
            (r = t.getBody()),
            (o = La.fromRangeStart(t.selection.getRng())),
            (i = V.curry(xl.isInlineTarget, t)),
            Jf(e, i, r, o).bind(function(e) {
              return ad(t, n, e);
            })).isSome()
          );
          var t, n, e, r, o, i;
        ...
        return (
          a.on("NodeChange", function(e) {
            ...
            od(a) &&
              ...
              (r = e.parents),
              (o = H.filter(
                n.select('*[data-mce-selected="inline-boundary"]'),
                t
              )),
              (i = H.filter(r, t)),
              H.each(H.difference(o, i), V.curry(id, !1)),
              H.each(H.difference(i, o), V.curry(id, !0)),
              (function(e, t) {
                if (
                  ...
                  La.isTextPosition(n) &&
                    !1 === xl.isAtZwsp(n) &&
                    (rd(e, $a.removeAndReposition(t.get(), n)), t.set(null));
                }
              })(a, u),
              (function(n, r, o, e) {
    ...
    ld = function(r, o, i, a) {
      ...
      r.undoManager.ignore(function() {
        ...
        r.selection.setRng(
          ...
          Gf(s, u, La.fromRangeStart(r.selection.getRng()))
            .map(Zf)
            .map(cd(r, o));
      }),
        r.nodeChanged();
    ...
    fd = function(n, r, i, o) {
      var e,
        t,
        a = ((e = n.getBody()), (t = o.container()), ys(t, e) || e),
      ...
      return s
        .bind(function(e) {
          return i
            ? e.fold(
                V.constant(A.some(Zf(e))),
                A.none,
                V.constant(A.some(Qf(e))),
                A.none
              )
            : e.fold(
                A.none,
            ...
            ? xl
                ...
                .map(function(e) {
                  return (
                    (o = e),
                    !!ma(
                      [Qa.firstPositionIn(o), Qa.lastPositionIn(o)],
                      function(e, t) {
                        var n = xl.normalizePosition(!0, e),
                          r = xl.normalizePosition(!1, t);
                        return Qa.nextPosition(o, n)
                          .map(function(e) {
                            return e.isEqual(r);
                          })
                          .getOr(!0);
    ...
    gd = nf([{ removeTable: ["element"] }, { emptyCells: ["cells"] }]),
    hd = function(e, t) {
        ...
        : ma([t, n], md).fold(
            ...
            function(e) {
              return wd(r, e)
                ? A.none()
                : ((n = r),
                  vd((t = e).start(), n).bind(function(e) {
                    return H.last(Cd(e)).map(function(e) {
                      return md(t.start(), e);
                    });
                  }));
    ...
    Nd = function(e, t) {
      var n,
        ...
        i,
        a,
        u = ((n = e), V.curry(Mr.eq, n));
      return ((r = t),
      (o = u),
      (i = hd(r.startContainer, o)),
      (a = hd(r.endContainer, o)),
      ma([i, a], md)
        .filter(yd)
        .filter(function(e) {
          return wd(o, e);
    ...
    Sd = function(n) {
      return ((r = n),
      ma(
        [Ed(r.cells(), r.rng().start()), Ed(r.cells(), r.rng().end())],
        function(e, t) {
    ...
    Vd = function(u, s, c, l, f) {
      return Qa.navigate(c, u.getBody(), f)
        .bind(function(e) {
          return (
            (r = l),
            (o = c),
            ...
            Qa.firstPositionIn(r.dom())
              ...
              : ((t = l),
                (n = e),
                Ud(s, Vn.fromDom(n.getNode())).map(function(e) {
                  return !1 === Mr.eq(e, t);
                }))
          );
          var t, n, r, o, i, a;
      ...
      return zd(s, e).bind(function(e) {
        return Ll(e)
          ...
          : ((t = a),
            ...
            (o = e),
            (i = c),
            Qa.navigate(r, t.getBody(), i).bind(function(e) {
        ...
        .fold(
          ...
          function(e) {
            return (
              ...
              (r = s),
              (o = e),
              (i = La.fromRangeStart(t.selection.getRng())),
              Ll(o) ? qd(t, o) : Vd(t, r, n, o, i)
            );
            var t, n, r, o, i;
          }
        )
    ...
    $d = function(e, t) {
      var n,
        ...
        i,
        a,
        u = Vn.fromDom(e.selection.getStart(!0)),
        s = Ld(e);
      return e.selection.isCollapsed() && 0 === s.length
        ? jd(e, t, u)
        : ((n = e),
          (r = u),
          (o = Vn.fromDom(n.getBody())),
          (i = n.selection.getRng()),
          0 !== (a = Ld(n)).length ? Id(n, a) : Fd(n, o, i, r));
    },
    Wd = function(e, t) {
        ...
        return A.from(e)
          ...
          .bind(function(e) {
            ...
            ul
              ...
              .bind(a)).or(
              ((t = s), (n = e.dom()), A.from(vi.DOM.getStyle(n, t, !0)))
            );
            var t, n, r, o, i, a;
          })
          .getOr("");
    ...
    im = function(e, t, n, r, o) {
      ...
      if (
        ...
        r && Oo.isBr(o) && t && e.isEmpty(u))
      )
        return A.some(Da(o.parentNode, e.nodeIndex(o)));
      for (i = new ao(o, u); (s = i[r ? "prev" : "next"]()); ) {
        if (
          "false" === e.getContentEditableParent(s) ||
          ((l = f), Li((c = s)) && !1 === tm(c, l, kc))
        )
          return A.none();
        if (Oo.isText(s) && 0 < s.nodeValue.length)
          return !1 === nm(s, f, "A")
            ? A.some(Da(s, r ? s.nodeValue.length : 0))
            : A.none();
    ...
    am = function(e, t, n, r) {
      ...
      if (
        ...
        (l = Oo.isElement(o) && i === o.childNodes.length),
        ...
        return A.none();
      if (
        (Oo.isElement(o) && i > o.childNodes.length - 1 && (c = !1),
        Oo.isDocument(o) && ((o = p), (i = 0)),
        o === p)
      ) {
        ...
        if (o.hasChildNodes()) {
          if (
            ...
            (o = o.childNodes[i]),
            (i = Oo.isText(o) && l ? o.data.length : 0),
            !t && o === p.lastChild && rm(o))
          )
            return A.none();
          if (
            (function(e, t) {
    ...
    dm = function(e, t) {
      ...
      var n = Vn.fromTag("br");
      Hu.after(Vn.fromDom(t), n),
        sm(e.dom, e.selection, n.dom()),
        cm(e.dom, e.selection, n.dom(), !1),
        e.undoManager.add();
    },
    mm = function(e, t) {
      return (
    ...
    vm = function(e, t) {
      var n,
        ...
        o,
        i = ((n = e),
        (r = V.curry(xl.isInlineTarget, n)),
        (o = La.fromRangeStart(n.selection.getRng())),
        Gf(r, n.getBody(), o).filter(gm));
    ...
    Rm = function(e) {
      return wm.range(
        Vn.fromDom(e.startContainer),
        e.startOffset,
        Vn.fromDom(e.endContainer),
        e.endOffset
      );
    },
    _m = function(e) {
    ...
    Pm = function(e) {
      return (e.bookmark ? e.bookmark : A.none())
        .bind(V.curry(Dm, Vn.fromDom(e.getBody())))
        .bind(Om);
    },
    Lm = function(e) {
    ...
    Fm = function(e, t) {
      ...
      e.queryCommandState("InsertUnorderedList") ||
        ...
        (n.forced_root_block ||
          ...
          i.apply("div"),
        H.each(o.getSelectedBlocks(), function(e) {
  ...
  function Hm(s) {
    ...
    e({
      ...
      "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull,JustifyNone": function(
        ...
        var t = e.substring(7);
        "full" === t && (t = "justify"),
          zm("left,center,right,justify".split(","), function(e) {
      ...
      FontName: function(e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle("fontname", { value: Zd(r, o) }),
          r.nodeChanged();
      },
      FontSize: function(e, t, n) {
        var r, o;
        (o = n),
          (r = s).formatter.toggle("fontsize", { value: Zd(r, o) }),
          r.nodeChanged();
      },
  ...
  var Wm,
    ...
    sp = {
      ...
      remove: function(e, t) {
        var n;
        ap(e) ? e.dom().classList.remove(t) : op(e, t),
          0 === (ap((n = e)) ? n.dom().classList : np(n)).length &&
            lr.remove(n, "class");
      },
      toggle: function(e, t) {
    ...
    hp = function(e, t) {
      ...
      (n = Vn.fromDom(e.getBody())),
        ...
        (o = t),
        sp.has(n, r) && !1 === o ? sp.remove(n, r) : o && sp.add(n, r),
        t
    ...
    bp = function(e, t) {
      return "selectionchange" === t
        ...
        ? (e.eventRoot || (e.eventRoot = yp.select(e.settings.event_root)[0]),
          e.eventRoot)
        : e.getBody();
    },
    Cp = function(e, t, n) {
      ...
      toggleNativeEvent: function(e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized &&
              (n.dom.unbind(bp(n, e), e, n.delegates[e]),
  ...
  function Ap(i) {
    var a = {},
      ...
      u = function(e) {
        ...
        for (n in (Ep(Sp(e, "+"), function(e) {
          e in Tp
            ...
            : ((r.charCode = e.charCodeAt(0)),
              (r.keyCode = kp[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        Tp))
          r[n] ? t.push(n) : (r[n] = !1);
        return (
          (r.id = t.join(",")),
          r.access && ((r.alt = !0), ve.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (ve.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        );
      },
      s = function(e, t, n, r) {
        var o;
        return (
          ((o = It.map(Sp(e, ">"), u))[o.length - 1] = It.extend(
            o[o.length - 1],
            { func: n, scope: r || i }
          )),
          It.extend(o[0], { desc: i.translate(t), subpatterns: o.slice(1) })
        );
      },
      o = function(e, t) {
        return (
  ...
  var Rp = function(e) {
    ...
    Dp = function(t, e) {
      return ((n = e),
      n.collapsed
        ? A.from(ua(n.startContainer, n.startOffset)).map(Vn.fromDom)
    ...
    Ip = function(e) {
      return e.inline
        ? Lp(e)
        : (t = e).iframeElement && _p(Vn.fromDom(t.iframeElement));
      var t;
    },
    Mp = function(e) {
        ...
        (t
          ...
          : (function(t) {
              ...
              t.bookmark !== undefined &&
                !1 === Ip(t) &&
                Mm(t).each(function(e) {
                  t.selection.setRng(e), (o = e);
                }),
                n || (ve.opera || Pp(r), t.getWin().focus()),
                (ve.gecko || n) && (Pp(r), Op(t, o)),
                Mp(t);
            })(e));
    },
    zp = Ip,
    ...
    Wp = function(e, t, n) {
      var r,
        ...
        f,
        d,
        m = Vn.fromDom(e.getBody()),
        p = e.inline ? m : $r.documentElement(m),
        g = ((r = e.inline),
        (i = t),
        (a = n),
        (u = (o = p).dom().getBoundingClientRect()),
        {
    ...
    Kp = function(e) {
      ...
      return ((t = n), A.from(t).map(Vn.fromDom))
        .map(function(e) {
  ...
  function ug(u, s) {
    ...
    return (
      (s = It.extend({ credentials: !1, handler: n }, s)),
      {
        upload: function(e, t) {
      ...
      return 0 === e.indexOf("blob:")
        ...
        ? ((o = e),
          new ye(function(e) {
            ...
            for (n = new lg(t.length), r = 0; r < n.length; r++)
              n[r] = t.charCodeAt(r);
            e(new sg([n], { type: o.type }));
          }))
        : null;
      var i, o;
    },
    ...
    var n,
      ...
      v = function(t, n) {
        Bt.each(u.undoManager.data, function(e) {
          "fragmented" === e.type
            ? (e.fragments = Bt.map(e.fragments, function(e) {
                return h(e, t, n);
              }))
  ...
  var Ng = function(e, t) {
    ...
    Eg = function(e, t) {
      if (Oo.isText(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || Ng(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
      ...
      if (
        ...
        v &&
          ...
          g.isValidChild(l, f.toLowerCase()) &&
            ...
            (C = y),
            (x = v),
            !H.exists(Hl(Vn.fromDom(x), Vn.fromDom(C)), function(e) {
              return Ng(b, e.dom());
            }))))
      ) {
        var b, C, x, w, N;
        for (
          ...
          if (
            ((w = h),
            (N = v),
            Oo.isText(N) || (Oo.isElement(N) && !Ng(w, N) && !Mc(N)))
          ) {
            if (Eg(h, v)) {
        ...
        [
          ...
          Oo.isText(a)
            ? 0 === u
              ? A.some(Vn.fromDom(a))
              : A.none()
            : A.from(a.childNodes[u]).map(Vn.fromDom)),
          ((t = e),
          (n = t.endContainer),
          (r = t.endOffset),
          Oo.isText(n)
            ? r === n.data.length
              ? A.some(Vn.fromDom(n))
              : A.none()
            : A.from(n.childNodes[r - 1]).map(Vn.fromDom))
        ],
        function(e, t) {
    ...
    _g = function(e, t, n, r) {
      ...
      do {
        if (3 === n.nodeType && 0 !== It.trim(n.nodeValue).length)
        ...
        if (a[n.nodeName] && !/^(TD|TH)$/.test(n.nodeName))
          return void (r
            ...
            ? t.setEndBefore(n)
            : t.setEndAfter(n));
        if (ve.ie && ve.ie < 11 && e.isBlock(n) && e.isEmpty(n))
    ...
    "onselectionchange" in i.getDoc() ||
      i.on("NodeChange Click MouseUp KeyUp Focus", function(e) {
        ...
        (n = {
          ...
          ("nodechange" !== e.type && em(n, r)) || i.fire("SelectionChange"),
          (r = n);
      }),
      ...
      i.on("SelectionChange", function() {
        ...
        !e ||
          (!ve.range && i.selection.isCollapsed()) ||
          (Bg(i) &&
            !(function(e) {
              var t, n;
              if (
      ...
      i.on("MouseUp", function(e) {
        !e.isDefaultPrevented() &&
          ...
          ("IMG" === i.selection.getNode().nodeName
            ? we.setEditorTimeout(i, function() {
                i.nodeChanged();
              })
            : i.nodeChanged());
      }),
  ...
  var Og,
    ...
    Ig = function(e, t) {
      return (
        (n = (u = e).inline ? Lg(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
        (r = i.inline
    ...
    Hg = function(e) {
      ...
      (t = vi.DOM),
        ...
        (r = function(e) {
          ...
          if (g.dragging) {
            var p = ((f = g),
            { pageX: (d = Ig(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
            (c = g.ghost),
              (l = h.getBody()),
        ...
        (n = e).on("drop", function(e) {
          var t =
            "undefined" != typeof e.clientX
              ...
              : null;
          (Mg(t) || Mg(n.dom.getContentEditableParent(t))) &&
            e.preventDefault();
        });
    },
    $g = function(e) {
  ...
  var Wg = function(o, i, a, e, u, t) {
      var n,
        ...
        r = function(e) {
          var t, n, r;
          for (
            r = $g([e]), -1 === o && (r = r.reverse()), t = 0;
            t < r.length;
            t++
          )
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, Bt.last(l)) && c++, (n.line = c), u(n)))
                return !0;
              l.push(n);
            }
        };
      return (
        (s = Bt.last(t.getClientRects())) &&
          (r((n = t.getNode())),
          (function(e, t, n, r) {
            for (; (r = vs(r, e, Zi, t)); ) if (n(r)) return;
          })(o, e, r, n)),
        l
      );
    },
    ...
    nh = function(e, o) {
      return Bt.reduce(e, function(e, t) {
        var n, r;
        return (
          (n = Math.min(Zg(e, o), eh(e, o))),
          (r = Math.min(Zg(t, o), eh(t, o))),
          th(o, t)
            ? t
            : th(o, e)
            ? e
    ...
    rh = function(e, t, n, r) {
      for (; (r = Qg(r, e, Zi, t)); ) if (n(r)) return;
    },
    oh = function(e, t, n) {
      var r,
        o,
        ...
        l,
        f = $g(
          ((o = e), Bt.filter(Bt.toArray(o.getElementsByTagName("*")), as))
        ),
      ...
      return (r = nh(d, t)) &&
        (r = nh(
          ...
          (c = []).push((s = r)),
          rh(Og.Up, u, V.curry(l, oa), s.node),
          rh(Og.Down, u, V.curry(l, ia), s.node),
          c),
          t
        )) &&
        as(r.node)
        ? ((a = t), { node: (i = r).node, before: Zg(i, a) < eh(i, a) })
        : null;
    },
    ih = function(i, a, e) {
      return (
    ...
    ph = function(p) {
      var g,
        ...
        v = function(e, t, n, r) {
          return (
            ...
            p
              ...
              .isDefaultPrevented()
              ? null
              : (r && p.selection.scrollIntoView(t, -1 === e), o.show(n, t))
          );
        },
        y = function(e, t) {
          return (
            (t = Ss(e, a, t)),
            -1 === e ? La.fromRangeStart(t) : La.fromRangeEnd(t)
          );
        },
        n = function(e) {
          ...
          return (
            ...
            1 !== i.nodeType
              ...
              : (u === a + 1 && (n = i.childNodes[a]),
                lh(n)
                  ? ((l = f = n.cloneNode(!0)),
                    (s = p.fire("ObjectSelected", {
                      target: n,
                      targetClone: l
                    })).isDefaultPrevented()
                      ? null
                      : ((r = Tl(Vn.fromDom(p.getBody()), "#" + h).fold(
                          function() {
                            return d([]);
                          },
                          function(e) {
                        ...
                        r.css({ top: m.getPos(n, p.getBody()).y }),
                        r[0].focus(),
                        (o = p.selection.getSel()).removeAllRanges(),
                        o.addRange(e),
                        H.each(
                          hu(Vn.fromDom(p.getBody()), "*[data-mce-selected]"),
                          function(e) {
        ...
        l = function() {
          g && g.removeAttribute("data-mce-selected"),
            Tl(Vn.fromDom(p.getBody()), "#" + h).each(Hc.remove),
            (g = null);
        },
        C = function() {
          o.hide();
          ...
          ((function() {
            p.on("mouseup", function(e) {
              ...
              p.on("click", function(e) {
                var t;
                (t = mh(p, e.target)) &&
                  (lh(t) && (e.preventDefault(), p.focus()),
                  ch(t) && p.dom.isChildOf(t, p.selection.getNode()) && l());
              }),
            ...
            var n,
              ...
              i = function(e, t) {
                var n,
                  r,
                  o = p.dom.getParent(e, p.dom.isBlock),
                  i = p.dom.getParent(t, p.dom.isBlock);
                return (
                  !(!o || !p.dom.isChildOf(o, i) || !1 !== lh(mh(p, o))) ||
                  (o &&
                    ((n = o),
                    (r = i),
                    !(
                      p.dom.getParent(n, p.dom.isBlock) ===
                      p.dom.getParent(r, p.dom.isBlock)
                    )) &&
                    (function(e) {
                      var t = Ys(e);
            ...
            (r = !1),
              ...
              p.on("mousedown", function(e) {
                var t,
                  n = e.target;
                if (
                  (n === a || "HTML" === n.nodeName || p.dom.isChildOf(n, a)) &&
                  !1 !== Wp(p, e.clientX, e.clientY)
                )
                  if ((t = mh(p, n)))
                    lh(t)
                      ? (e.preventDefault(), c(nu(p, t)))
                      : (l(),
                        (ch(t) && e.shiftKey) ||
                          ih(e.clientX, e.clientY, p.selection.getRng()) ||
                          (C(),
                          p.selection.placeCaretAt(e.clientX, e.clientY)));
                  else if (!1 === as(n)) {
                    l(), C();
              ...
              p.on("keypress", function(e) {
                sh.modifierPressed(e) ||
                  (e.keyCode, lh(p.selection.getNode()) && e.preventDefault());
              }),
              ...
              p.on("AfterSetSelectionRange", function(e) {
                ...
                b(n) || C(),
                  ...
                  p.dom.hasClass(t, "mce-offscreen-selection") || l();
              }),
          ...
          )),
        {
          ...
          showBlockCaretContainer: function(e) {
            e.hasAttribute("data-mce-caret") &&
              (Vi(e), u(s()), p.selection.scrollIntoView(e[0]));
          },
          hideFakeCaret: C,
          destroy: function() {
            o.destroy(), (g = null);
      ...
      parse: function(e) {
        var t,
          ...
          M = function(e, t, n, r, o) {
            var i, a, u, s, c;
            if (
              ((n = (t = t.toLowerCase()) in p ? t : O(n || r || o || "")),
              g &&
                !m &&
                0 ==
        ...
        for (
          ...
          if ((_ < t.index && V(O(e.substr(_, t.index - _))), (n = t[6])))
            ...
            if (
              ...
              (c = n in s),
              R && E[n] && 0 < B.length && B[B.length - 1].name === n && I(n),
              !g || (l = z.getElementRule(n)))
            ) {
              if (
                ((f = !0),
                g && ((y = l.attributes), (b = l.attributePatterns)),
                (v = t[8])
        ...
        for (_ < e.length && V(O(e.substr(_))), o = B.length - 1; 0 <= o; o--)
          (n = B[o]).valid && j(n.name);
      }
    };
  }
  (hh || (hh = {})).findEndTag = gh;
  var vh = hh,
    yh = function(e, t) {
      ...
      for (
        ...
        (r = f.lastIndex),
          (o = i[0].length),
          (n = a[i[1]] ? r : vh.findEndTag(d, l, r)),
          (l = l.substring(0, r - o) + l.substring(n)),
          (f.lastIndex = r - o);
      return _i(l);
    },
    bh = { trimExternal: yh, trimInternal: yh },
    Ch = 0,
    xh = 2,
    wh = 1,
    Nh = function(p, g) {
    ...
    Eh = function(e) {
      return Oo.isElement(e)
        ? e.outerHTML
        : Oo.isText(e)
        ? Ko.encodeRaw(e.data, !1)
        : Oo.isComment(e)
        ? "\x3c!--" + e.data + "--\x3e"
        : "";
    },
    ...
    return (
      ...
      (o = {
        ...
        add: function(e, t) {
          ...
          (e.bookmark = Ec.getUndoBookmark(u.selection)),
        ...
        undo: function() {
          ...
          return (
            ...
            0 < c &&
              ((e = l[--c]), Fh(u, e, !0), d(!0), u.fire("undo", { level: e })),
            e
          );
        },
        redo: function() {
          ...
          return (
            c < l.length - 1 &&
              ((e = l[++c]), Fh(u, e, !1), d(!0), u.fire("redo", { level: e })),
            e
          );
        },
        clear: function() {
  ...
  var qh,
      ...
      moveStart: function(e, t, n) {
        ...
        if (
          (n.startContainer !== n.endContainer ||
            !Hh(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
    ...
    ev = function(e, t, n, r, o, i) {
      var a, u, s, c;
      if (3 === n.nodeType) {
        if (-1 !== (s = Zh(o, i, n, r))) return { container: n, offset: s };
        c = n;
      }
      for (
    ...
    nv = function(t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = Xh(i, o, "ul,ol").reverse()[0] || o), !o))
        for (
          o = n;
          o[r] && !i.isBlock(o[r]) && ((o = o[r]), !Wh.isEq(o, "br"));
    ...
    rv = function(e, t, n, r, o, i, a) {
      ...
      if (
        ...
        (f = e.getRoot()),
        3 === u.nodeType && !Yh(u) && (a ? 0 < r : i < u.nodeValue.length))
      )
        return u;
      for (;;) {
    ...
    ov = function(e, t, n, r) {
      ...
      return (
        ...
        (i = Qh(c, i)),
        (u = Qh(c, u)),
        (Kh(i.parentNode) || Kh(i)) &&
          3 ===
            (i = (i = Kh(i) ? i : i.parentNode).nextSibling || i).nodeType &&
          (a = 0),
        (Kh(u.parentNode) || Kh(u)) &&
          3 ===
            (u = (u = Kh(u) ? u : u.parentNode).previousSibling || u)
              .nodeType &&
          (s = u.length),
        n[0].inline &&
          (t.collapsed &&
            ((o = ev(c, e.getBody(), i, a, !0, r)) &&
              ((i = o.container), (a = o.offset)),
            (o = ev(c, e.getBody(), u, s, !1, r)) &&
        ...
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((i = tv(c, n, t, i, "previousSibling")),
          (u = tv(c, n, t, u, "nextSibling"))),
        (n[0].block || n[0].selector) &&
          ((i = nv(e, n, i, "previousSibling")),
          (u = nv(e, n, u, "nextSibling")),
          n[0].block &&
            (c.isBlock(i) || (i = rv(c, n, i, a, u, s, !0)),
            c.isBlock(u) || (u = rv(c, n, i, a, u, s, !1)))),
        ...
        if ("undefined" == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              ...
              if (
                (!o || n.exact) &&
                !iv(u, Wh.normalizeStyleValue(e, Wh.replaceVars(c[a], i), a))
              )
                return;
            }
        } else
    ...
    fv = {
      ...
      match: function(e, t, n, r) {
        ...
        return r
          ...
          : ((r = e.selection.getNode()),
            !!uv(e, r, t, n) ||
              !((o = e.selection.getStart()) === r || !uv(e, o, t, n)));
      },
        ...
        return (
          ...
          r.dom.getParent(
            ...
            function(e) {
              var t, n;
              for (t = 0; t < o.length; t++)
                (n = o[t]), !u[n] && lv(r, e, n, i) && ((u[n] = !0), a.push(n));
            },
            r.dom.getRoot()
          ),
          a
    ...
    bv = function(e, t, n, r) {
      ...
      (o = t.getRng(!0)),
        ...
        hv(n)
          ...
          : ((u = vv(n)) && u.nodeValue.charAt(0) === pv && u.deleteData(0, 1),
            (a = u),
            o.startContainer === a &&
              0 < o.startOffset &&
    ...
    Ev = function(e) {
      ...
      e.on("mouseup keydown", function(e) {
        ...
        (t = u),
          ...
          8 === o &&
            r.isCollapsed() &&
            r.getStart().innerHTML === pv &&
            Cv(t, n, r, Tc(t, r.getStart())),
          (37 !== o && 39 !== o) || Cv(t, n, r, Tc(t, r.getStart()));
      });
    },
    Sv = function(e, t) {
      return (
  ...
  (Vh = function(e) {
    ...
    (t = Oo.matchNodeNames("pre")),
      r.collapsed ||
        ((n = e.selection.getSelectedBlocks()),
        Av(
          Tv(Tv(n, t), function(e) {
            return (
              t(e.previousSibling) && -1 !== Bt.indexOf(n, e.previousSibling)
            );
          }),
          function(e) {
            var t, n;
  ...
  var Rv = function(e, t) {
    ...
    Fv = function(e, t, n, r) {
      return (
        !(t = Wh.getNonWhiteSpaceSibling(t, n, r)) ||
        "BR" === t.nodeName ||
        e.isBlock(t)
      );
    },
    zv = function(e, n, r, o, i) {
      ...
      if (
        ...
        !(
          Pv((l = o), (f = n).inline) ||
          Pv(l, f.block) ||
          (f.selector ? Oo.isElement(l) && c.is(l, f.selector) : void 0) ||
      ...
      if ("all" !== n.remove)
        for (
          Ov(n.styles, function(e, t) {
            (e = Wh.normalizeStyleValue(b, Wh.replaceVars(e, r), t)),
              "number" == typeof t && ((t = e), (i = 0)),
              (n.remove_similar || !i || Pv(Wh.getStyle(b, i, t), e)) &&
                b.setStyle(o, t, ""),
              (u = 1);
          }),
            u &&
            ...
            Ov(n.attributes, function(e, t) {
              var n;
              if (
                ((e = Wh.replaceVars(e, r)),
                "number" == typeof t && ((t = e), (i = 0)),
                !i || Pv(b.getAttrib(i, t), e))
              ) {
                if (
                  "class" === t &&
                  (e = b.getAttrib(o, t)) &&
                  ((n = ""),
                  Ov(e.split(/\s+/), function(e) {
                    /mce\-\w+/.test(e) && (n += (n ? " " : "") + e);
                  }),
                  n)
                )
                ...
                "class" === t && o.removeAttribute("className"),
                  Dv.test(t) && o.removeAttribute("data-mce-" + t),
                  o.removeAttribute(t);
              }
            }),
            Ov(n.classes, function(e) {
              (e = Wh.replaceVars(e, r)),
                (i && !b.hasClass(i, e)) || b.removeClass(o, e);
            }),
            a = b.getAttribs(o),
            t = 0;
          t < a.length;
      ...
      return "none" !== n.remove
        ? ((d = e),
          ...
          p.block &&
            (y
              ? h === v.getRoot() &&
                ((p.list_block && Pv(m, p.list_block)) ||
                  Ov(It.grep(m.childNodes), function(e) {
                    Wh.isValid(d, y, e.nodeName.toLowerCase())
                      ? g
                        ? g.appendChild(e)
                        : ((g = Mv(v, e, y)),
                          v.setAttribs(g, d.settings.forced_root_block_attrs))
                      : (g = 0);
                  }))
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                (Fv(v, m, !1) ||
                  Fv(v, m.firstChild, !0, 1) ||
                  m.insertBefore(v.create("br"), m.firstChild),
                Fv(v, m, !0) ||
                  Fv(v, m.lastChild, !1, 1) ||
                  m.appendChild(v.create("br")))),
          (p.selector && p.inline && !Pv(p.inline, m)) || v.remove(m, 1),
          !0)
        : void 0;
    },
    Uv = zv,
    qv = function(s, c, l, e, f) {
      var t,
        ...
        o = function(e) {
          var n,
            ...
            (o = l),
            (i = f),
            Ov(Wh.getParents(n.dom, t.parentNode).reverse(), function(e) {
              var t;
              a ||
                "_start" === e.id ||
                "_end" === e.id ||
                ((t = fv.matchNode(n, e, r, o, i)) &&
                  !1 !== t.split &&
                  (a = e));
            }),
            a);
        ...
        i = function(e) {
          ...
          return (
            Mc(n) && (n = n[e ? "firstChild" : "lastChild"]),
            Oo.isText(n) &&
              0 === n.data.length &&
              (n = e
            ...
            Ov(e, function(e) {
              p(e),
                Oo.isElement(e) &&
                  ...
                  e.parentNode &&
                  "underline" === Wh.getTextDecoration(u, e.parentNode) &&
                  zv(
                    s,
                    {
                      deep: !1,
      ...
      if (e)
        e.nodeType
          ? ((n = u.createRng()).setStartBefore(e), n.setEndAfter(e), g(n))
          : g(e);
        ...
        !u.select("td[data-mce-selected],th[data-mce-selected]").length
          ...
          : ((t = Ec.getPersistentBookmark(s.selection, !0)),
            g(r.getRng()),
            r.moveToBookmark(t),
            m.inline &&
              fv.match(s, c, l, r.getStart()) &&
              Wh.moveStart(u, r, r.getRng()),
            s.nodeChanged());
      else {
        e = r.getNode();
        for (
          var h = 0, v = d.length;
          h < v && (!d[h].ceFalseOverride || !zv(s, d[h], l, e, e));
          h++
        );
      }
    },
    ...
    $v = function(e, t, n) {
      ...
      if (
        ...
        return (
          e.remove(n),
          It.each(It.grep(n.childNodes), function(e) {
            t.appendChild(e);
          }),
          t
        );
    ...
    Gv = function(e, t) {
      ...
      1 === t.nodeType &&
        ...
        ((n = Wh.getTextDecoration(e, t.parentNode)),
    ...
    Qv = function(e, t, n, r) {
      (t.styles.color || t.styles.textDecoration) &&
        (It.walk(r, V.curry(Gv, e), "childNodes"), Gv(e, r));
    },
    Zv = function(e, t, n, r) {
      t.styles &&
        ...
        Wv(
          r,
          Kv(e, "fontSize"),
          Xv(e, "backgroundColor", Wh.replaceVars(t.styles.backgroundColor, n))
        );
    },
    ey = function(e, t, n, r) {
      ("sub" !== t.inline && "sup" !== t.inline) ||
        (Wv(r, Kv(e, "fontSize"), Xv(e, "fontSize", "")),
        e.remove(e.select("sup" === t.inline ? "sub" : "sup", r), !0));
    },
    ty = function(e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = $v(e, Wh.getNonWhiteSpaceSibling(r), r)),
        (r = $v(e, r, Wh.getNonWhiteSpaceSibling(r, !0))));
    },
    ny = function(t, n, r, o, i) {
      (fv.matchNode(t, i.parentNode, r, o) && Uv(t, n, o, i)) ||
                ...
                u = function(e) {
                  ...
                  if (y.wrapper && fv.matchNode(p, e, g, h)) a = 0;
                    ...
                    if (
                      ...
                      return (
                        (e = s.rename(e, l)), b(e), d.push(e), void (a = 0)
                      );
                    if (y.selector) {
                      var i = C(v, e);
          ...
          if (r)
            ...
            !(function(e, t, n) {
              ...
              (a = (r = c.getRng(!0)).startOffset),
                ...
                (o = Tc(e.getBody(), c.getStart())) && (i = vv(o));
              var l,
                f,
                d = /[^\s\u00a0\u00ad\u200b\ufeff]/;
              s &&
            ...
            p.settings.forced_root_block ||
              !v[0].defaultBlock ||
              i.getParent(u, i.isBlock) ||
              oy(p, v[0].defaultBlock),
              p.selection.setRng(Zc(p.selection.getRng())),
              (e = Ec.getPersistentBookmark(p.selection, !0)),
              a(i, ov(p, n.getRng(), v)),
              y.styles && Qv(i, y, h, u),
              n.moveToBookmark(e),
              Wh.moveStart(i, n, n.getRng()),
              p.nodeChanged();
          }
          Rv(g, p);
        }
              ...
              ay(r, function(t) {
                return a.formatter.matchNode(t, n, {}, e.similar)
                  ? (u[n] ||
                    ...
                    (o[n] = e),
                    !1)
                  : !fv.matchesUnInheritedFormatSelector(a, t, n) && void 0;
              });
            }),
            ay(u, function(e, t) {
              o[t] ||
    ...
    fy = function(e, t) {
      var n,
        ...
        p = function(e) {
          ...
          return (
            ...
            (t = ly.create(o.name)),
            (n = t),
            (r = o).classes.length && ly.addClass(n, r.classes.join(" ")),
            ly.setAttribs(n, r.attrs),
            t
          );
        },
        g = function(n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = ly.create("div")).appendChild(n),
      ...
      return e && e.length
        ? ((o = e[0]),
          (n = p(o)),
          (r = ly.create("div")).appendChild(g(n, e.slice(1), o.siblings)),
          r)
        : "";
    },
    dy = function(e) {
    ...
    py = function(n, e) {
      ...
      return "preview" in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || "span"),
          (i = my(e.selector)).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), (r = fy(i, n)))
            : (r = fy([t], n)),
          (o = ly.select(t, r)[0] || r.firstChild),
          cy(e.styles, function(e, t) {
          ...
          ly.setStyles(r, { position: "absolute", left: -65535 }),
          n.getBody().appendChild(r),
          (a = ly.getStyle(n.getBody(), "fontSize", !0)),
          (a = /px$/.test(a) ? parseInt(a, 10) : 0),
          cy(u.split(" "), function(e) {
            var t = ly.getStyle(o, e, !0);
            if (
              !(
                ("background-color" === e &&
                  /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) &&
                  ((t = ly.getStyle(n.getBody(), e, !0)),
                  "#ffffff" === ly.toHex(t).toLowerCase())) ||
                ("color" === e && "#000000" === ly.toHex(t).toLowerCase())
              )
            ) {
    ...
    gy = function(e, t, n, r, o) {
      var i = t.get(n);
      !fv.match(e, n, r, o) || ("toggle" in i[0] && !i[0].toggle)
        ? iy.applyFormat(e, n, r, o)
        : qv(e, n, r, o);
    },
    hy = function(e) {
  ...
  var yy = function(a) {
        ...
        t.addAttributeFilter("data-mce-tabindex", function(e, t) {
          ...
          t.addNodeFilter("noscript", function(e) {
            for (var t, n = e.length; n--; )
              (t = e[n].firstChild) && (t.value = Ko.decode(t.value));
          }),
          ...
          (l = e) && l.hasEventListeners("PreProcess") && !f.no_events
            ? ((o = t),
              ...
              (a = document.implementation).createHTMLDocument &&
                ...
                It.each("BODY" === o.nodeName ? o.childNodes : [o], function(
                  e
                ) {
    ...
    Ey = function(e, u, s) {
      e.addNodeFilter("font", function(e) {
        H.each(e, function(e) {
          var t,
            n,
            r = u.parse(e.attr("style")),
            o = e.attr("color"),
            i = e.attr("face"),
            a = e.attr("size");
          o && (r.color = o),
            i && (r["font-family"] = i),
            a && (r["font-size"] = s[parseInt(e.attr("size"), 10) - 1]),
            (e.name = "span"),
            e.attr("style", u.serialize(r)),
            (t = e),
            (n = ["color", "face", "size"]),
            H.each(n, function(e) {
              t.attr(e, null);
    ...
    Sy = function(e, t) {
      ...
      t.convert_fonts_to_spans &&
        Ey(e, r, It.explode(t.font_size_legacy_values)),
        (n = r),
    ...
    _y = (function() {
      ...
      return (
        (a.create = function(e, t) {
          var n, r;
          if (((n = new a(e, Ay[e] || 1)), t)) for (r in t) n.attr(r, t[r]);
          return n;
        }),
        ...
        (a.prototype.getAll = function(e) {
          var t,
            n = [];
          for (t = this.firstChild; t; t = Ry(t, this))
            t.name === e && n.push(t);
          return n;
        }),
    ...
    By = function(e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new _y("br", 1)).shortEnded = !0)
        : (r.empty().append(new _y("#text", 3)).value = "\xa0");
    },
    Dy = function(e) {
            ...
            if (
              ...
              o &&
                ...
                Py(h, m, p, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && By(g, n, d, i)));
            } else {
              for (
                a = o;
                i &&
              ...
              a === i &&
                ...
                (((l = new _y("#text", 3)).value = "\xa0"), o.replace(l));
            }
        }),
          ...
          t = vh(
            {
              ...
              text: function(e, t) {
                ...
                f ||
                  ((e = e.replace(x, " ")),
                  Ly(d.lastChild, l) && (e = e.replace(b, ""))),
                  0 !== e.length &&
                ...
                if ((i = h ? T.getElementRule(e) : {})) {
                  for (
                    (r = N(i.outputName || e, 1)).attributes = t,
                      r.shortEnded = n,
                      d.append(r),
                      (u = g[d.name]) && g[r.name] && !u[r.name] && m.push(r),
                      o = R.length;
                    o--;

                  )
                    (a = R[o].name) in t.map &&
                      ((s = B[a]) ? s.push(r) : (B[a] = [r]));
                ...
                if ((n = h ? T.getElementRule(e) : {})) {
                  if (l[e] && !f) {
                    if ((t = d.firstChild) && 3 === t.type)
                      if (0 < (r = t.value.replace(b, "")).length)
                        (t.value = r), (t = t.next);
                      else
                  ...
                  n.paddEmpty && (Dy(d) || Py(T, p, y, d)) && By(k, a, l, d),
                    (d = d.parent);
                }
              }
            },
            ...
            h &&
              ...
              (a.context
                ...
                : (function(e) {
                    ...
                    for (
                      d = My("tr,td,th,tbody,thead,tfoot,table"),
                      ...
                      if ((n = e[t]).parent && !n.fixed)
                        if (m[n.name] && "li" === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            for (
                              o.reverse(), i = a = D(o[0].clone()), c = 0;
                              c < o.length - 1;
                              c++
                            ) {
                              for (
                                T.isValidChild(a.name, o[c].name)
                                  ? ((u = D(o[c].clone())), a.append(u))
                                  : (u = a),
                                  s = o[c].firstChild;
                                s && s !== o[c + 1];
  ...
  var Vy = function(e, t, n) {
    ...
    jy = function(e, t, n) {
      var r = n.selection ? xy.merge({ forced_root_block: !1 }, n) : n,
        o = e.parse(t, r);
    ...
    $y = function(e, t, n, r, o) {
      var i,
        ...
        u,
        s,
        c = ((i = r), Jc(t, n).serialize(i));
      return (
        (a = e),
        (s = c),
        !(u = o).no_events && a ? lp(a, xy.merge(u, { content: s })).content : s
      );
    };
  function Wy(e, t) {
    var a,
      ...
      r = ((a = e),
      (n = ["data-mce-selected"]),
      (s = (u = t) && u.dom ? u.dom : vi.DOM),
      (c = u && u.schema ? u.schema : oi(a)),
  ...
  function Ky(e) {
    return { getBookmark: V.curry(Lc, e), moveToBookmark: V.curry(Ic, e) };
  }
  ...
  var Xy = Ky,
    ...
    Jy = function(r, a) {
      ...
      a.contentStyles.push(
        e +
          ...
          (ve.gecko ? "" : "outline: 1px dashed black;") +
        ...
        O = function(e) {
          ...
          (t = e.screenX - d),
            ...
            (_(u) && !1 !== a.settings.resize_img_proportional
              ? !sh.modifierPressed(e)
              : sh.modifierPressed(e) || (_(u) && f[2] * f[3] != 0)) &&
              (T(t) > T(n)
                ? ((C = A(b * y)), (b = A(C / y)))
                : ((b = A(C / y)), (C = A(b * y)))),
            N.setStyles(B(s), { width: b, height: C }),
            ...
            f[2] < 0 &&
              s.clientWidth <= b &&
              N.setStyle(s, "left", p + (h - b)),
            f[3] < 0 &&
              s.clientHeight <= C &&
              N.setStyle(s, "top", g + (v - C)),
                  ...
                  (t = N.get("mceResizeHandle" + e)) && N.remove(t),
                    ...
                    N.bind(t, "mousedown", function(e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        (s.contentEditable = !1),
                        (s.unSelectabe = !0),
                        N.setStyles(s, { left: p, top: g, margin: 0 }),
        ...
        try {
          ...
          r = (function(e, n, t) {
            ...
            if (
              ...
              0 <
                (i = (i = It.toArray(o.getClientRects())).sort(function(e, t) {
                  return (
      ...
      return fb(l, e).bind(function(c) {
        return fb(l, t).map(function(e) {
          return (
            ...
            (a = r.x()),
            (u = r.y()),
            (s = i < u ? db(t, o, i, a, u) : db(t, o, u, a, i)),
            ab(t.element(), lb(s), s)
          );
          var t, n, r, o, i, a, u, s;
        });
    ...
    vb = function(e, t) {
      var n,
        r = Vn.fromDom(t.commonAncestorContainer),
        o = jl(r, e),
    ...
    Cb = function(e, o) {
      return ((t = e), (n = o[0]), kl(n, "table", V.curry(Mr.eq, t)))
        .bind(function(e) {
          var t = o[0],
            n = o[o.length - 1],
            r = mb(e);
    ...
    xb = function(e, t) {
      ...
      return 0 < o.length
        ? Cb(e, o)
        : ((n = e), 0 < (r = t).length && r[0].collapsed ? yb() : bb(n, r[0]));
    },
    wb = function(e, t) {
      var n,
        r = e.selection.getRng(),
      ...
      if ("text" === t.format)
        return e.selection.isCollapsed()
          ? ""
          : _i(r.text || (i.toString ? i.toString() : ""));
      r.cloneContents
        ? (n = t.contextual
            ? xb(Vn.fromDom(e.getBody()), a).dom()
    ...
    Tb = function(e, t) {
      for (var n = e; e && Oo.isText(e) && 0 === e.length; )
    ...
    _b = function(e) {
      return (
        !(!e || !e.ownerDocument) &&
        Mr.contains(Vn.fromDom(e.ownerDocument), Vn.fromDom(e))
      );
    },
    Bb = function(u, s, e, c) {
      var n,
        ...
        i = function(e, t) {
          ...
          if (
            (o = e) &&
            (Rb(o) || (_b(o.startContainer) && _b(o.endContainer)))
          ) {
            var o,
              i = Rb(e) ? e : null;
            if (i) {
        ...
        g = {
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r =
                      r.length === i ? Tb(r.nextSibling, !0) : r.parentNode),
                    (o = 0 === a ? Tb(o.previousSibling, !1) : o.parentNode),
                    r && r === o))
                    ? r
                    : n && 3 === n.nodeType
                    ? n.parentNode
          ...
          getSelectedBlocks: function(e, t) {
            return (function(e, t, n, r) {
              ...
              if (
                ((i = e.getRoot()),
                (n = e.getParent(n || Sb(i, t, !1), e.isBlock)),
                (r = e.getParent(r || kb(i, t, !1), e.isBlock)),
                n && n !== i && a.push(n),
                n && r && n !== r)
              )
          ...
          getBoundingClientRect: function() {
            var e = m();
            return e.collapsed
              ? La.fromRangeStart(e).getClientRects()[0]
    ...
    Mb = function(e, t, n, r) {
      var o,
        ...
        l = e === iu.Forwards,
        f = l ? Lb : Pb;
      return !r.collapsed && ((o = Ob(r)), Db(o))
        ? tu(e, t, o, e === iu.Backwards, !0)
        : ((u = Oi(r.startContainer)),
          f((i = Rs(e, t.getBody(), r)))
            ? nu(t, i.getNode(!l))
            : (i = n(i))
            ? f(i)
              ? tu(e, t, i.getNode(!l), l, !0)
              : f((a = n(i))) &&
                ((!(c = bs((s = i), a)) && Oo.isBr(s.getNode())) || c)
              ? tu(e, t, a.getNode(!l), l, !0)
              : u
              ? ou(t, i.toRange(), !0)
              : null
            : u
    ...
    Fb = function(e, t, n, r) {
      ...
      if (
        ((d = Ob(r)),
        (o = Rs(e, t.getBody(), r)),
        (i = n(t.getBody(), Yg(1), o)),
        (a = Bt.filter(i, Gg(1))),
        (s = Bt.last(o.getClientRects())),
        (Lb(o) || Ds(o)) && (d = o.getNode()),
        (Pb(o) || Os(o)) && (d = o.getNode(!0)),
        !s)
      )
        return null;
      if (((c = s.left), (u = nh(a, c)) && Db(u.node)))
        return (
          (l = Math.abs(c - u.left)),
      ...
      if (d) {
        var m = (function(e, t, n, r) {
          ...
          1 === e
            ? ((o = l.next), (i = ia), (a = oa), (u = La.after(r)))
            : ((o = l.prev), (i = oa), (a = ia), (u = La.before(r))),
            (c = m(u));
          do {
            if (u.isVisible() && !a((s = m(u)), c)) {
              if (
                (0 < f.length && i(s, Bt.last(f)) && d++,
                ((s = ta(s)).position = u),
                (s.line = d),
                n(s))
              )
        ...
        if ((u = nh(Bt.filter(m, Gg(1)), c)))
          return ou(t, u.position.toRange(), !0);
        if ((u = Bt.last(Bt.filter(m, Gg(0)))))
          return ou(t, u.position.toRange(), !0);
      }
    },
    zb = function(e, t, n) {
      ...
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        (1 === t ? s(La.fromRangeStart(n)) : c(La.fromRangeStart(n))) ||
          ((a = (i = e).dom.create(i.settings.forced_root_block)),
          (!ve.ie || 11 <= ve.ie) && (a.innerHTML = '<br data-mce-bogus="1">'),
          (o = a),
    ...
    Ub = function(l, f) {
      return function() {
        var e,
          ...
          c = ((t = f),
          (r = Ys((e = l).getBody())),
          (o = da.curry(Ib, r.next)),
          (i = da.curry(Ib, r.prev)),
          (a = t ? iu.Forwards : iu.Backwards),
          (u = t ? o : i),
          (s = e.selection.getRng()),
          (n = Mb(a, e, u, s)) ? n : (n = zb(e, a, s)) || null);
    ...
    qb = function(u, s) {
      return function() {
        var e,
          ...
          (n = Fb(r, e, o, i)) ? n : (n = zb(e, r, i)) || null);
    ...
    $b = function(i, a) {
      i.on("keydown", function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          jb(
            [
              { keyCode: sh.RIGHT, action: Ub(t, !0) },
              { keyCode: sh.LEFT, action: Ub(t, !1) },
              { keyCode: sh.UP, action: qb(t, !1) },
              { keyCode: sh.DOWN, action: qb(t, !0) },
              { keyCode: sh.RIGHT, action: es(t, !0) },
              { keyCode: sh.LEFT, action: es(t, !1) },
              { keyCode: sh.UP, action: ts(t, !1) },
              { keyCode: sh.DOWN, action: ts(t, !0) },
              { keyCode: sh.RIGHT, action: sd.move(t, n, !0) },
              { keyCode: sh.LEFT, action: sd.move(t, n, !1) },
              {
                keyCode: sh.RIGHT,
                ctrlKey: !o.isOSX(),
                altKey: o.isOSX(),
    ...
    Kb = function(e, t, n, r) {
      ...
      if (0 === c.length) vf(t, e, n);
        ...
        (a = yv(!1)),
        (u = Nv(i, a.dom())),
        Hu.before(Vn.fromDom(o), a),
        Hc.remove(Vn.fromDom(o)),
        La(u, 0));
    ...
    Xb = function(n, r) {
      var t,
        e = Vn.fromDom(n.getBody()),
        o = Vn.fromDom(n.selection.getStart()),
        i = H.filter(
          ((t = jl(o, e)),
          H.findIndex(t, mo).fold(V.constant(t), function(e) {
            return t.slice(0, e);
          })),
          Wb
        );
    ...
    Gb = function(o, i) {
      o.on("keydown", function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          jb(
            [
              { keyCode: sh.BACKSPACE, action: Hb(Cf, t, !1) },
              { keyCode: sh.DELETE, action: Hb(Cf, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(dd, t, n, !1) },
              { keyCode: sh.DELETE, action: Hb(dd, t, n, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(tf, t, !1) },
              { keyCode: sh.DELETE, action: Hb(tf, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(Jl, t, !1) },
              { keyCode: sh.DELETE, action: Hb(Jl, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb($d, t, !1) },
              { keyCode: sh.DELETE, action: Hb($d, t, !0) },
              { keyCode: sh.BACKSPACE, action: Hb(Yb, t, !1) },
              { keyCode: sh.DELETE, action: Hb(Yb, t, !0) }
            ],
            r
          ).each(function(e) {
            r.preventDefault();
        ...
        o.on("keyup", function(e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            jb(
              [
                { keyCode: sh.BACKSPACE, action: Hb(xf, t) },
                { keyCode: sh.DELETE, action: Hb(xf, t) }
              ],
              n
            ));
        });
    ...
    aC = function(e, t, n) {
      for (var r = e[n ? "firstChild" : "lastChild"]; r && !Oo.isElement(r); )
    ...
    uC = function(e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        var s,
          c,
          l = o ? t(o) : i.create("BR");
        if (aC(n, r, !0) && aC(n, r, !1))
          rC(n, "LI") ? i.insertAfter(l, iC(n)) : i.replace(l, n);
        else if (aC(n, r, !0))
          rC(n, "LI")
            ? (i.insertAfter(l, iC(n)),
    ...
    fC = function(e, t, n) {
      return !1 === Oo.isText(t)
        ? n
        : e
        ? 1 === n && t.data.charAt(n - 1) === Ri
          ? 0
          : n
        : n === t.data.length - 1 && t.data.charAt(n) === Ri
        ? t.data.length
        : n;
    },
    dC = function(e, t) {
    ...
    pC = function(a, e) {
      var t,
        ...
        S = function(e) {
          ...
          if (
            ((o = fC(e, s, i)),
            Oo.isText(s) && (e ? 0 < o : o < s.nodeValue.length))
          )
            return !1;
      ...
      um(C, N).each(function(e) {
        ...
        Oo.isElement(s) &&
          ...
          (i = p && Oo.isText(s) ? s.nodeValue.length : 0)),
        (u = dC(C, s)) &&
          (((m && !n) || (!m && n)) &&
          ...
          /^(LI|DT|DD)$/.test(f) && C.isEmpty(c)
            ...
            : (m && c === a.getBody()) ||
              ((m = m || "P"),
              Oi(c)
                ? ((r = Vi(c)), C.isEmpty(c) && sC(c), Qb(a, r))
                : S()
                ? k()
                : S(!0)
                ...
                : ((t = ((y = N),
                  ...
                  b.setStart(
                    y.startContainer,
                    fC(!0, y.startContainer, y.startOffset)
                  ),
                  b.setEnd(y.endContainer, fC(!1, y.endContainer, y.endOffset)),
                  b).cloneRange()).setEndAfter(c),
                  (function(e) {
                    for (
                      ;
                      Oo.isText(e) &&
                      ...
                      for (r = i.length; r--; )
                        ...
                        (o.firstChild === o.lastChild &&
                          ...
                          : (a = o) &&
                            "A" === a.nodeName &&
                            0 ===
                              It.trim(_i(a.innerText || a.textContent))
                                .length &&
                            e.remove(o);
                      var a;
                    }
                  ...
                  C.isEmpty(c) && sC(c),
                  r.normalize(),
                  C.isEmpty(r) ? (C.remove(r), k()) : Qb(a, r)),
              C.setAttrib(r, "id", ""),
    ...
    RC = function(e, t) {
      return Df(
        [
          AC([bC], yC.none()),
          AC([wC("summary", !0)], yC.br()),
          AC([NC(!0), EC(!1), kC], yC.br()),
          AC([NC(!0), EC(!1)], yC.block()),
          AC([NC(!0), EC(!0), kC], yC.block()),
          AC([NC(!0), EC(!0)], yC.br()),
          AC([xC(!0), kC], yC.br()),
          AC([xC(!0)], yC.block()),
          AC([CC(!0), kC, TC], yC.block()),
          AC([CC(!0)], yC.br()),
          AC([SC], yC.br()),
          AC([CC(!1), kC], yC.br()),
          AC([TC], yC.block())
    ...
    PC = function(e) {
      return (
        !!e.selection.isCollapsed() &&
        ((t = e),
        (n = V.curry(xl.isInlineTarget, t)),
        (r = La.fromRangeStart(t.selection.getRng())),
        Gf(n, t.getBody(), r)
          .map(V.curry(DC, t, r))
          .getOr(!1))
      );
    ...
    LC = function(r) {
      r.on("keydown", function(e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          jb([{ keyCode: sh.SPACEBAR, action: Hb(PC, t) }], n).each(function(
            e
          ) {
            n.preventDefault();
          }));
    ...
    MC = function(e, t) {
      var n,
        r = ((n = e),
        Tl(Vn.fromDom(n.getBody()), "*[data-mce-caret]").fold(
          V.constant(null),
          function(e) {
            return e.dom();
          }
      ...
      if (r)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void IC(e, r))
          : void (Ii(r) && (IC(e, r), e.undoManager.add()));
    },
    FC = function(e) {
        ...
        Range.prototype.getClientRects ||
          u.on("mousedown", function(e) {
            if (!v(e) && "HTML" === e.target.nodeName) {
              var t = u.getBody();
              t.blur(),
                we.setEditorTimeout(u, function() {
                  t.focus();
                });
            }
          }),
  ...
  var qC = function(e) {
        ...
        3 === e.detail &&
          (function(e) {
            ...
            if (Da.isElementPosition(n)) {
              var o = n.container();
              qC(o) &&
                Qa.firstPositionIn(o).each(function(e) {
                  return t.setStart(e.container(), e.offset());
                });
            }
            Da.isElementPosition(r) &&
              ((o = n.container()),
              qC(o) &&
                Qa.lastPositionIn(o).each(function(e) {
      ...
      (t = e).on("click", function(e) {
        ...
        n.serializer.addNodeFilter("details", function(e) {
          H.each(e, function(e) {
            ...
            e.attr("open", k.isString(t) ? t : null),
    ...
    WC = function(t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        (t.parser = ((o = qy((u = t).settings, u.schema)).addAttributeFilter(
        ...
        o.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function(e) {
          for (var t, n = e.length, r = u.schema.getNonEmptyElements(); n--; )
            (t = e[n]).isEmpty(r) &&
              ...
              (t.append(new _y("br", 1)).shortEnded = !0);
        }),
        o)),
        (t.serializer = Wy(f, t)),
        (t.selection = Bb(t.dom, t.getWin(), t.serializer, t)),
        (t.formatter = vy(t)),
        (t.undoManager = Uh(t)),
        (t._nodeChangeDispatcher = new Dg(t)),
        (t._selectionOverrides = ph(t)),
        HC(t),
        VC(t),
        zC(t),
        kg(t),
        ...
        0 < t.contentStyles.length &&
          ((r = ""),
          It.each(t.contentStyles, function(e) {
            r += e + "\r\n";
          }),
          t.dom.addStyle(r)),
        ((i = t),
        ...
        f.content_style &&
          ((a = t),
          (s = f.content_style),
          (c = Vn.fromDom(a.getDoc().head)),
          (l = Vn.fromTag("style")),
          lr.set(l, "type", "text/css"),
          Hu.append(l, Vn.fromText(s)),
          Hu.append(c, l));
    },
    KC = vi.DOM,
    XC = function(e, t) {
      ...
      return (
        ...
        (e.iframeElement = l),
        (e.iframeHTML = ((p = Tu((f = e)) + "<html><head>"),
        Au(f) !== f.documentBaseUrl &&
    ...
    JC = function(t, n, e) {
      var r,
        ...
        i = og.get(e);
      if (
        ((r = og.urls[e] || t.documentBaseUrl.replace(/\/$/, "")),
        (e = It.trim(e)),
        i && -1 === It.inArray(n, e))
      ) {
        if (
          (It.each(og.dependencies(e), function(e) {
            JC(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    ex = function(e) {
      ...
      return e.inline
        ? ZC(null)
        : ((t = r), (n = GC.create("div")), GC.insertAfter(n, t), ZC(n));
    },
    tx = function(e) {
      var t,
        n,
      ...
      return (
        ...
        k.isString(d.theme)
          ? ((l = (o = e).settings),
            (f = o.getElement()),
            (i = l.width || GC.getStyle(f, "width") || "100%"),
            (a = l.height || GC.getStyle(f, "height") || f.offsetHeight),
            (u = l.min_height || 100),
            (s = /^[0-9\.]+(|px)$/i).test("" + i) &&
    ...
    nx = function(t) {
      ...
      return (
        ...
        (u.aria_label =
          u.aria_label ||
          GC.getAttrib(s, "aria-label", t.getLang("aria.rich_text_area"))),
        t.fire("ScriptsLoaded"),
        (o = (n = t).settings.theme),
        k.isString(o)
          ? ((n.settings.theme = QC(o)),
            (r = ig.get(o)),
            (n.theme = new r(n, ig.urls[o])),
            n.theme.init &&
              n.theme.init(
                n,
                ig.urls[o] || n.documentBaseUrl.replace(/\/$/, ""),
                n.$
              ))
          : (n.theme = {}),
        (i = t),
        (a = []),
        It.each(i.settings.plugins.split(/[ ,]/), function(e) {
          JC(i, a, QC(e));
        }),
        (e = tx(t)),
        (t.editorContainer = e.editorContainer ? e.editorContainer : null),
        u.content_css &&
          It.each(It.explode(u.content_css), function(e) {
      ...
      !(function(e, t, n, r) {
        ...
        if (k.isString(i)) {
          if (!ox(i) && !ig.urls.hasOwnProperty(i)) {
            var a = o.theme_url;
            a
              ? ig.load(i, t.documentBaseURI.toAbsolute(a))
              : ig.load(i, "themes/" + i + "/theme" + n + ".js");
          }
        ...
        (e = u),
          ...
          (r = i.settings),
          (o = a),
          It.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
          It.each(r.external_plugins, function(e, t) {
        ...
        if (t.getElement() && ve.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (rx.insertAfter(
                rx.create("input", { type: "hidden", name: n }),
                n
              ),
              (t.hasHiddenInput = !0)),
            ...
            rx.bind(o, "submit reset", t.formEventDelegate),
            t.on("reset", function() {
            ...
            (t.windowManager = Yp(t)),
            (t.notificationManager = Xp(t)),
            "xml" === e.encoding &&
      ...
      if (
        ...
        0 !== r.indexOf("/") ||
          ...
          /^[\w\-]*:?\/\//.test(r) ||
            ((n = e.base_uri
              ? e.base_uri.path
              : new dx(document.location.href).directory),
            "" == e.base_uri.protocol
  ...
  var mx = function(e, t, n) {
      ...
      if (
        ...
        r = It.trim(bh.trimExternal(e.serializer, n.innerHTML));
    ...
    vx = function(e, t) {
      ...
      e.dom.setHTML(e.getBody(), t),
        zp((r = e)) &&
          Qa.firstPositionIn(r.getBody()).each(function(e) {
            var t = e.getNode(),
    ...
    yx = function(u, s, c) {
      return (
        ...
        A.from(u.getBody()).fold(V.constant(s), function(e) {
          return hx(s)
            ? (function(e, t, n, r) {
                gx(
                ...
                return (
                  (r.content = wo(Vn.fromDom(t)) ? o : It.trim(o)),
                  vx(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  t.fire("SetContent", o))
                : ("raw" !== o.format &&
                    (r = Jc({ validate: t.validate }, t.schema).serialize(
                      t.parser.parse(r, { isRootContent: !0, insert: !0 })
                    )),
                  (o.content = wo(Vn.fromDom(n)) ? r : It.trim(r)),
                  vx(t, o.content),
    ...
    xx = function(e) {
      if (!e.removed) {
        ...
        r && e.save(),
          ...
          e.hasHiddenInput && o && bx.remove(o.nextSibling),
          !e.inline &&
            r &&
            ((i = e), bx.setStyle(i.id, "display", i.orgDisplay)),
          fp(e),
          e.editorManager.remove(e),
          bx.remove(e.getContainer()),
          Cx(t),
          Cx(n),
          e.destroy();
      }
        ...
        (t || e.removed
          ? (t ||
            ...
            (r = (n = e).formElement) &&
              ...
              bx.unbind(r, "submit reset", n.formEventDelegate)),
    ...
    Ax = function(e, t, n) {
      ...
      (r = l),
        ...
        l.setDirty(!1),
        (l.plugins = {}),
        (l.documentBaseURI = new dx(t.document_base_url, { base_uri: d })),
        (l.baseURI = d),
        (l.contentCSS = []),
        (l.contentStyles = []),
        (l.shortcuts = new Ap(l)),
        (l.loadedCSS = {}),
        (l.editorCommands = new Hm(l)),
        (l.suffix = n.suffix),
        (l.editorManager = n),
        (l.inline = t.inline),
        (l.buttons = {}),
        (l.menuItems = {}),
        t.cache_suffix &&
          (ve.cacheSuffix = t.cache_suffix.replace(/^[\?\&]+/, "")),
        !1 === t.override_viewport && (ve.overrideViewPort = !1),
        n.fire("SetupEditor", { editor: l }),
        l.execCallback("setup", l),
        (l.$ = tn.overrideDefaults(function() {
          return {
  ...
  Ex(
    (Ax.prototype = {
      ...
      show: function() {
        this.hidden &&
          ...
          this.inline
            ...
            : (Nx.show(this.getContainer()), Nx.hide(this.id)),
          this.load(),
          this.fire("show"));
      },
      hide: function() {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (Tx && t && !e.inline && t.execCommand("SelectAll"),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = !1),
              e === e.editorManager.focusedEditor &&
                (e.editorManager.focusedEditor = null))
            : (Nx.hide(e.getContainer()),
              Nx.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      },
      isHidden: function() {
      ...
      getContent: function(e) {
        return (
          ...
          A.from(t.getBody()).fold(
            V.constant("tree" === n.format ? new _y("body", 11) : ""),
            function(e) {
              return mx(t, n, e);
            }
          )
      ...
      getElement: function() {
        return (
          this.targetElm || (this.targetElm = Nx.get(this.id)), this.targetElm
        );
      },
      getWin: function() {
        var e;
      ...
      addVisual: function(e) {
        ...
        (e = e || r.getBody()),
          ...
          Sx(i.select("table,a", e), function(e) {
            var t;
            switch (e.nodeName) {
              case "TABLE":
                return (
  ...
  var Rx,
    ...
    Px = function(e) {
      ...
      e.inline &&
        ...
        vi.DOM.bind(document, "mouseup", r),
        t.on("remove", function() {
    ...
    zx = function(e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (Lx.unbind(document, "focusin", Rx), (Rx = null));
    },
    Ux = function(e) {
    ...
    Zx = function(e) {
      e !== Yx &&
        (e
          ? tn(window).on("resize scroll", Qx)
          : tn(window).off("resize scroll", Qx),
        (Yx = e));
    },
    ew = function(t) {
      var e = Jx;
      ...
      return (
        (Jx = H.filter(Jx, function(e) {
          return t !== e;
        })),
        Bx.activeEditor === t &&
          (Bx.activeEditor = 0 < Jx.length ? Jx[0] : null),
        Bx.focusedEditor === t && (Bx.focusedEditor = null),
        e.length !== Jx.length
      );
    };
  Kx(
    (Bx = {
      ...
      setup: function() {
        var e,
          ...
          o = "";
        if (
          ((t = dx.getDocumentBaseUrl(document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
            ((t = t.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
            /[\/\\]$/.test(t) || (t += "/")),
        ...
        var c = function(e) {
          ...
          e = function() {
            ...
            jx.unbind(window, "ready", e),
              ...
              r.types
                ? Wx(r.types, function(t) {
                    It.each(o, function(e) {
                      return (
                        !jx.is(e, t.selector) || (n(c(e), Kx({}, r, t), e), !1)
                      );
                    });
                  })
                : (It.each(o, function(e) {
      ...
      add: function(e) {
        ...
        return (
          Gx[e.id] === e ||
            (null === t.get(e.id) &&
              ("length" !== e.id && (Gx[e.id] = e), Gx.push(e), Jx.push(e)),
            Zx(!0),
            (t.activeEditor = e),
            ...
            _x ||
              ...
              jx.bind(window, "beforeunload", _x))),
          e
        );
      },
      ...
      remove: function(e) {
        ...
        if (e)
          return k.isString(e)
            ? ((e = e.selector || e),
              void Wx(jx.select(e), function(e) {
                (n = r.get(e.id)) && r.remove(n);
              }))
            : ((n = e),
              k.isNull(r.get(n.id))
                ? null
                : (ew(n) && r.fire("RemoveEditor", { editor: n }),
                  0 === Jx.length && jx.unbind(window, "beforeunload", _x),
                  n.remove(),
                  Zx(0 < Jx.length),
                  n));
  ...
  ((tw = rw || (rw = {})).compareRanges = em),
    (tw.getCaretRangeFromPoint = Zy),
    (tw.getSelectedNode = aa),
    (tw.getNode = ua);
  var ow,
    iw,
    aw = rw,
    ...
    dw = {
      ...
      intersect: function(e, t) {
        ...
        return (
          ...
          o - n < 0 || i - r < 0 ? null : fw(n, r, o - n, i - r)
        );
      },
  ...
  vw.extend = ow = function(n) {
    ...
    (iw = !1),
    n.Mixins &&
      (gw(n.Mixins, function(e) {
        for (var t in e) "init" !== t && (n[t] = e[t]);
      }),
      o.Mixins && (n.Mixins = o.Mixins.concat(n.Mixins))),
    n.Methods &&
      gw(n.Methods.split(","), function(e) {
        n[e] = a;
      }),
    n.Properties &&
      gw(n.Properties.split(","), function(e) {
        var t = "_" + e;
        n[e] = function(e) {
    ...
    n.Statics &&
      gw(n.Statics, function(e, t) {
        i[t] = e;
      }),
    n.Defaults && o.Defaults && (n.Defaults = hw({}, o.Defaults, n.Defaults)),
    n))
    ...
    Ew = {
      send: function(e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ""),
          Ew.fire("beforeInitialize", { settings: e }),
          (t = new ag()))
        ) {
          if (
            ...
            e.requestheaders &&
              It.each(e.requestheaders, function(e) {
                t.setRequestHeader(e.key, e.value);
              }),
            t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            (t = Ew.fire("beforeSend", { xhr: t, settings: e }).xhr).send(
              e.data
            ),
            !e.async)
          )
    ...
    (kw.prototype = {
      send: function(n) {
        ...
        ((n = Sw(this.settings, n)).success = function(e, t) {
          void 0 === (e = ww.parse(e)) && (e = { error: "JSON Parse error." }),
            e.error
