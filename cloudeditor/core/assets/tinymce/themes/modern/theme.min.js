!(function() {
  ...
  var e,
    ...
    U = function(e, t, n, i, r, o) {
      return (
        (o = I({ x: t, y: n, w: o.w, h: o.h })),
        e &&
          (o = e({ elementRect: I(i), contentAreaRect: I(r), panelRect: o })),
        o
      );
    },
    V = function(x) {
        ...
        n = function(e, t) {
          ...
          if (!x.removed) {
            ...
            (l = ["bc-tc", "tc-bc", "tl-bl", "bl-tl", "tr-br", "br-tr"]),
              ...
              t && s.show(),
              (d = e.element),
              (f = L.getPos(x.getContentAreaContainer())),
              (h = x.dom.getRect(d)),
              "BODY" === (m = x.dom.getRoot()).nodeName &&
                ((h.x -=
                  m.ownerDocument.documentElement.scrollLeft || m.scrollLeft),
                (h.y -=
                  m.ownerDocument.documentElement.scrollTop || m.scrollTop)),
              (h.x += f.x),
              (h.y += f.y),
              (r = h),
              (i = L.getRect(s.getEl())),
              (o = L.getRect(x.getContentAreaContainer() || x.getBody()));
            var g,
              p,
              v,
            ...
            if (
              ...
              (o.x += b.x),
              (o.y += b.y),
              "inline" !== L.getStyle(e.element, "display", !0))
            ) {
            ...
            x.inline || (o.w = x.getDoc().documentElement.offsetWidth),
              x.selection.controlSelection.isResizable(e.element) &&
                r.w < 25 &&
                (r = R.inflate(r, 0, 8)),
              (n = R.findBestRelativePosition(i, r, o, l)),
              (r = R.clamp(r, o)),
              n
                ? ((a = R.relativePosition(i, r, n)),
                  F(s, U(u, a.x, a.y, r, o, i)))
                : ((o.h += i.h),
                  (r = R.intersect(o, r))
                    ? (n = R.findBestRelativePosition(i, r, o, [
                        "bc-tc",
                        "bl-tl",
                        "br-tr"
                      ]))
        ...
        a ||
          w.each(n, function(e, t) {
            ...
            e.context !== r ||
              ...
              e.prependToContext ? s.unshift(ae(t, e)) : s.push(ae(t, e)),
              "after" === e.separator &&
                s.push({ name: "|", item: { text: "|" } }));
          }),
        (i.menu = oe.map(
    ...
    be = function(c, d, f) {
      return function(e) {
        ...
        (i = d),
          ...
          l && l.visible()
            ? (ve(u, l, "onhide"), l.hide(), s.active(!1))
            : (l
                ? l.show()
                : ((l = v.create({
                    type: "container",
    ...
    ye = function(e) {
      return (
        !((pe.ie && !(11 <= pe.ie)) || !e.sidebars) && 0 < e.sidebars.length
      );
    },
    xe = function(n) {
      return {
    ...
    Ce = function(t, e, n) {
      ...
      if (
        (!1 === m(t) && n.skinUiCss
          ? _e.styleSheetLoader.load(n.skinUiCss, we(t))
          : we(t)(),
        (i = e.panel = v.create({
          type: "panel",
          role: "application",
          ...
          items: [
            {
              ...
              items: [
                !1 === d(t)
                  ? null
                  : { type: "menubar", border: "0 0 1 0", items: ce(t) },
                z(t, f(t))
              ]
            },
            ye(t)
        ...
        "none" !== g(t) &&
          (r = {
            ...
            onResize: function(e) {
              "both" === g(t)
                ? me(t, o.width + e.deltaX, o.height + e.deltaY)
                : me(t, null, o.height + e.deltaY);
            }
          }),
      ...
      return (
        ...
        n.width && _e.setStyle(i.getEl(), "width", n.width),
  ...
  function Te(e, t, n) {
    ...
    return (
      (d = Pe()),
      (o = (r = He.getPos(t, A.getUiContainer(e))).x),
      (s = r.y),
      Me(e) && Se(document.body) && ((o -= d.x), (s -= d.y)),
      (i = e.getEl()),
      (a = (f = He.getSize(i)).width),
      (l = f.height),
      (u = (f = He.getSize(t)).width),
      (c = f.height),
      "b" === (n = (n || "").split(""))[0] && (s += c),
      "r" === n[1] && (o += u),
  ...
  var Pe = function() {
    ...
    We = function(e) {
      var t,
        n = A.getUiContainer(e);
      return n && !Me(e)
        ? { x: 0, y: 0, w: (t = n).scrollWidth - 1, h: t.scrollHeight - 1 }
        : Pe();
    },
    Ne = {
      ...
      moveTo: function(e, t) {
        ...
        return (
          s && Se(s) && !Me(n) && ((e -= s.scrollLeft), (t -= s.scrollTop)),
          s && ((e += 1), (t += 1)),
      ...
      init: function(e) {
        ...
        function a(e, t) {
          ...
          do {
            if (
              (je.exec(""),
              (i = je.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))
            ) {
              n = i[3];
              break;
            }
  ...
  var Qe,
    ...
    tt = De.extend({
      ...
      init: function(e) {
        var t, n;
        for (t in (e = e || {}))
          (n = e[t]) instanceof Ge && (e[t] = n.create(this, t));
        this.data = e;
      },
      set: function(t, n) {
        var i,
          ...
          o = this.data[t];
        if (
          (n instanceof Ge && (n = n.create(this, t)), "object" == typeof t)
        ) {
          ...
          nt[t._id] || (nt[t._id] = t),
            Qe ||
              ...
              u.requestAnimationFrame(function() {
                var e, t;
                for (e in ((Qe = !1), nt))
                  (t = nt[e]).state.get("rendered") && t.reflow();
                nt = {};
              }, document.body));
        }
      },
    ...
    at = {
      ...
      init: function(t) {
        ...
        (i.settings = t = w.extend({}, i.Defaults, t)),
          ...
          (i.settings = t),
          (i.borderBox = Be(t.border)),
          (i.paddingBox = Be(t.padding)),
          (i.marginBox = Be(t.margin)),
          t.hidden && i.hide();
      },
      ...
      initLayoutRect: function() {
        var e,
          ...
          d = c.settings,
          f = c.getEl();
        (e = c.borderBox = c.borderBox || Oe(f, "border")),
          (c.paddingBox = c.paddingBox || Oe(f, "padding")),
          (c.marginBox = c.marginBox || Oe(f, "margin")),
          (u = He.getSize(f)),
          (a = d.minWidth),
          (l = d.minHeight),
          (r = a || u.width),
      ...
      repaint: function() {
        ...
        (l = document.createRange
          ...
          c._hasBody &&
            ...
            ((u = l(i.innerW)),
            (n = c.getEl("body")) &&
              ((t = n.style).width = (0 <= u ? u : 0) + "px"),
            (a.innerW = i.innerW)),
          c._hasBody &&
            i.innerH !== a.innerH &&
            ((u = l(i.innerH)),
            (n = n || c.getEl("body")) &&
              ((t = t || n.style).height = (0 <= u ? u : 0) + "px"),
            (a.innerH = i.innerH)),
      ...
      getEl: function(e) {
        ...
        return (
          this._elmCache[t] || (this._elmCache[t] = ke("#" + t)[0]),
          this._elmCache[t]
        );
      },
      show: function() {
      ...
      remove: function() {
        ...
        r &&
          ...
          r.items().set(t),
          (r._lastRect = null)),
          n._eventsRoot && n._eventsRoot === n && ke(i).off();
      ...
      renderTo: function(e) {
        return (
          ke(e || this.getContainerElm()).append(this.renderHtml()),
          this.postRender(),
          this
        );
      },
      ...
      postRender: function() {
        var e,
          ...
          o = this,
          s = o.settings;
        for (i in ((o.$el = ke(o.getEl())), o.state.set("rendered", !0), s))
  ...
  function ut(a) {
      ...
      if (r !== o) {
        if (
          ...
          for (t = i.length - 1; s <= t; t--)
            (o = i[t]).fire("mouseleave", { target: o.getEl() });
        }
        for (t = s; t < n.length; t++)
          (r = n[t]).fire("mouseenter", { target: r.getEl() });
      }
    }
    function c(e) {
      e.preventDefault(),
    ...
    if ((i = a._nativeEvents)) {
      for (
        (n = a.parents().toArray()).unshift(a), e = 0, t = n.length;
        !l && e < t;
        e++
      )
        l = n[e]._eventsRoot;
      for (
        l || (l = n[n.length - 1] || a), a._eventsRoot = l, t = e, e = 0;
        e < t;
        e++
      )
        n[e]._eventsRoot = l;
          ...
          ? ("mouseenter" === r || "mouseleave" === r
              ? l._hasMouseEnter ||
                (ke(l.getEl())
                  ...
                  .on("mouseover", u),
                (l._hasMouseEnter = 1))
              : d[r] || (ke(l.getEl()).on(r, o), (d[r] = !0)),
            (i[r] = !1))
          : rt
          ? ke(a.getEl()).on("mousewheel", c)
          : ke(a.getEl()).on("DOMMouseScroll", c);
      }
    }
  }
    ...
    return (
      ...
      n.on("keydown", function(e) {
        function t(e, t) {
          u(o) ||
            dt(o) ||
            ("slider" !== s(o) && !1 !== t(e) && e.preventDefault());
        }
    ...
    mt = ct.extend({
            ...
            e.parent(i),
              e.state.get("rendered") ||
                ...
                t <= n.childNodes.length - 1
                  ? ke(n.childNodes[t]).before(e.renderHtml())
                  : ke(n).append(e.renderHtml()),
                e.postRender(),
                it.add(e));
          }),
      ...
      postRender: function() {
        ...
        return (
          ...
          t.parent() || (t.keyboardNav = ft({ root: t })),
          t
        );
      },
      initLayoutRect: function() {
      ...
      reflow: function() {
        ...
        if ((it.remove(this), this.visible())) {
          for (
            ct.repaintControls = [],
              ct.repaintControls.map = {},
              this.recalc(),
              e = ct.repaintControls.length;
            e--;

          )
            ct.repaintControls[e].repaint();
  ...
  function pt(e, h) {
    ...
    (t = function(e) {
      ...
      (v = function(e) {
        ...
        (e.deltaX = e.screenX - b),
          (e.deltaY = e.screenY - y),
          e.preventDefault(),
          h.drag(e);
      }),
      (p = function(e) {
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl("scroll" + e))) {
              if (
                ((f = t.toLowerCase()),
                (h = n.toLowerCase()),
                ke(p.getEl("absend")).css(f, p.layoutRect()[i] - 1),
                !r)
              )
                return void ke(a).css("display", "none");
              ke(a).css("display", "block"),
                (s = p.getEl("body")),
            ...
            (function() {
              function e(s, a, l, u, c) {
                ...
                ke(p.getEl()).append(
                  ...
                  (p.draghelper = new pt(e + "t", {
                    start: function() {
                      (d = p.getEl("body")["scroll" + a]),
                        ke("#" + e).addClass(t + "active");
                    },
                    drag: function(e) {
                      var t,
                        n,
  ...
  function St(r) {
    ...
    function t(e, t) {
      for (var n, i = 0; i < Ct.length; i++)
        if (Ct[i] !== r)
          for (n = Ct[i].parent(); n && (n = n.parent()); )
            n === r &&
              Ct[i]
                .fixed(e)
                .moveBy(0, t)
  ...
  function Mt(e, t) {
    var n,
      ...
      r = Tt.zIndex || 65535;
    if (e) kt.push(t);
    else for (n = kt.length; n--; ) kt[n] === t && kt.splice(n, 1);
    if (kt.length)
      for (n = 0; n < kt.length; n++)
        kt[n].modal && (r++, (i = kt[n])),
          (kt[n].getEl().style.zIndex = r),
          (kt[n].zIndex = r),
          r++;
    var o = ke("#" + t.classPrefix + "modal-block", t.getContainerElm())[0];
    i
      ? ke(o).css("z-index", i.zIndex - 1)
      : o && (o.parentNode.removeChild(o), (xt = !1)),
      (Tt.currentZIndex = r);
  }
  var Tt = _t.extend({
    Mixins: [Ne, Rt],
      ...
      i._super(e),
            ...
            if (!yt) {
              ...
              (yt = function() {
                (document.all && t === e.clientWidth && n === e.clientHeight) ||
                  ((t = e.clientWidth), (n = e.clientHeight), Tt.hideAll());
              }),
        ...
        i.on("postrender show", function(e) {
          if (e.control === i) {
            ...
            i.modal &&
              !xt &&
              ((t = ke("#" + n + "modal-block", i.getContainerElm()))[0] ||
                (t = ke(
                  '<div id="' +
                    n +
                    'modal-block" class="' +
  ...
  var Wt = function(e, t) {
    ...
    Nt = function(s, e, t) {
      ...
      var r = function() {
          if (a && a.moveRel && a.visible() && !a._fixed) {
            ...
            a.fixed(!1)
              .moveRel(
                t,
                s.rtl ? ["tr-br", "br-tr"] : ["tl-bl", "bl-tl", "tr-br"]
              )
              .moveBy(n, i);
          }
        },
        ...
        u = function() {
          a &&
            (a.hide(),
            Tt.hideAll(),
            l.removeClass(s.getBody(), "mce-edit-focus"));
        },
        c = function() {
          a
            ? a.visible() || o()
            : ((a = e.panel = v.create({
                ...
                items: [
                  !1 === d(s)
                    ? null
                    : { type: "menubar", border: "0 0 1 0", items: ce(s) },
                  z(s, f(s))
                ]
              })),
              A.setUiContainer(s, a),
              x(s),
              n ? a.renderTo(n).reflow() : a.renderTo().reflow(),
              _(s, a),
              o(),
              V(s),
              s.on("nodeChange", r),
      ...
      return (
        ...
        s.on("focus", function() {
          !1 === m(s) && t.skinUiCss
            ? l.styleSheetLoader.load(t.skinUiCss, c, c)
            : c();
        }),
        s.on("blur hide", u),
        ...
        !1 === m(s) && t.skinUiCss
          ? l.styleSheetLoader.load(t.skinUiCss, we(s))
          : we(s)(),
        {}
      );
    };
  ...
  var At = function(e, t) {
    ...
    Bt = function(e, t, n) {
      ...
      return (
        ...
        At(e, t),
        e.getParam("inline", !1, "boolean") ? Nt(e, t, n) : Ce(e, t, n)
      );
    },
    Ot = ct.extend({
      Mixins: [Ne],
      ...
      tooltip: function() {
        return (
          this._tooltip ||
            ...
            A.inheritUiContainer(this, this._tooltip),
    ...
    Ft = ct.extend({
      ...
      init: function(e) {
        ...
        t._super(e),
          ...
          e.progressBar && (t.progressBar = new Lt()),
  ...
  function Ut(o) {
    ...
    return {
      open: function(e, t) {
        var n,
          i = w.extend(e, { maxWidth: ((n = s(o)), He.getSize(n).width) }),
          r = new Ft(i);
        return (
          0 < (r.args = i).timeout &&
  ...
  function qt(e) {
    var t,
      n = ke("meta[name=viewport]")[0];
    !1 !== pe.overrideViewPort &&
      (n ||
        ((n = document.createElement("meta")).setAttribute("name", "viewport"),
        document.getElementsByTagName("head")[0].appendChild(n)),
      (t = n.getAttribute("content")) && void 0 !== jt && (jt = t),
      n.setAttribute(
        "content",
        e
  ...
  function Yt(e, t) {
    (function() {
      for (var e = 0; e < Vt.length; e++) if (Vt[e]._fullscreen) return !0;
      return !1;
    })() &&
      !1 === t &&
      ke([document.documentElement, document.body]).removeClass(
        e + "fullscreen"
      );
  }
  var $t = Tt.extend({
    ...
    init: function(e) {
      ...
      n._super(e),
        ...
        n.on("click", function(e) {
          ...
          (He.hasClass(e.target, t) || He.hasClass(e.target.parentNode, t)) &&
            n.close();
        }),
      ...
      if (e !== i._fullscreen)
        if (
          (ke(window).on("resize", function() {
            ...
            if (i._fullscreen)
              if (n)
                ...
                i.moveTo(0, 0).resizeTo(t.w, t.h),
                  50 < new Date().getTime() - e && (n = !0);
              }
          }),
          (t = i.layoutRect()),
          (i._fullscreen = e))
          ...
          (i._initial = { x: t.x, y: t.y, w: t.w, h: t.h }),
            ...
            ke([r, document.body]).addClass(o + "fullscreen"),
            i.classes.add("fullscreen");
          var s = He.getWindowSize();
          i.moveTo(0, 0).resizeTo(s.w, s.h);
        } else
          (i.borderBox = Be(i.settings.border)),
            (i.getEl("head").style.display = ""),
            (t.deltaH += t.headerH),
            ke([r, document.body]).removeClass(o + "fullscreen"),
    ...
    postRender: function() {
      ...
      setTimeout(function() {
        ...
        n.focus(),
        (this.dragHelper = new pt(n._id + "-dragh", {
          start: function() {
  ...
  !(function() {
    if (!pe.desktop) {
      ...
      u.setInterval(function() {
        ...
        (n.w === e && n.h === t) ||
          ((n = { w: e, h: t }), ke(window).trigger("resize"));
      }, 100);
    }
    ke(window).on("resize", function() {
      var e,
      ...
      for (e = 0; e < Vt.length; e++)
        (t = Vt[e].layoutRect()),
          Vt[e].moveTo(
            Vt[e].settings.x || Math.max(0, n.w / 2 - t.w / 2),
            Vt[e].settings.y || Math.max(0, n.h / 2 - t.h / 2)
          );
    });
  })();
  var Xt,
        ...
        msgBox: function(e) {
          ...
          switch (e.buttons) {
            ...
            case Jt.YES_NO_CANCEL:
              (t = [n("Yes", 1, !0), n("No", 0)]),
                e.buttons === Jt.YES_NO_CANCEL && t.push(n("Cancel", -1));
              break;
            default:
              t = [n("Ok", !0, !0)];
          }
    ...
    en = Qt.extend({
      ...
      remove: function() {
        ke(this.getEl("button")).off(),
          ke(this.getEl("input")).off(),
          this._super();
      }
    }),
    tn = mt.extend({
    ...
    on = zt.extend({
      init: function(i) {
        ...
        r._super(i),
            ...
            if (ke.contains(n, t) || t === n)
              for (; t && t !== n; )
                t.id &&
                  ...
                  (r.fire("action"),
                  i.menu &&
                    (r.showMenu(), e.aria && r.menu.items()[0].focus())),
                  (t = t.parentNode);
          }),
          ...
          r.on("mouseover", function(e) {
            ...
            if (
              r.statusLevel() &&
              -1 !== e.target.className.indexOf(r.classPrefix + "status")
            ) {
      ...
      statusLevel: function(e) {
        return (
          0 < arguments.length && this.state.set("statusLevel", e),
      ...
      repaint: function() {
        ...
        n.statusLevel() &&
          "none" !== n.statusLevel() &&
          (s =
            parseInt(He.getRuntimeStyle(a, "padding-right"), 10) -
            parseInt(He.getRuntimeStyle(a, "padding-left"), 10)),
          (e = r ? o.w - He.getSize(r).width - 10 : o.w - 10);
        var l = document;
        return (
          l.all &&
            (!l.documentMode || l.documentMode <= 8) &&
            (t = n.layoutRect().h - 2 + "px"),
          ke(a).css({ width: e - s, lineHeight: t }),
          n._super(),
          n
        );
      },
      postRender: function() {
        var t = this;
        return (
          ke(this.getEl("inp")).on("change", function(e) {
        ...
        if (0 !== e.length) {
          r.menu
            ...
            r.menu.on("cancel", function(e) {
              e.control.parent() === r.menu &&
                (e.stopPropagation(), r.focus(), r.hideMenu());
            }),
        ...
        r.state.on("change:value", function(e) {
          ...
          r.state.on("change:statusLevel", function(e) {
            var t = r.getEl("status"),
              n = r.classPrefix,
              i = e.value;
            He.css(t, "display", "none" === i ? "none" : ""),
              He.toggleClass(t, n + "i-checkmark", "ok" === i),
              He.toggleClass(t, n + "i-warning", "warn" === i),
              He.toggleClass(t, n + "i-error", "error" === i),
          ...
          r.on("keydown", function(e) {
            ...
            "INPUT" === e.target.nodeName &&
              (t === rn.DOWN
                ...
                : t === rn.UP && (e.preventDefault(), n(-1, r.menu)));
          }),
          r._super()
        );
      },
      remove: function() {
        ke(this.getEl("inp")).off(),
        ...
        return (
          t.on("click", function(e) {
            (e.aria && "down" === e.aria.key) ||
              e.control !== t ||
              ln.getParent(e.target, "." + t.classPrefix + "open") ||
    ...
    dn = zt.extend({
      ...
      postRender: function() {
        ...
        function c(e, t) {
          var n = (360 - e.h) / 360;
          He.css(r, { top: 100 * n + "%" }),
            t || He.css(s, { left: e.s + "%", top: 100 - e.v + "%" }),
            (o.style.background = cn({ s: 100, v: 100, h: e.h }).toHex()),
        ...
        (i = a.getEl("h")),
          ...
          a._super(),
          (a._svdraghelper = new pt(a._id + "-sv", { start: e, drag: e })),
          (a._hdraghelper = new pt(a._id + "-h", { start: t, drag: t })),
          a._repaint();
      },
      rgb: function() {
    ...
    fn = zt.extend({
      ...
      renderHtml: function() {
        ...
        return (
          ...
          n.height && He.css(t, "height", n.height + "px"),
          n.width && He.css(t, "width", n.width + "px"),
        ...
        return (
          !1 !== s.settings.elementpath &&
            (o.on("select", function(e) {
              s.focus(),
                s.selection.select(this.row()[e.index].element),
                s.nodeChanged();
            }),
                ...
                if (1 === n[i].nodeType && !a(n[i])) {
                  ...
                  if (
                    (r.isDefaultPrevented() ||
                      t.push({ name: r.name, element: n[i] }),
    ...
    Xn = {
      unknown: function() {
        return $n({ current: undefined, version: jn.unknown() });
      },
      nu: $n,
    ...
    ti = {
      unknown: function() {
        return ei({ current: undefined, version: jn.unknown() });
      },
      nu: ei,
    ...
    ui = [
      ...
      { name: "Linux", search: ai("linux"), versionRegexes: [] },
      { name: "Solaris", search: ai("sunos"), versionRegexes: [] },
      { name: "FreeBSD", search: ai("freebsd"), versionRegexes: [] }
    ],
    ci = { browsers: H.constant(li), oses: H.constant(ui) },
    di = function(e) {
      var t,
        n,
        i,
    ...
    gi = function(e) {
      return (
        (e.nodeType !== hi && e.nodeType !== mi) || 0 === e.childElementCount
      );
    },
    pi = {
      all: function(e, t) {
    ...
    Si = function(e) {
      ...
      return _i(
        ...
        Ri(e),
        "#" + i,
        ki((n = e)) ? parseInt(n.nodeName.substr(1), 10) : 0,
        function() {
          e.id = i;
        }
      );
    ...
    Ti = function(e) {
      ...
      return (
        ...
        (n = e),
        oe.map(vi(wn.fromDom(n), t), function(e) {
          return e.dom();
        })
      );
    },
    ...
    Wi = function(e) {
      var t,
        ...
        i = Ti(e);
      return oe.filter(
        ((n = i), oe.map(oe.filter(n, Hi), Si)).concat(
          ((t = i), oe.map(oe.filter(t, Ci), Mi))
        ),
        Pi
      );
    },
    ...
    Ai = function(e, t) {
      return { title: e, value: { title: e, url: t, attach: H.noop } };
    },
    Bi = function(e, t, n) {
      var i = t in e ? e[t] : n;
      return !1 === i ? null : i;
      ...
      var n,
        ...
        u = function(e) {
          ...
          return w.map(n, function(e) {
            return { title: e, value: { title: e, url: e, attach: H.noop } };
          });
        },
        c = function(t) {
          var e,
            n = oe.filter(i, function(e) {
              return e.type === t;
            });
      ...
      return !1 === t.typeahead_urls
        ...
        ? ((n = [
            ...
            zi(
              e,
              ((o = c("anchor")),
              (s = Bi(t, "anchor_top", "#top")),
              (a = Bi(t, "anchor_bottom", "#bottom")),
              null !== s && o.unshift(Ai("<top>", s)),
              null !== a && o.push(Ai("<bottom>", a)),
              o)
            )
          ]),
          oe.foldl(
        ...
        r.on("PostRender", function() {
          r.getRoot().on("submit", function(e) {
            ...
            e.isDefaultPrevented() ||
              ...
              /^https?/.test(t) &&
                (i
                  ? oe.indexOf(i, t).isNone() &&
                    (Ni[n] = i.slice(0, 5).concat(t))
                  : (Ni[n] = [t])));
          });
        });
    },
      ...
      recalc: function(e) {
        ...
        if (
          ...
          for (b = d / c, t = 0, n = z.length; t < n; t++)
            (v = (m = (h = z[t]).layoutRect())[k]) < (p = m[R] + m.flex * b)
              ? ((d -= m[k] - m[R]),
                (c -= m.flex),
                (m.flex = 0),
                (m.maxFlexSize = v))
          ...
          for (
            ...
            (p = (m = (h = i[t]).layoutRect()).maxFlexSize || m[R]),
              "center" === a
                ...
                : "stretch" === a
                ? ((y[W] = L(m[N] || 0, r[P] - o[D] - o[A])), (y[T] = o[D]))
    ...
    Ji = function(i) {
      var t = ["alignleft", "aligncenter", "alignright", "alignjustify"],
        r = "alignleft",
        e = [
          { text: "Left", icon: "alignleft", onclick: Yi(i, "alignleft") },
          {
            text: "Center",
            icon: "aligncenter",
            onclick: Yi(i, "aligncenter")
          },
          { text: "Right", icon: "alignright", onclick: Yi(i, "alignright") },
          {
            text: "Justify",
            icon: "alignjustify",
      ...
      return function() {
        ...
        l.on("init nodeChange", function(e) {
          var t,
            ...
            w.each(t, function(e) {
              i ||
                Gi(e.value).toLowerCase() !== Gi(r).toLowerCase() ||
                (i = e.value);
            }),
            i);
        ...
        return {
          ...
          onselect: function(e) {
            e.control.settings.value &&
              n.execCommand("FontName", !1, e.control.settings.value);
          }
        };
      });
    },
        ...
        var e,
          ...
          w.map(e.split(" "), function(e) {
            var t = e,
              ...
              i = e.split("=");
            return (
              1 < i.length && ((t = i[0]), (n = i[1])), { text: t, value: n }
            );
          }));
        return {
          type: "listbox",
          ...
          onclick: function(e) {
            e.control.settings.value &&
              n.execCommand("FontSize", !1, e.control.settings.value);
          }
        };
      });
    },
    ...
    or = function(n, e) {
      ...
      return (
        e.items().each(function(e) {
          e.menu && e.visible(0 < or(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < rr(n, e.settings.menu));
          ...
          itemDefaults: {
            ...
            onPostRender: function() {
              ...
              n.parent().on("show", function() {
                var e, t;
                (e = n.settings.format) &&
                  (n.disabled(!i.formatter.canApply(e)),
                  n.active(i.formatter.match(e))),
                  (t = n.settings.cmd) && n.active(i.queryCommandState(t));
              });
            },
            onclick: function() {
              this.settings.format && Yi(i, this.settings.format)(),
      ...
      setup: function(e) {
        ...
        e.rtl && (ct.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (pe.container = qi(
              wn.fromDom(document.body),
              t.settings.ui_container
            ).fold(H.constant(null), function(e) {
              return e.dom();
            })),
          (zt.tooltips = !pe.iOS),
          (ct.translate = function(e) {
    ...
    xr = Zt.extend({
      recalc: function(e) {
        ...
        for (E = o.innerW - p.left - p.right, d = _ = 0; d < i; d++)
          (_ += M[d] + (0 < d ? b : 0)), (E -= (0 < d ? b : 0) + M[d]);
        for (H = o.innerH - p.top - p.bottom, f = R = 0; f < n; f++)
          (R += T[f] + (0 < f ? y : 0)), (H -= (0 < f ? y : 0) + T[f]);
        if (
          ((_ += p.left + p.right),
          (R += p.top + p.bottom),
          ...
          o.autoResize &&
            ...
            (l.contentH = l.minH - o.deltaH)),
            (P = "start" === t.packV ? 0 : 0 < H ? Math.floor(H / n) : 0);
          var W = 0,
            N = t.flexWidths;
          if (N) for (d = 0; d < N.length; d++) W += N[d];
          else W = i;
          var D = E / W;
      ...
      bindStates: function() {
        ...
        return (
          ...
          t.state.on("change:help", function(e) {
            t.classes.toggle("has-help", e.value),
              t.state.get("rendered") && t.updateLayoutRect();
          }),
          t._super()
        );
    ...
    Er = Qt.extend({
      ...
      renderHtml: function() {
        ...
        return (
          ...
          t.aria("role", t.parent() instanceof kr ? "menuitem" : "button"),
          '<div id="' +
            n +
            '" class="' +
            t.classes +
            ...
            n &&
              ...
              (i
                ...
                .each(function(e) {
                  e.hideMenu &&
                    e !== n &&
                    (e.menu && e.menu.visible() && (t = !0), e.hideMenu());
                }),
    ...
    Hr = Tt.extend({
      ...
      init: function(e) {
        ...
        this._super(e),
          ...
          e.animate && 11 !== pe.ie && this.classes.add("animate");
      },
      repaint: function() {
        return (
      ...
      load: function() {
        ...
        n.settings.itemsFactory &&
          (n.throbber ||
            ((n.throbber = new Dt(n.getEl("body"), !0)),
            0 === n.items().length
      ...
      init: function(i) {
        ...
        s._super(i),
          ...
          t &&
              ...
              (function e(t) {
                for (var n = 0; n < t.length; n++) {
                  if ((r = t[n].selected || i.value === t[n].value))
                    return (
                      (o = o || t[n].text), s.state.set("value", t[n].value), !0
                    );
            ...
            !r &&
              0 < t.length &&
              ((o = t[0].text), s.state.set("value", t[0].value)),
            s.state.set("menu", t)),
        ...
        return 0 === arguments.length
          ...
          : (void 0 === t ||
              (this.settings.values
                ? 0 <
                  w.grep(this.settings.values, function(e) {
                    return e.value === t;
                  }).length
                  ? this.state.set("value", t)
                  : null === t && this.state.set("value", null)
                : this.state.set("value", t)),
            this);
      },
      bindStates: function() {
          ...
          (t = n.menu)
            ...
            : ((t = e.menu).length
              ...
              i.settings.itemDefaults &&
                (t.itemDefaults = i.settings.itemDefaults),
              (t = n.menu = v
                .create(t)
                .parent(n)
                .renderTo()).reflow(),
    ...
    Tr = nn.extend({ Defaults: { classes: "radio", role: "radio" } }),
    Pr = zt.extend({
      renderHtml: function() {
        var e = this,
          t = e.classPrefix;
      ...
      postRender: function() {
        var t = this;
        t._super(),
          (t.resizeDragHelper = new pt(this._id, {
            start: function() {
              t.fire("ResizeStart");
            },
            drag: function(e) {
              "both" !== t.settings.direction && (e.deltaX = 0),
                t.fire("Resize", e);
            },
            stop: function() {
              t.fire("ResizeEnd");
  ...
  function Br(e, t) {
    ...
    "v" === e.settings.orientation
      ...
      (s = e.getEl("handle")),
      (o =
        ((e.layoutRect()[n] || 100) - He.getSize(s)[i]) *
          ((t - e._minValue) / (e._maxValue - e._minValue)) +
        "px"),
      (s.style[r] = o),
      (s.style.height = e.layoutRect().h + "px"),
      Ar(s, "valuenow", t),
      Ar(s, "valuetext", "" + e.settings.previewFilter(t)),
      Ar(s, "valuemin", e._minValue),
      Ar(s, "valuemax", e._maxValue);
  }
  var Or = zt.extend({
      init: function(e) {
        var t = this;
        e.previewFilter ||
          ...
          (t._minValue = q.isNumber(e.minValue) ? e.minValue : 0),
          (t._maxValue = q.isNumber(e.maxValue) ? e.maxValue : 100),
      ...
      postRender: function() {
        ...
        (e = m._minValue),
          ...
          (a = t),
          (l = m.getEl("handle")),
          (m._dragHelper = new pt(m._id, {
            handle: m._id + "-handle",
            start: function(e) {
              (u = e[n]),
                (c = parseInt(m.getEl("handle").style[i], 10)),
                (d = (m.layoutRect()[o] || 100) - He.getSize(l)[r]),
    ...
    Lr = Er.extend({
      ...
      repaint: function() {
        ...
        return (
          ...
          (e = n.firstChild),
          (t = n.lastChild),
          ke(e).css({ width: i.w - He.getSize(t).width, height: i.h - 2 }),
          ke(t).css({ height: i.h - 2 }),
          this
        );
      },
      activeMenu: function(e) {
            ...
            if (e.control === this)
              for (; t; ) {
                if (
                  ...
                  return (
                    e.stopImmediatePropagation(), void (n && n.call(this, e))
                  );
                t = t.parentNode;
              }
          }),
    ...
    Fr = _t.extend({
      ...
      activateTab: function(n) {
        ...
        this.activeTabId &&
          ...
          ke(e).removeClass(this.classPrefix + "active"),
          e.setAttribute("aria-selected", "false")),
          (this.activeTabId = "t" + n),
          (e = this.getEl("t" + n)).setAttribute("aria-selected", "true"),
          ke(e).addClass(this.classPrefix + "active"),
          this.items()
            [n].show()
            .fire("showtab"),
          this.reflow(),
      ...
      initLayoutRect: function() {
        var e,
          ...
          n,
          i = this;
        (t = (t = He.getSize(i.getEl("head")).width) < 0 ? 0 : t),
          (n = 0),
          i.items().each(function(e) {
  ...
  w.each(Vr(), function(e, t) {
    ...
    jr(window.tinymce ? window.tinymce : {}),
