...
const {
  ...
  BleedBox,
  TrimBox
} = require("../fabric/index");

const ImageLoad = require("../components/Objects/ImageLoad");
const TextLoad = require("../components/Objects/TextLoad");
const GraphicsLoad = require("../components/Objects/GraphicsLoad");
